...
`.trim(),_n={config:`
    ...
    `};function jt(e){return e&&_n[e]||""}var Xe=`
    <svg
...
`.trim();function Ie(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function J(e,t){return`
    ...
    `}function tt(e,t){e&&(e.classList.toggle("is-locked",t),e.setAttribute("aria-pressed",String(t)),e.innerHTML=t?Ze:Xe)}function ie(e,t){e&&e.classList.toggle("is-saved",t)}function nt(e=document){let t=e.querySelectorAll(".pf-save-btn[data-save-input]"),n=[];return t.forEach(a=>{let o=a.getAttribute("data-save-input"),s=document.getElementById(o);if(!s)return;let r=()=>{ie(a,!1)};s.addEventListener("input",r),n.push(()=>s.removeEventListener("input",r))}),()=>n.forEach(a=>a())}function Ut(e,t){if(e===0)return{canComplete:!0,blockedBy:null,message:""};for(let n=0;n<e;n++)if(!t[n])return{canComplete:!1,blockedBy:n,message:`Complete Step ${n} before signing off on this step.`};return{canComplete:!0,blockedBy:null,message:""}}function Gt(e){let t=document.querySelector(".pf-workflow-toast");t&&t.remove();let n=document.createElement("div");n.className="pf-workflow-toast pf-workflow-toast--warning",n.innerHTML=`
        <span class="pf-workflow-toast-icon">\u26A0\uFE0F</span>
        <span class="pf-workflow-toast-message">${e}</span>
    `,document.body.appendChild(n),requestAnimationFrame(()=>{n.classList.add("pf-workflow-toast--visible")}),setTimeout(()=>{n.classList.remove("pf-workflow-toast--visible"),setTimeout(()=>n.remove(),300)},4e3)}var at={fillColor:"#000000",fontColor:"#FFFFFF",bold:!0},Me={currency:"$#,##0.00",currencyWithNegative:"$#,##0.00;($#,##0.00)",number:"#,##0.00",integer:"#,##0",percent:"0.00%",date:"yyyy-mm-dd",dateTime:"yyyy-mm-dd hh:mm"};function ot(e){e.format.fill.color=at.fillColor,e.format.font.color=at.fontColor,e.format.font.bold=at.bold}function fe(e,t,n,a=!1){if(n<=0)return;let o=e.getRangeByIndexes(1,t,n,1);o.numberFormat=[[a?Me.currencyWithNegative:Me.currency]]}function ke(e,t,n){if(n<=0)return;let a=e.getRangeByIndexes(1,t,n,1);a.numberFormat=[[Me.number]]}function Jt(e,t,n,a=Me.date){if(n<=0)return;let o=e.getRangeByIndexes(1,t,n,1);o.numberFormat=[[a]]}var Cn="1.1.0",Ae="pto-accrual";var ge="PTO Accrual";function Q(e,t="info",n=4e3){document.querySelectorAll(".pf-toast").forEach(o=>o.remove());let a=document.createElement("div");if(a.className=`pf-toast pf-toast--${t}`,a.innerHTML=`
    ...
    `,!document.getElementById("pf-toast-styles")){let o=document.createElement("style");o.id="pf-toast-styles",o.textContent=`
        ...
        `,document.head.appendChild(o)}return document.body.appendChild(a),n>0&&setTimeout(()=>a.remove(),n),a}function xn(e,t={}){let{title:n="Confirm Action",confirmText:a="Continue",cancelText:o="Cancel",icon:s="\u{1F4CB}",destructive:r=!1}=t;return new Promise(l=>{document.querySelectorAll(".pf-confirm-overlay").forEach(i=>i.remove());let c=document.createElement("div");if(c.className="pf-confirm-overlay",c.innerHTML=`
    ...
    `;let s=B.activeView==="home"||B.activeView!=="step"&&B.activeView!=="config",r=document.getElementById("pf-info-fab-pto");if(s)r&&r.remove();else if((l=window.PrairieForge)!=null&&l.mountInfoFab){let c=Vn(B.activeStepId);PrairieForge.mountInfoFab({title:c.title,content:c.content,buttonId:"pf-info-fab-pto"})}qn(),Kn(),s?Pt():We()}function Vn(e){switch(e){case 0:return{title:"Configuration",content:`
    ...
    `}function Fn(){return`
        <section class="pf-step-guide">
            <div class="pf-step-grid">
                ${re.map((e,t)=>Un(e,t)).join("")}
            </div>
        </section>
    `}function Un(e,t){let n=B.stepStatuses[e.id]||"pending",a=B.activeView==="step"&&B.focusedIndex===t?"pf-step-card--active":"",o=jt(ia(e.id));return`
    ...
    `}function Gn(e){let t=re.filter(o=>o.id!==6).map(o=>({id:o.id,title:o.title,complete:Qn(o.id)})),n=t.every(o=>o.complete),a=t.map(o=>`
            <article class="pf-step-card pf-step-detail pf-config-card">
                <div class="pf-config-head pf-notes-header">
    ...
    `}function rn(){if(!C.loaded)return`
            <section class="pf-step-guide">
                <article class="pf-step-card pf-step-detail">
                    <p class="pf-step-title">Loading configuration\u2026</p>
                </article>
            </section>
        `;let e=Zt(se(E.payrollDate)),t=Zt(se(E.accountingPeriod)),n=se(E.journalEntryId),a=se(E.accountingSoftware),o=se(E.payrollProvider),s=se(E.companyName),r=se(E.reviewerName),l=ve(0),c=!!C.permanents[0],i=!!(gn(C.completes[0])||l.signOffDate),f=he(l==null?void 0:l.reviewer),g=(l==null?void 0:l.signOffDate)||"";return`
    ...
    `}function Jn(e){let t=ve(1),n=!!C.permanents[1],a=he(t==null?void 0:t.reviewer),o=(t==null?void 0:t.signOffDate)||"",s=!!(Se(C.completes[1])||o),r=se(E.payrollProvider);return`
        <section class="pf-hero" id="pf-step-hero">
            <p class="pf-hero-copy">${k(ge)} | Step ${e.id}</p>
            <h2 class="pf-hero-title">${k(e.title)}</h2>
            <p class="pf-hero-copy">${k(e.summary||"")}</p>
    ...
    `}function Yn(e){let t=re.find(l=>l.id===e);if(!t)return"";if(e===0)return rn();if(e===1)return Jn(t);if(e===2)return ma(t);if(e===3)return ha(t);if(e===4)return va(t);if(e===5)return ba(t);if(t.id===6)return Gn(t);let n=ve(e),a=!!C.permanents[e],o=he(n==null?void 0:n.reviewer),s=(n==null?void 0:n.signOffDate)||"",r=!!(Se(C.completes[e])||s);return`
        <section class="pf-hero" id="pf-step-hero">
    ...
    `}function qn(){var n,a,o,s,r,l,c;(n=document.getElementById("nav-home"))==null||n.addEventListener("click",async()=>{var f;let i=je(Ae);await $e(i.sheetName,i.title,i.subtitle),Ne({activeView:"home",activeStepId:null}),(f=document.getElementById("pf-hero"))==null||f.scrollIntoView({behavior:"smooth",block:"start"})}),(a=document.getElementById("nav-selector"))==null||a.addEventListener("click",()=>{window.location.href=Tn}),(o=document.getElementById("nav-prev"))==null||o.addEventListener("click",()=>Yt(-1)),(s=document.getElementById("nav-next"))==null||s.addEventListener("click",()=>Yt(1));let e=document.getElementById("nav-quick-toggle"),t=document.getElementById("quick-access-dropdown");e==null||e.addEventListener("click",i=>{i.stopPropagation(),t==null||t.classList.toggle("hidden"),e.classList.toggle("is-active")}),document.addEventListener("click",i=>{!(t!=null&&t.contains(i.target))&&!(e!=null&&e.contains(i.target))&&(t==null||t.classList.add("hidden"),e==null||e.classList.remove("is-active"))}),(r=document.getElementById("nav-roster"))==null||r.addEventListener("click",()=>{Qt("SS_Employee_Roster"),t==null||t.classList.add("hidden"),e==null||e.classList.remove("is-active")}),(l=document.getElementById("nav-accounts"))==null||l.addEventListener("click",()=>{Qt("SS_Chart_of_Accounts"),t==null||t.classList.add("hidden"),e==null||e.classList.remove("is-active")}),(c=document.getElementById("showConfigSheets"))==null||c.addEventListener("click",async()=>{await sa()}),document.querySelectorAll("[data-step-card]").forEach(i=>{let f=Number(i.getAttribute("data-step-index")),g=Number(i.getAttribute("data-step-id"));i.addEventListener("click",()=>Fe(f,g))}),B.activeView==="config"?Wn():B.activeView==="step"&&B.activeStepId!=null&&zn(B.activeStepId)}function zn(e){var f,g,u,d,y,h,b,p,v,w,R,x,$,j,D,V,S;let t=e===2?document.getElementById("step-notes-input"):document.getElementById(`step-notes-${e}`),n=e===2?document.getElementById("step-reviewer-name"):document.getElementById(`step-reviewer-${e}`),a=e===2?document.getElementById("step-signoff-date"):document.getElementById(`step-signoff-${e}`),o=document.getElementById("step-back-btn"),s=e===2?document.getElementById("step-notes-lock-2"):document.getElementById(`step-notes-lock-${e}`),r=e===2?document.getElementById("step-notes-save-2"):document.getElementById(`step-notes-save-${e}`);r==null||r.addEventListener("click",async()=>{let I=(t==null?void 0:t.value)||"";await ee(e,"notes",I),ie(r,!0)});let l=e===2?document.getElementById("headcount-signoff-save"):document.getElementById(`step-signoff-save-${e}`);l==null||l.addEventListener("click",async()=>{let I=(n==null?void 0:n.value)||"";await ee(e,"reviewer",I),ie(l,!0)}),nt();let c=e===2?"headcount-signoff-toggle":`step-signoff-toggle-${e}`,i=e===2?"step-signoff-date":`step-signoff-${e}`;pn(e,{buttonId:c,inputId:i,canActivate:e===2?()=>{var O;return!dt()||((O=document.getElementById("step-notes-input"))==null?void 0:O.value.trim())||""?!0:(Q("Please enter a brief explanation of the headcount differences before completing this step.","info"),!1)}:null,onComplete:e===2?_a:null}),o==null||o.addEventListener("click",async()=>{let I=je(Ae);await $e(I.sheetName,I.title,I.subtitle),Ne({activeView:"home",activeStepId:null})}),s==null||s.addEventListener("click",async()=>{let I=!s.classList.contains("is-locked");tt(s,I),await un(e,I)}),e===6&&((f=document.getElementById("archive-run-btn"))==null||f.addEventListener("click",()=>{})),e===1&&((g=document.getElementById("import-open-data-btn"))==null||g.addEventListener("click",()=>cn("PTO_Data")),(u=document.getElementById("import-clear-btn"))==null||u.addEventListener("click",()=>oa())),e===2&&((d=document.getElementById("headcount-skip-btn"))==null||d.addEventListener("click",()=>{L.skipAnalysis=!L.skipAnalysis;let I=document.getElementById("headcount-skip-btn");I==null||I.classList.toggle("is-active",L.skipAnalysis),L.skipAnalysis&&on(),an()}),(y=document.getElementById("headcount-run-btn"))==null||y.addEventListener("click",()=>rt()),(h=document.getElementById("headcount-refresh-btn"))==null||h.addEventListener("click",()=>rt()),Ea(),L.skipAnalysis&&on(),an()),e===3&&((b=document.getElementById("quality-run-btn"))==null||b.addEventListener("click",()=>zt()),(p=document.getElementById("quality-refresh-btn"))==null||p.addEventListener("click",()=>zt()),(v=document.getElementById("quality-acknowledge-btn"))==null||v.addEventListener("click",()=>Zn())),e===4&&((w=document.getElementById("analysis-refresh-btn"))==null||w.addEventListener("click",()=>Wt()),(R=document.getElementById("analysis-run-btn"))==null||R.addEventListener("click",()=>Wt()),(x=document.getElementById("payrate-save-btn"))==null||x.addEventListener("click",qt),($=document.getElementById("payrate-ignore-btn"))==null||$.addEventListener("click",Xn),(j=document.getElementById("payrate-input"))==null||j.addEventListener("keydown",I=>{I.key==="Enter"&&qt()})),e===5&&((D=document.getElementById("je-create-btn"))==null||D.addEventListener("click",()=>na()),(V=document.getElementById("je-run-btn"))==null||V.addEventListener("click",()=>ln()),(S=document.getElementById("je-export-btn"))==null||S.addEventListener("click",()=>aa()))}function Wn(){var l,c,i,f,g;It("config-payroll-date",{onChange:u=>{if(oe(E.payrollDate,u),!!u){if(!C.overrides.accountingPeriod){let d=ca(u);if(d){let y=document.getElementById("config-accounting-period");y&&(y.value=d),oe(E.accountingPeriod,d)}}if(!C.overrides.journalId){let d=da(u);if(d){let y=document.getElementById("config-journal-id");y&&(y.value=d),oe(E.journalEntryId,d)}}}}});let e=document.getElementById("config-accounting-period");e==null||e.addEventListener("change",u=>{C.overrides.accountingPeriod=!!u.target.value,oe(E.accountingPeriod,u.target.value||"")});let t=document.getElementById("config-journal-id");t==null||t.addEventListener("change",u=>{C.overrides.journalId=!!u.target.value,oe(E.journalEntryId,u.target.value.trim())}),(l=document.getElementById("config-company-name"))==null||l.addEventListener("change",u=>{oe(E.companyName,u.target.value.trim())}),(c=document.getElementById("config-payroll-provider"))==null||c.addEventListener("change",u=>{oe(E.payrollProvider,u.target.value.trim())}),(i=document.getElementById("config-accounting-link"))==null||i.addEventListener("change",u=>{oe(E.accountingSoftware,u.target.value.trim())}),(f=document.getElementById("config-user-name"))==null||f.addEventListener("change",u=>{oe(E.reviewerName,u.target.value.trim())});let n=document.getElementById("config-notes");n==null||n.addEventListener("input",u=>{ee(0,"notes",u.target.value)});let a=document.getElementById("config-notes-lock");a==null||a.addEventListener("click",async()=>{let u=!a.classList.contains("is-locked");tt(a,u),await un(0,u)});let o=document.getElementById("config-notes-save");o==null||o.addEventListener("click",async()=>{n&&(await ee(0,"notes",n.value),ie(o,!0))});let s=document.getElementById("config-reviewer");s==null||s.addEventListener("change",u=>{let d=u.target.value.trim();ee(0,"reviewer",d);let y=document.getElementById("config-signoff-date");if(d&&y&&!y.value){let h=ct();y.value=h,ee(0,"signOffDate",h),fn(0,!0)}}),(g=document.getElementById("config-signoff-date"))==null||g.addEventListener("change",u=>{ee(0,"signOffDate",u.target.value||"")});let r=document.getElementById("config-signoff-save");r==null||r.addEventListener("click",async()=>{var y,h;let u=((y=s==null?void 0:s.value)==null?void 0:y.trim())||"",d=((h=document.getElementById("config-signoff-date"))==null?void 0:h.value)||"";await ee(0,"reviewer",u),await ee(0,"signOffDate",d),ie(r,!0)}),nt(),pn(0,{buttonId:"config-signoff-toggle",inputId:"config-signoff-date",onComplete:ga})}function Fe(e,t=null){if(e<0||e>=re.length)return;Ve=e;let n=t!=null?t:re[e].id;Ne({focusedIndex:e,activeView:n===0?"config":"step",activeStepId:n});let o=Rn[n];o&&cn(o),n===2&&!L.hasAnalyzed&&(mn(),rt())}function Yt(e){let t=B.focusedIndex+e,n=Math.max(0,Math.min(re.length-1,t));Fe(n,re[n].id)}function Kn(){if(Ve===null)return;let e=document.querySelector(`[data-step-index="${Ve}"]`);Ve=null,e==null||e.scrollIntoView({behavior:"smooth",block:"center"})}function Qn(e){return gn(C.completes[e])}function Ne(e){e.stepStatuses&&(B.stepStatuses={...B.stepStatuses,...e.stepStatuses}),Object.assign(B,{...e,stepStatuses:B.stepStatuses}),te()}function ne(){return typeof Excel!="undefined"&&typeof Excel.run=="function"}async function qt(){let e=document.getElementById("payrate-input");if(!e)return;let t=parseFloat(e.value),n=e.dataset.employee,a=parseInt(e.dataset.row,10);if(isNaN(t)||t<=0){Q("Please enter a valid pay rate greater than 0.","info");return}if(!n||isNaN(a)){console.error("Missing employee data on input");return}Z(!0,"Updating pay rate...");try{await Excel.run(async o=>{let s=o.workbook.worksheets.getItem("PTO_Analysis"),r=s.getCell(a-1,3);r.values=[[t]];let l=s.getCell(a-1,8);l.load("values"),await o.sync();let i=(Number(l.values[0][0])||0)*t,f=s.getCell(a-1,9);f.values=[[i]];let g=s.getCell(a-1,10);g.load("values"),await o.sync();let u=Number(g.values[0][0])||0,d=i-u,y=s.getCell(a-1,11);y.values=[[d]],await o.sync()}),X.missingPayRates=X.missingPayRates.filter(o=>o.name!==n),Z(!1),Fe(3,3)}catch(o){console.error("Failed to save pay rate:",o),Q(`Failed to save pay rate: ${o.message}`,"error"),Z(!1)}}function Xn(){let e=document.getElementById("payrate-input");if(!e)return;let t=e.dataset.employee;t&&(X.ignoredMissingPayRates.add(t),X.missingPayRates=X.missingPayRates.filter(n=>n.name!==t)),Fe(3,3)}async function zt(){if(!ne()){Q("Excel is not available. Open this module inside Excel to run quality check.","info");return}W.loading=!0,Z(!0,"Analyzing data quality..."),ie(document.getElementById("quality-save-btn"),!1);try{await Excel.run(async t=>{var b;let a=t.workbook.worksheets.getItem("PTO_Data").getUsedRangeOrNullObject();a.load("values"),await t.sync();let o=a.isNullObject?[]:a.values||[];if(!o.length||o.length<2)throw new Error("PTO_Data is empty or has no data rows.");let s=(o[0]||[]).map(p=>q(p));console.log("[Data Quality] PTO_Data headers:",o[0]);let r=s.findIndex(p=>p==="employee name"||p==="employeename");r===-1&&(r=s.findIndex(p=>p.includes("employee")&&p.includes("name"))),r===-1&&(r=s.findIndex(p=>p==="name"||p.includes("name")&&!p.includes("company")&&!p.includes("form"))),console.log("[Data Quality] Employee name column index:",r,"Header:",(b=o[0])==null?void 0:b[r]);let l=M(s,["balance"]),c=M(s,["accrual rate","accrualrate"]),i=M(s,["carry over","carryover"]),f=M(s,["ytd accrued","ytdaccrued"]),g=M(s,["ytd used","ytdused"]),u=[],d=[],y=[],h=o.slice(1);h.forEach((p,v)=>{let w=v+2,R=r!==-1?String(p[r]||"").trim():`Row ${w}`;if(!R)return;let x=l!==-1&&Number(p[l])||0,$=c!==-1&&Number(p[c])||0,j=i!==-1&&Number(p[i])||0,D=f!==-1&&Number(p[f])||0,V=g!==-1&&Number(p[g])||0,S=j+D;x<0?u.push({name:R,issue:`Negative balance: ${x.toFixed(2)} hrs`,rowIndex:w}):V>S&&S>0&&u.push({name:R,issue:`Used ${V.toFixed(0)} hrs but only ${S.toFixed(0)} available`,rowIndex:w}),x===0&&(j>0||D>0)&&d.push({name:R,rowIndex:w}),$>8&&y.push({name:R,accrualRate:$,rowIndex:w})}),W.balanceIssues=u,W.zeroBalances=d,W.accrualOutliers=y,W.totalIssues=u.length,W.totalEmployees=h.filter(p=>p.some(v=>v!==null&&v!=="")).length,W.hasRun=!0});let e=W.balanceIssues.length>0;Ne({stepStatuses:{3:e?"blocked":"complete"}})}catch(e){console.error("Data quality check error:",e),Q(`Quality check failed: ${e.message}`,"error"),W.hasRun=!1}finally{W.loading=!1,Z(!1),te()}}function Zn(){W.acknowledged=!0,Ne({stepStatuses:{3:"complete"}}),te()}async function ea(){if(ne())try{await Excel.run(async e=>{let t=e.workbook.worksheets.getItem("PTO_Data"),n=e.workbook.worksheets.getItemOrNullObject("PTO_Analysis"),a=t.getUsedRangeOrNullObject();if(a.load("values"),n.load("isNullObject"),await e.sync(),n.isNullObject){X.completenessCheck={accrualRate:null,carryOver:null,ytdAccrued:null,ytdUsed:null,balance:null};return}let o=n.getUsedRangeOrNullObject();o.load("values"),await e.sync();let s=a.isNullObject?[]:a.values||[],r=o.isNullObject?[]:o.values||[];if(!s.length||!r.length){X.completenessCheck={accrualRate:null,carryOver:null,ytdAccrued:null,ytdUsed:null,balance:null};return}let l=(f,g,u)=>{let d=(f[0]||[]).map(b=>q(b)),y=M(d,g);return y===-1?null:f.slice(1).reduce((b,p)=>b+(Number(p[y])||0),0)},c=[{key:"accrualRate",aliases:["accrual rate","accrualrate"]},{key:"carryOver",aliases:["carry over","carryover","carry_over"]},{key:"ytdAccrued",aliases:["ytd accrued","ytdaccrued","ytd_accrued"]},{key:"ytdUsed",aliases:["ytd used","ytdused","ytd_used"]},{key:"balance",aliases:["balance"]}],i={};for(let f of c){let g=l(s,f.aliases,"PTO_Data"),u=l(r,f.aliases,"PTO_Analysis");if(g===null||u===null)i[f.key]=null;else{let d=Math.abs(g-u)<.01;i[f.key]={match:d,ptoData:g,ptoAnalysis:u}}}X.completenessCheck=i})}catch(e){console.error("Completeness check failed:",e)}}async function Wt(){if(!ne()){Q("Excel is not available. Open this module inside Excel to run analysis.","info");return}Z(!0,"Running analysis...");try{await mn(),await ea(),X.cleanDataReady=!0,te()}catch(e){console.error("Full analysis error:",e),Q(`Analysis failed: ${e.message}`,"error")}finally{Z(!1)}}async function ln(){if(!ne()){Q("Excel is not available. Open this module inside Excel to run journal checks.","info");return}Y.loading=!0,Y.lastError=null,ie(document.getElementById("je-save-btn"),!1),te();try{let e=await Excel.run(async t=>{let a=t.workbook.worksheets.getItem("PTO_JE_Draft").getUsedRangeOrNullObject();a.load("values");let o=t.workbook.worksheets.getItemOrNullObject("PTO_Analysis");o.load("isNullObject"),await t.sync();let s=a.isNullObject?[]:a.values||[];if(!s.length)throw new Error("PTO_JE_Draft is empty. Generate the JE first.");let r=(s[0]||[]).map(w=>q(w)),l=M(r,["debit"]),c=M(r,["credit"]),i=M(r,["lineamount","line amount"]),f=M(r,["account number","accountnumber"]);if(l===-1||c===-1)throw new Error("Could not find Debit and Credit columns in PTO_JE_Draft.");let g=0,u=0,d=0,y=0;s.slice(1).forEach(w=>{let R=Number(w[l])||0,x=Number(w[c])||0,$=i!==-1&&Number(w[i])||0,j=f!==-1?String(w[f]||"").trim():"";g+=R,u+=x,d+=$,j&&j!=="21540"&&(y+=$)});let h=0;if(!o.isNullObject){let w=o.getUsedRangeOrNullObject();w.load("values"),await t.sync();let R=w.isNullObject?[]:w.values||[];if(R.length>1){let x=(R[0]||[]).map(j=>q(j)),$=M(x,["change"]);$!==-1&&R.slice(1).forEach(j=>{h+=Number(j[$])||0})}}let b=g-u,p=[];Math.abs(b)>=.01?p.push({check:"Debits = Credits",passed:!1,detail:b>0?`Debits exceed credits by $${Math.abs(b).toLocaleString(void 0,{minimumFractionDigits:2})}`:`Credits exceed debits by $${Math.abs(b).toLocaleString(void 0,{minimumFractionDigits:2})}`}):p.push({check:"Debits = Credits",passed:!0,detail:""}),Math.abs(d)>=.01?p.push({check:"Line Amounts Sum to Zero",passed:!1,detail:`Line amounts sum to $${d.toLocaleString(void 0,{minimumFractionDigits:2})} (should be $0.00)`}):p.push({check:"Line Amounts Sum to Zero",passed:!0,detail:""});let v=Math.abs(y-h);return v>=.01?p.push({check:"JE Matches Analysis Total",passed:!1,detail:`JE expense total ($${y.toLocaleString(void 0,{minimumFractionDigits:2})}) differs from PTO_Analysis Change total ($${h.toLocaleString(void 0,{minimumFractionDigits:2})}) by $${v.toLocaleString(void 0,{minimumFractionDigits:2})}`}):p.push({check:"JE Matches Analysis Total",passed:!0,detail:""}),{debitTotal:g,creditTotal:u,difference:b,lineAmountSum:d,jeChangeTotal:y,analysisChangeTotal:h,issues:p,validationRun:!0}});Object.assign(Y,e,{lastError:null})}catch(e){console.warn("PTO JE summary:",e),Y.lastError=(e==null?void 0:e.message)||"Unable to calculate journal totals.",Y.debitTotal=null,Y.creditTotal=null,Y.difference=null,Y.lineAmountSum=null,Y.jeChangeTotal=null,Y.analysisChangeTotal=null,Y.issues=[],Y.validationRun=!1}finally{Y.loading=!1,te()}}var ta={"general & administrative":"64110","general and administrative":"64110","g&a":"64110","research & development":"62110","research and development":"62110","r&d":"62110",marketing:"61610","cogs onboarding":"53110","cogs prof. services":"56110","cogs professional services":"56110","sales & marketing":"61110","sales and marketing":"61110","cogs support":"52110","client success":"61811"},Kt="21540";async function na(){if(!ne()){Q("Excel is not available. Open this module inside Excel to create the journal entry.","info");return}Z(!0,"Creating PTO Journal Entry...");try{await Excel.run(async e=>{let t=[],n=e.workbook.tables.getItemOrNullObject(pe[0]);if(n.load("isNullObject"),await e.sync(),n.isNullObject){let m=e.workbook.worksheets.getItemOrNullObject("SS_PF_Config");if(m.load("isNullObject"),await e.sync(),!m.isNullObject){let P=m.getUsedRangeOrNullObject();P.load("values"),await e.sync();let A=P.isNullObject?[]:P.values||[];t=A.length>1?A.slice(1):[]}}else{let m=n.getDataBodyRange();m.load("values"),await e.sync(),t=m.values||[]}let a=e.workbook.worksheets.getItemOrNullObject("PTO_Analysis");if(a.load("isNullObject"),await e.sync(),a.isNullObject)throw new Error("PTO_Analysis sheet not found. Please ensure the worksheet exists.");let o=a.getUsedRangeOrNullObject();o.load("values");let s=e.workbook.worksheets.getItemOrNullObject("SS_Chart_of_Accounts");s.load("isNullObject"),await e.sync();let r=[];if(!s.isNullObject){let m=s.getUsedRangeOrNullObject();m.load("values"),await e.sync(),r=m.isNullObject?[]:m.values||[]}let l=o.isNullObject?[]:o.values||[];if(!l.length||l.length<2)throw new Error("PTO_Analysis is empty or has no data rows. Run the analysis first (Step 4).");let c={};t.forEach(m=>{let P=String(m[1]||"").trim(),A=m[2];P&&(c[P]=A)}),(!c[E.journalEntryId]||!c[E.payrollDate])&&console.warn("[JE Draft] Missing config values - RefNumber:",c[E.journalEntryId],"TxnDate:",c[E.payrollDate]);let i=c[E.journalEntryId]||"",f=c[E.payrollDate]||"",g=c[E.accountingPeriod]||"",u="";if(f)try{let m;if(typeof f=="number"||/^\d{4,5}$/.test(String(f).trim())){let P=Number(f),A=new Date(1899,11,30);m=new Date(A.getTime()+P*24*60*60*1e3)}else m=new Date(f);if(!isNaN(m.getTime())&&m.getFullYear()>1970){let P=String(m.getMonth()+1).padStart(2,"0"),A=String(m.getDate()).padStart(2,"0"),N=m.getFullYear();u=`${P}/${A}/${N}`}else console.warn("[JE Draft] Date parsing resulted in invalid date:",f,"->",m),u=String(f)}catch(m){console.warn("[JE Draft] Could not parse TxnDate:",f,m),u=String(f)}let d=g?`${g} PTO Accrual`:"PTO Accrual",y={};if(r.length>1){let m=(r[0]||[]).map(N=>q(N)),P=M(m,["account number","accountnumber","account","acct"]),A=M(m,["account name","accountname","name","description"]);P!==-1&&A!==-1&&r.slice(1).forEach(N=>{let z=String(N[P]||"").trim(),le=String(N[A]||"").trim();z&&(y[z]=le)})}let h=(l[0]||[]).map(m=>q(m));console.log("[JE Draft] PTO_Analysis headers:",h),console.log("[JE Draft] PTO_Analysis row count:",l.length-1);let b=M(h,["department"]),p=M(h,["change"]);if(console.log("[JE Draft] Column indices - Department:",b,"Change:",p),b===-1||p===-1)throw new Error(`Could not find required columns in PTO_Analysis. Found headers: ${h.join(", ")}. Looking for "Department" (found: ${b!==-1}) and "Change" (found: ${p!==-1}).`);let v={},w=0,R=0,x=0;if(l.slice(1).forEach((m,P)=>{w++;let A=String(m[b]||"").trim(),N=m[p],z=Number(N)||0;if(P<3&&console.log(`[JE Draft] Row ${P+2}: Dept="${A}", Change raw="${N}", Change num=${z}`),!A){x++;return}if(z===0){R++;return}v[A]||(v[A]=0),v[A]+=z}),console.log(`[JE Draft] Data summary: ${w} rows, ${R} with zero change, ${x} missing dept`),console.log("[JE Draft] Department totals:",v),Object.keys(v).length===0){let m=`No journal entry lines could be created.
...
`,m+=`\u2022 ${x} rows missing department`),new Error(m)}let j=["RefNumber","TxnDate","Account Number","Account Name","LineAmount","Debit","Credit","LineDesc","Department"],D=[j],V=0,S=0;Object.entries(v).forEach(([m,P])=>{if(Math.abs(P)<.01)return;let A=m.toLowerCase().trim(),N=ta[A]||"",z=y[N]||"",le=P>0?Math.abs(P):0,_=P<0?Math.abs(P):0;V+=le,S+=_,D.push([i,u,N,z,P,le,_,d,m])});let I=V-S;if(Math.abs(I)>=.01){let m=I<0?Math.abs(I):0,P=I>0?Math.abs(I):0,A=y[Kt]||"Accrued PTO";D.push([i,u,Kt,A,-I,m,P,d,""])}let O=e.workbook.worksheets.getItemOrNullObject("PTO_JE_Draft");if(O.load("isNullObject"),await e.sync(),O.isNullObject)O=e.workbook.worksheets.add("PTO_JE_Draft");else{let m=O.getUsedRangeOrNullObject();m.load("isNullObject"),await e.sync(),m.isNullObject||m.clear()}if(D.length>0){let m=O.getRangeByIndexes(0,0,D.length,j.length);m.values=D;let P=O.getRangeByIndexes(0,0,1,j.length);ot(P);let A=D.length-1;A>0&&(fe(O,4,A,!0),fe(O,5,A),fe(O,6,A)),m.format.autofitColumns()}await e.sync(),O.activate(),O.getRange("A1").select(),await e.sync()}),await ln()}catch(e){console.error("Create JE Draft error:",e),Q(`Unable to create Journal Entry: ${e.message}`,"error")}finally{Z(!1)}}async function aa(){if(!ne()){Q("Excel is not available. Open this module inside Excel to export.","info");return}Z(!0,"Preparing JE CSV...");try{let{rows:e}=await Excel.run(async n=>{let o=n.workbook.worksheets.getItem("PTO_JE_Draft").getUsedRangeOrNullObject();o.load("values"),await n.sync();let s=o.isNullObject?[]:o.values||[];if(!s.length)throw new Error("PTO_JE_Draft is empty.");return{rows:s}}),t=Oa(e);Sa(`pto-je-draft-${ct()}.csv`,t)}catch(e){console.error("PTO JE export:",e),Q("Unable to export the JE draft. Confirm the sheet has data.","error")}finally{Z(!1)}}async function cn(e){if(!(!e||!ne()))try{await Excel.run(async t=>{let n=t.workbook.worksheets.getItem(e);n.activate(),n.getRange("A1").select(),await t.sync()})}catch(t){console.error(t)}}async function oa(){if(!(!ne()||!await xn(`All data in PTO_Data will be permanently removed.

This action cannot be undone.`,{title:"Clear PTO Data",icon:"\u{1F5D1}\uFE0F",confirmText:"Clear Data",cancelText:"Keep Data",destructive:!0}))){Z(!0);try{await Excel.run(async t=>{let n=t.workbook.worksheets.getItem("PTO_Data"),a=n.getUsedRangeOrNullObject();a.load("rowCount"),await t.sync(),!a.isNullObject&&a.rowCount>1&&(n.getRangeByIndexes(1,0,a.rowCount-1,20).clear(Excel.ClearApplyTo.contents),await t.sync()),n.activate(),n.getRange("A1").select(),await t.sync()}),Q("PTO_Data cleared successfully. You can now paste new data.","success")}catch(t){console.error("Clear PTO_Data error:",t),Q(`Failed to clear PTO_Data: ${t.message}`,"error")}finally{Z(!1)}}}async function Qt(e){if(!e||!ne())return;let t={SS_Employee_Roster:["Employee","Department","Pay_Rate","Status","Hire_Date"],SS_Chart_of_Accounts:["Account_Number","Account_Name","Type","Category"]};try{await Excel.run(async n=>{let a=n.workbook.worksheets.getItemOrNullObject(e);if(a.load("isNullObject"),await n.sync(),a.isNullObject){a=n.workbook.worksheets.add(e);let o=t[e]||["Column1","Column2"],s=a.getRange(`A1:${String.fromCharCode(64+o.length)}1`);s.values=[o],s.format.font.bold=!0,s.format.fill.color="#f0f0f0",s.format.autofitColumns(),await n.sync()}a.activate(),a.getRange("A1").select(),await n.sync()})}catch(n){console.error("Error opening reference sheet:",n)}}async function sa(){if(!ne()){console.log("Excel not available");return}try{await Excel.run(async e=>{let t=e.workbook.worksheets;t.load("items/name,visibility"),await e.sync();let n=0;t.items.forEach(o=>{o.name.toUpperCase().startsWith("SS_")&&(o.visibility=Excel.SheetVisibility.visible,console.log(`[Config] Made visible: ${o.name}`),n++)}),await e.sync();let a=e.workbook.worksheets.getItemOrNullObject("SS_PF_Config");a.load("isNullObject"),await e.sync(),a.isNullObject||(a.activate(),a.getRange("A1").select(),await e.sync()),console.log(`[Config] ${n} system sheets now visible`)})}catch(e){console.error("[Config] Error unhiding system sheets:",e)}}function se(e){var n,a;let t=String(e!=null?e:"").trim();return(a=(n=C.values)==null?void 0:n[t])!=null?a:""}function he(e){var n;if(e)return e;let t=se(E.reviewerName);if(t)return t;if((n=window.PrairieForge)!=null&&n._sharedConfigCache){let a=window.PrairieForge._sharedConfigCache.get("SS_Default_Reviewer")||window.PrairieForge._sharedConfigCache.get("Default_Reviewer");if(a)return a}return""}function oe(e,t,n={}){var r;let a=String(e!=null?e:"").trim();if(!a)return;C.values[a]=t!=null?t:"";let o=(r=n.debounceMs)!=null?r:0;if(!o){let l=Oe.get(a);l&&clearTimeout(l),Oe.delete(a),Ce(a,t!=null?t:"",pe);return}Oe.has(a)&&clearTimeout(Oe.get(a));let s=setTimeout(()=>{Oe.delete(a),Ce(a,t!=null?t:"",pe)},o);Oe.set(a,s)}function q(e){return String(e!=null?e:"").trim().toLowerCase()}function Z(e,t="Working..."){let n=document.getElementById(In);n&&(n.style.display="none")}function it(){Dn()}typeof Office!="undefined"&&Office.onReady?Office.onReady(()=>it()).catch(()=>it()):it();function ve(e){return C.steps[e]||{notes:"",reviewer:"",signOffDate:""}}function dn(e){return He[e]||{}}function ia(e){return e===0?"config":e===1?"import":e===2?"headcount":e===3?"validate":e===4?"review":e===5?"journal":e===6?"archive":""}async function ee(e,t,n){let a=C.steps[e]||{notes:"",reviewer:"",signOffDate:""};a[t]=n,C.steps[e]=a;let o=dn(e),s=t==="notes"?o.note:t==="reviewer"?o.reviewer:o.signOff;if(s&&K())try{await Ce(s,n,pe)}catch(r){console.warn("PTO: unable to save field",s,r)}}async function un(e,t){C.permanents[e]=t;let n=dn(e);if(n!=null&&n.note&&K())try{await Excel.run(async a=>{var u;let o=a.workbook.tables.getItemOrNullObject(pe[0]);if(await a.sync(),o.isNullObject)return;let s=o.getDataBodyRange(),r=o.getHeaderRowRange();s.load("values"),r.load("values"),await a.sync();let l=r.values[0]||[],c=l.map(d=>String(d||"").trim().toLowerCase()),i={field:c.findIndex(d=>d==="field"||d==="field name"||d==="setting"),permanent:c.findIndex(d=>d==="permanent"||d==="persist"),value:c.findIndex(d=>d==="value"||d==="setting value"),type:c.findIndex(d=>d==="type"||d==="category"),title:c.findIndex(d=>d==="title"||d==="display name")};if(i.field===-1)return;let g=(s.values||[]).findIndex(d=>String(d[i.field]||"").trim()===n.note);if(g>=0)i.permanent>=0&&(s.getCell(g,i.permanent).values=[[t?"Y":"N"]]);else{let d=new Array(l.length).fill("");i.type>=0&&(d[i.type]="Other"),i.title>=0&&(d[i.title]=""),d[i.field]=n.note,i.permanent>=0&&(d[i.permanent]=t?"Y":"N"),i.value>=0&&(d[i.value]=((u=C.steps[e])==null?void 0:u.notes)||""),o.rows.add(null,[d])}await a.sync()})}catch(a){console.warn("PTO: unable to update permanent flag",a)}}async function fn(e,t){let n=sn[e];if(n&&(C.completes[e]=t?"Y":"",!!K()))try{await Ce(n,t?"Y":"",pe)}catch(a){console.warn("PTO: unable to save completion flag",n,a)}}function Xt(e,t){e&&(e.classList.toggle("is-active",t),e.setAttribute("aria-pressed",String(t)))}function ra(){let e={};return Object.keys(He).forEach(t=>{var s;let n=parseInt(t,10),a=!!((s=C.steps[n])!=null&&s.signOffDate),o=!!C.completes[n];e[n]=a||o}),e}function pn(e,{buttonId:t,inputId:n,canActivate:a=null,onComplete:o=null}){var c;let s=document.getElementById(t);if(!s)return;let r=document.getElementById(n),l=!!((c=C.steps[e])!=null&&c.signOffDate)||!!C.completes[e];Xt(s,l),s.addEventListener("click",()=>{if(!s.classList.contains("is-active")&&e>0){let g=ra(),{canComplete:u,message:d}=Ut(e,g);if(!u){Gt(d);return}}if(typeof a=="function"&&!a())return;let f=!s.classList.contains("is-active");Xt(s,f),r&&(r.value=f?ct():"",ee(e,"signOffDate",r.value)),fn(e,f),f&&typeof o=="function"&&o()})}function k(e){return String(e!=null?e:"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function la(e){return String(e!=null?e:"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function gn(e){let t=String(e!=null?e:"").trim().toLowerCase();return t==="true"||t==="y"||t==="yes"||t==="1"}function Se(e){let t=String(e!=null?e:"").trim().toLowerCase();return t==="true"||t==="y"||t==="yes"||t==="1"}function lt(e){if(!e)return null;let t=/^(\d{4})-(\d{2})-(\d{2})$/.exec(String(e));if(!t)return null;let n=Number(t[1]),a=Number(t[2]),o=Number(t[3]);return!n||!a||!o?null:{year:n,month:a,day:o}}function Zt(e){if(!e)return"";let t=lt(e);if(!t)return"";let{year:n,month:a,day:o}=t;return`${n}-${String(a).padStart(2,"0")}-${String(o).padStart(2,"0")}`}function ca(e){let t=lt(e);return t?`${["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][t.month-1]} ${t.year}`:""}function da(e){let t=lt(e);return t?`PTO-AUTO-${t.year}-${String(t.month).padStart(2,"0")}-${String(t.day).padStart(2,"0")}`:""}function ct(){let e=new Date,t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),a=String(e.getDate()).padStart(2,"0");return`${t}-${n}-${a}`}function ua(e){let t=String(e!=null?e:"").trim().toLowerCase();return t==="y"||t==="yes"||t==="true"||t==="t"||t==="1"}function fa(e){if(e instanceof Date)return e.getTime();if(typeof e=="number"){let n=pa(e);return n?n.getTime():null}let t=new Date(e);return Number.isNaN(t.getTime())?null:t.getTime()}function pa(e){if(!Number.isFinite(e))return null;let t=new Date(Date.UTC(1899,11,30));return new Date(t.getTime()+e*24*60*60*1e3)}function ga(){let e=n=>{var a,o;return((o=(a=document.getElementById(n))==null?void 0:a.value)==null?void 0:o.trim())||""};[{id:"config-payroll-date",field:E.payrollDate},{id:"config-accounting-period",field:E.accountingPeriod},{id:"config-journal-id",field:E.journalEntryId},{id:"config-company-name",field:E.companyName},{id:"config-payroll-provider",field:E.payrollProvider},{id:"config-accounting-link",field:E.accountingSoftware},{id:"config-user-name",field:E.reviewerName}].forEach(({id:n,field:a})=>{let o=e(n);a&&oe(a,o)})}function M(e,t=[]){let n=t.map(a=>q(a));return e.findIndex(a=>n.some(o=>a.includes(o)))}function ma(e){var w,R,x,$,j,D,V,S,I;let t=ve(2),n=(t==null?void 0:t.notes)||"",a=!!C.permanents[2],o=he(t==null?void 0:t.reviewer),s=(t==null?void 0:t.signOffDate)||"",r=!!(Se(C.completes[2])||s),l=L.roster||{},c=L.hasAnalyzed,i=(R=(w=L.roster)==null?void 0:w.difference)!=null?R:0,f=!L.skipAnalysis&&Math.abs(i)>0,g=(x=l.rosterCount)!=null?x:0,u=($=l.payrollCount)!=null?$:0,d=(j=l.difference)!=null?j:u-g,y=Array.isArray(l.mismatches)?l.mismatches.filter(Boolean):[],h="";L.loading?h=((V=(D=window.PrairieForge)==null?void 0:D.renderStatusBanner)==null?void 0:V.call(D,{type:"info",message:"Analyzing headcount\u2026",escapeHtml:k}))||"":L.lastError&&(h=((I=(S=window.PrairieForge)==null?void 0:S.renderStatusBanner)==null?void 0:I.call(S,{type:"error",message:L.lastError,escapeHtml:k}))||"");let b=(O,m,P,A)=>{let N=!c,z;N?z='<span class="pf-je-check-circle pf-je-circle--pending"></span>':A?z=`<span class="pf-je-check-circle pf-je-circle--pass">
    ...
    `}function ha(e){var d,y,h,b,p,v,w,R;let t=ve(3),n=!!C.permanents[3],a=he(t==null?void 0:t.reviewer),o=(t==null?void 0:t.signOffDate)||"",s=!!(Se(C.completes[3])||o),r=W.hasRun,{balanceIssues:l,zeroBalances:c,accrualOutliers:i,totalEmployees:f}=W,g="";if(W.loading)g=((y=(d=window.PrairieForge)==null?void 0:d.renderStatusBanner)==null?void 0:y.call(d,{type:"info",message:"Analyzing data quality...",escapeHtml:k}))||"";else if(r){let x=l.length,$=i.length+c.length;x>0?g=((b=(h=window.PrairieForge)==null?void 0:h.renderStatusBanner)==null?void 0:b.call(h,{type:"error",title:`${x} Balance Issue${x>1?"s":""} Found`,message:"Review the issues below. Fix in PTO_Data and re-run, or acknowledge to continue.",escapeHtml:k}))||"":$>0?g=((v=(p=window.PrairieForge)==null?void 0:p.renderStatusBanner)==null?void 0:v.call(p,{type:"warning",title:"No Critical Issues",message:`${$} informational item${$>1?"s":""} to review (see below).`,escapeHtml:k}))||"":g=((R=(w=window.PrairieForge)==null?void 0:w.renderStatusBanner)==null?void 0:R.call(w,{type:"success",title:"Data Quality Passed",message:`${f} employee${f!==1?"s":""} checked \u2014 no anomalies found.`,escapeHtml:k}))||""}let u=[];return r&&l.length>0&&u.push(`
            <div class="pf-quality-issue pf-quality-issue--critical">
                ...
                <ul class="pf-quality-issue-list">
                    ${l.slice(0,5).map(x=>`<li><strong>${k(x.name)}</strong>: ${k(x.issue)}</li>`).join("")}
    ...
    `}function va(e){let t=ve(4),n=!!C.permanents[4],a=he(t==null?void 0:t.reviewer),o=(t==null?void 0:t.signOffDate)||"",s=!!(Se(C.completes[4])||o);return`
        <section class="pf-hero" id="pf-step-hero">
            <p class="pf-hero-copy">${k(ge)} | Step ${e.id}</p>
            <h2 class="pf-hero-title">${k(e.title)}</h2>
            <p class="pf-hero-copy">${k(e.summary||"")}</p>
    ...
    `}function wa(){var t,n;return Math.abs((n=(t=L.roster)==null?void 0:t.difference)!=null?n:0)>0}function dt(){return!L.skipAnalysis&&wa()}async function rt(){if(!K()){L.loading=!1,L.lastError="Excel runtime is unavailable.",te();return}L.loading=!0,L.lastError=null,ie(document.getElementById("headcount-save-btn"),!1),te();try{let e=await Excel.run(async t=>{let n=t.workbook.worksheets.getItem("SS_Employee_Roster"),a=t.workbook.worksheets.getItem("PTO_Data"),o=t.workbook.worksheets.getItemOrNullObject("PTO_Analysis"),s=n.getUsedRangeOrNullObject(),r=a.getUsedRangeOrNullObject();s.load("values"),r.load("values"),o.load("isNullObject"),await t.sync();let l=null;o.isNullObject||(l=o.getUsedRangeOrNullObject(),l.load("values")),await t.sync();let c=s.isNullObject?[]:s.values||[],i=r.isNullObject?[]:r.values||[],f=l&&!l.isNullObject?l.values||[]:[],g=f.length?f:i;return ka(c,g)});L.roster=e.roster,L.hasAnalyzed=!0,L.lastError=null}catch(e){console.warn("PTO headcount: unable to analyze data",e),L.lastError="Unable to analyze headcount data. Try re-running the analysis."}finally{L.loading=!1,te()}}function en(e){if(!e)return!0;let t=e.toLowerCase().trim();return t?["total","subtotal","sum","count","grand","average","avg"].some(a=>t.includes(a)):!0}function ka(e,t){let n={rosterCount:0,payrollCount:0,difference:0,mismatches:[]};if(((e==null?void 0:e.length)||0)<2||((t==null?void 0:t.length)||0)<2)return console.warn("Headcount: insufficient data rows",{rosterRows:(e==null?void 0:e.length)||0,payrollRows:(t==null?void 0:t.length)||0}),{roster:n};let a=tn(e),o=tn(t),s=a.headers,r=o.headers,l={employee:nn(s),termination:s.findIndex(d=>d.includes("termination"))},c={employee:nn(r)};console.log("Headcount column detection:",{rosterEmployeeCol:l.employee,rosterTerminationCol:l.termination,payrollEmployeeCol:c.employee,rosterHeaders:s.slice(0,5),payrollHeaders:r.slice(0,5)});let i=new Set,f=new Set;for(let d=a.startIndex;d<e.length;d+=1){let y=e[d],h=l.employee>=0?ye(y[l.employee]):"";en(h)||l.termination>=0&&ye(y[l.termination])||i.add(h.toLowerCase())}for(let d=o.startIndex;d<t.length;d+=1){let y=t[d],h=c.employee>=0?ye(y[c.employee]):"";en(h)||f.add(h.toLowerCase())}n.rosterCount=i.size,n.payrollCount=f.size,n.difference=n.payrollCount-n.rosterCount,console.log("Headcount results:",{rosterCount:n.rosterCount,payrollCount:n.payrollCount,difference:n.difference});let g=[...i].filter(d=>!f.has(d)),u=[...f].filter(d=>!i.has(d));return n.mismatches=[...g.map(d=>`In roster, missing in PTO_Data: ${d}`),...u.map(d=>`In PTO_Data, missing in roster: ${d}`)],{roster:n}}function tn(e){if(!Array.isArray(e)||!e.length)return{headers:[],startIndex:1};let t=e.findIndex((o=[])=>o.some(s=>ye(s).toLowerCase().includes("employee"))),n=t===-1?0:t;return{headers:(e[n]||[]).map(o=>ye(o).toLowerCase()),startIndex:n+1}}function nn(e=[]){let t=-1,n=-1;return e.forEach((a,o)=>{let s=a.toLowerCase();if(!s.includes("employee"))return;let r=1;s.includes("name")?r=4:s.includes("id")?r=2:r=3,r>n&&(n=r,t=o)}),t}function ye(e){return e==null?"":String(e).trim()}async function mn(e=null){let t=async n=>{let a=n.workbook.worksheets.getItem("PTO_Data"),o=n.workbook.worksheets.getItemOrNullObject("PTO_Analysis"),s=n.workbook.worksheets.getItemOrNullObject("SS_Employee_Roster"),r=n.workbook.worksheets.getItemOrNullObject("PR_Archive_Summary"),l=n.workbook.worksheets.getItemOrNullObject("PTO_Archive_Summary"),c=a.getUsedRangeOrNullObject();c.load("values"),o.load("isNullObject"),s.load("isNullObject"),r.load("isNullObject"),l.load("isNullObject"),await n.sync();let i=c.isNullObject?[]:c.values||[];if(!i.length)return;let f=(i[0]||[]).map(_=>q(_)),g=f.findIndex(_=>_.includes("employee")&&_.includes("name")),u=g>=0?g:0,d=M(f,["accrual rate"]),y=M(f,["carry over","carryover"]),h=f.findIndex(_=>_.includes("ytd")&&(_.includes("accrued")||_.includes("accrual"))),b=f.findIndex(_=>_.includes("ytd")&&_.includes("used")),p=M(f,["balance","current balance","pto balance"]);console.log("[PTO Analysis] PTO_Data headers:",f),console.log("[PTO Analysis] Column indices found:",{employee:u,accrualRate:d,carryOver:y,ytdAccrued:h,ytdUsed:b,balance:p}),b>=0?console.log(`[PTO Analysis] YTD Used column: "${f[b]}" at index ${b}`):console.warn("[PTO Analysis] YTD Used column NOT FOUND. Headers:",f);let v=i.slice(1).map(_=>ye(_[u])).filter(_=>_&&!_.toLowerCase().includes("total")),w=new Map;i.slice(1).forEach(_=>{let G=q(_[u]);!G||G.includes("total")||w.set(G,_)});let R=new Map;if(s.isNullObject)console.warn("[PTO Analysis] SS_Employee_Roster sheet not found");else{let _=s.getUsedRangeOrNullObject();_.load("values"),await n.sync();let G=_.isNullObject?[]:_.values||[];if(G.length){let H=(G[0]||[]).map(T=>q(T));console.log("[PTO Analysis] SS_Employee_Roster headers:",H);let F=H.findIndex(T=>T.includes("employee")&&T.includes("name"));F<0&&(F=H.findIndex(T=>T==="employee"||T==="name"||T==="full name"));let U=H.findIndex(T=>T.includes("department"));console.log(`[PTO Analysis] Roster column indices - Name: ${F}, Dept: ${U}`),F>=0&&U>=0?(G.slice(1).forEach(T=>{let ae=q(T[F]),ce=ye(T[U]);ae&&R.set(ae,ce)}),console.log(`[PTO Analysis] Built roster map with ${R.size} employees`)):console.warn("[PTO Analysis] Could not find Name or Department columns in SS_Employee_Roster")}}let x=new Map;if(!r.isNullObject){let _=r.getUsedRangeOrNullObject();_.load("values"),await n.sync();let G=_.isNullObject?[]:_.values||[];if(G.length){let H=(G[0]||[]).map(U=>q(U)),F={payrollDate:M(H,["payroll date"]),employee:M(H,["employee"]),category:M(H,["payroll category","category"]),amount:M(H,["amount","gross salary","gross_salary","earnings"])};F.employee>=0&&F.category>=0&&F.amount>=0&&G.slice(1).forEach(U=>{let T=q(U[F.employee]);if(!T)return;let ae=q(U[F.category]);if(!ae.includes("regular")||!ae.includes("earn"))return;let ce=Number(U[F.amount])||0;if(!ce)return;let Ee=fa(U[F.payrollDate]),_e=x.get(T);(!_e||Ee!=null&&Ee>_e.timestamp)&&x.set(T,{payRate:ce/80,timestamp:Ee})})}}let $=new Map;if(!l.isNullObject){let _=l.getUsedRangeOrNullObject();_.load("values"),await n.sync();let G=_.isNullObject?[]:_.values||[];if(G.length>1){let H=(G[0]||[]).map(T=>q(T)),F=H.findIndex(T=>T.includes("employee")&&T.includes("name")),U=M(H,["liability amount","liability","accrued pto"]);F>=0&&U>=0&&G.slice(1).forEach(T=>{let ae=q(T[F]);if(!ae)return;let ce=Number(T[U])||0;$.set(ae,ce)})}}let j=se(E.payrollDate)||"",D=[],V=[],S=v.map((_,G)=>{var pt,gt,mt,yt,ht,vt,bt;let H=q(_),F=R.get(H)||"",U=(gt=(pt=x.get(H))==null?void 0:pt.payRate)!=null?gt:"",T=w.get(H),ae=T&&d>=0&&(mt=T[d])!=null?mt:"",ce=T&&y>=0&&(yt=T[y])!=null?yt:"",Ee=T&&h>=0&&(ht=T[h])!=null?ht:"",_e=T&&b>=0&&(vt=T[b])!=null?vt:"";(H.includes("avalos")||H.includes("sarah"))&&console.log(`[PTO Debug] ${_}:`,{ytdUsedIdx:b,rawValue:T?T[b]:"no dataRow",ytdUsed:_e,fullRow:T});let Ue=T&&p>=0&&Number(T[p])||0,ut=G+2;!U&&typeof U!="number"&&D.push({name:_,rowIndex:ut}),F||V.push({name:_,rowIndex:ut});let Ge=typeof U=="number"&&Ue?Ue*U:0,ft=(bt=$.get(H))!=null?bt:0,yn=(typeof Ge=="number"?Ge:0)-ft;return[j,_,F,U,ae,ce,Ee,_e,Ue,Ge,ft,yn]});X.missingPayRates=D.filter(_=>!X.ignoredMissingPayRates.has(_.name)),X.missingDepartments=V,console.log(`[PTO Analysis] Data quality: ${D.length} missing pay rates, ${V.length} missing departments`);let I=[["Analysis Date","Employee Name","Department","Pay Rate","Accrual Rate","Carry Over","YTD Accrued","YTD Used","Balance","Liability Amount","Accrued PTO $ [Prior Period]","Change"],...S],O=o.isNullObject?n.workbook.worksheets.add("PTO_Analysis"):o,m=O.getUsedRangeOrNullObject();m.load("address"),await n.sync(),m.isNullObject||m.clear();let P=I[0].length,A=I.length,N=S.length,z=O.getRangeByIndexes(0,0,A,P);z.values=I;let le=O.getRangeByIndexes(0,0,1,P);ot(le),N>0&&(Jt(O,0,N),fe(O,3,N),ke(O,4,N),ke(O,5,N),ke(O,6,N),ke(O,7,N),ke(O,8,N),fe(O,9,N),fe(O,10,N),fe(O,11,N,!0)),z.format.autofitColumns(),O.getRange("A1").select(),await n.sync()};K()&&(e?await t(e):await Excel.run(t))}function Oa(e=[]){return e.map(t=>(t||[]).map(n=>{if(n==null)return"";let a=String(n);return/[",\n]/.test(a)?`"${a.replace(/"/g,'""')}"`:a}).join(",")).join(`
`)}function Sa(e,t){let n=new Blob([t],{type:"text/csv;charset=utf-8;"}),a=URL.createObjectURL(n),o=document.createElement("a");o.href=a,o.download=e,document.body.appendChild(o),o.click(),o.remove(),setTimeout(()=>URL.revokeObjectURL(a),1e3)}function an(){let e=document.getElementById("headcount-signoff-toggle");if(!e)return;let t=dt(),n=document.getElementById("step-notes-input"),a=(n==null?void 0:n.value.trim())||"";e.disabled=t&&!a;let o=document.getElementById("headcount-notes-hint");o&&(o.textContent=t?"Please document outstanding differences before signing off.":"")}function on(){let e=document.getElementById("step-notes-input");if(!e)return;let t=e.value||"",n=t.startsWith(me)?t.slice(me.length).replace(/^\s+/,""):t.replace(new RegExp(`^${me}\\s*`,"i"),"").trimStart(),a=me+(n?`
${n}`:"");e.value!==a&&(e.value=a),ee(2,"notes",e.value)}function Ea(){let e=document.getElementById("step-notes-input");e&&e.addEventListener("input",()=>{if(!L.skipAnalysis)return;let t=e.value||"";if(!t.startsWith(me)){let n=t.replace(me,"").trimStart();e.value=me+(n?`
${n}`:"")}ee(2,"notes",e.value)})}function _a(){var n;let e=dt(),t=((n=document.getElementById("step-notes-input"))==null?void 0:n.value.trim())||"";if(e&&!t){Q("Please enter a brief explanation of the outstanding differences before completing this step.","info");return}}})();
