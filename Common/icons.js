...
// File/Report icon for Payroll Provider Report
export const FILE_TEXT_ICON_SVG = `
    <svg
        class="pf-icon pf-nav-icon"
        viewBox="0 0 24 24"
        fill="none"
...
// Globe/Map icon for column mapping
...
// Grid/Matrix icon for Create Matrix button
export const GRID_ICON_SVG = `
    <svg
        class="pf-icon pf-nav-icon"
        viewBox="0 0 24 24"
        fill="none"
...
// Clipboard/List icon for Roster Updates
export const CLIPBOARD_LIST_ICON_SVG = `
    <svg
        class="pf-icon pf-nav-icon"
        viewBox="0 0 24 24"
        fill="none"
