...
`.trim();function Je(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Vt(e,t){return`
    ...
    `}function Uo(e){switch(e){case 0:return{title:"Configuration",content:`
                ...
                `}}}sn(()=>Go());async function Go(){try{await zo(),await Xn();let e=Tt(kt);await Ot(e.sheetName,e.title,e.subtitle),ce()}catch(e){throw console.error("[Payroll] Module initialization failed:",e),e}}async function zo(){try{await $t(kt),console.log(`[Payroll] Tab visibility applied for ${kt}`)}catch(e){console.warn("[Payroll] Could not apply tab visibility:",e)}}function ce(){var r;let e=document.body;if(!e)return;let t=ne.focusedIndex<=0?"disabled":"",n=ne.focusedIndex>=be.length-1?"disabled":"",o=ne.activeView==="config",a=ne.activeView==="step",s=!o&&!a,l=o?Yo():a?ta(ne.activeStepId):Jo();e.innerHTML=`
        <div class="pf-root">
            ${Wo(t,n)}
            ${l}
            ${oa()}
        </div>
    `;let c=document.getElementById("pf-info-fab-payroll");if(s)c&&c.remove();else if((r=window.PrairieForge)!=null&&r.mountInfoFab){let i=Uo(ne.activeStepId);PrairieForge.mountInfoFab({title:i.title,content:i.content,buttonId:"pf-info-fab-payroll"})}if(sa(),o)ca();else if(a)try{da(ne.activeStepId)}catch(i){console.warn("Payroll Recorder: failed to bind step interactions",i)}else la();pa(),s?mn():Lt()}function Wo(e,t){let n=O("SS_Company_Name")||"your company";return`
    ...
    `}function Jo(){return`
        <section class="pf-hero" id="pf-hero">
            ...
            <p class="pf-hero-hint">${x(ne.statusText||"")}</p>
        </section>
        <section class="pf-step-guide">
            <div class="pf-step-grid">
                ${be.map((e,t)=>na(e,t)).join("")}
            </div>
        </section>
    `}function Yo(){if(!Y.loaded)return`
        ...
        `;let e=Ie[0],t=ye(Ct()),n=ye(O("PR_Accounting_Period")),o=O("PR_Journal_Entry_ID"),a=O("SS_Accounting_Software"),s=Xt(),l=O("SS_Company_Name"),c=O(Ke)||Ae(),r=e?O(e.note):"",i=e?Re(e.note):!1,u=(e?O(e.reviewer):"")||Ae(),p=e?ye(O(e.signOff)):"",f=!!(p||O(pe[0]));return`
    ...
    `}function qo(e){let t=Se(1),n=t?Re(t.note):!1,o=t?O(t.note):"",a=(t?O(t.reviewer):"")||Ae(),s=t?ye(O(t.signOff)):"",l=!!(s||O(pe[1])),c=Xt();return`
        ...
        <section class="pf-step-guide">
            <article class="pf-step-card pf-step-detail pf-config-card">
                ...
                <div class="pf-signoff-action">
                    ${ge(c?`<a href="${x(c)}" target="_blank" rel="noopener noreferrer" class="pf-action-toggle pf-clickable" title="Open payroll provider">${ft}</a>`:`<button type="button" class="pf-action-toggle pf-clickable" id="import-provider-btn" disabled title="Add provider link in Configuration">${ft}</button>`,"Provider")}
                    ${ge(`<button type="button" class="pf-action-toggle pf-clickable" id="import-open-data-btn" title="Open PR_Data sheet">${dt}</button>`,"PR_Data")}
                    ${ge(`<button type="button" class="pf-action-toggle pf-clickable" id="import-clear-btn" title="Clear PR_Data to start over">${Pn}</button>`,"Clear")}
                </div>
            </article>
            ${t?`
    ...
    `}function Ko(e){var A,B,S,I,g,P,D,G,Q,J;let t=Se(2),n=t?O(t.note):"",o=t?Re(t.note):!1,a=(t?O(t.reviewer):"")||Ae(),s=t?ye(O(t.signOff)):"",l=!!(s||O(pe[2])),c=St(),r=H.roster||{},i=H.departments||{},u=H.hasAnalyzed,p="";H.loading?p='<p class="pf-step-note">Analyzing roster and payroll data\u2026</p>':H.lastError&&(p=`<p class="pf-step-note">${x(H.lastError)}</p>`);let f=(M,K,oe)=>{let xe=!u,Z;xe?Z='<span class="pf-je-check-circle pf-je-circle--pending"></span>':oe?Z=`<span class="pf-je-check-circle pf-je-circle--pass">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg>
            </span>`:Z=`<span class="pf-je-check-circle pf-je-circle--fail">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
            </span>`;let ee=u?` = ${K}`:"";return`
            <div class="pf-je-check-row">
                ${Z}
                <span class="pf-je-check-desc-pill">${x(M)}${ee}</span>
            </div>
        `},d=(A=r.difference)!=null?A:0,h=(B=i.difference)!=null?B:0,v=Array.isArray(r.mismatches)?r.mismatches.filter(Boolean):[],w=Array.isArray(i.mismatches)?i.mismatches.filter(Boolean):[],m=`
        ${f("SS_Employee_Roster count",(S=r.rosterCount)!=null?S:"\u2014",!0)}
        ${f("PR_Data employee count",(I=r.payrollCount)!=null?I:"\u2014",!0)}
        ${f("Difference",d,d===0)}
    `,b=`
        ${f("Expected departments",(g=i.rosterCount)!=null?g:"\u2014",!0)}
        ${f("PR_Data departments",(P=i.payrollCount)!=null?P:"\u2014",!0)}
        ${f("Difference",h,h===0)}
    `,k=v.length&&!H.skipAnalysis&&u&&((G=(D=window.PrairieForge)==null?void 0:D.renderMismatchTiles)==null?void 0:G.call(D,{mismatches:v,label:"Employees Driving the Difference",sourceLabel:"Roster",targetLabel:"Payroll Data",escapeHtml:x}))||"",_=w.length&&!H.skipAnalysis&&u&&((J=(Q=window.PrairieForge)==null?void 0:Q.renderMismatchTiles)==null?void 0:J.call(Q,{mismatches:w,label:"Employees with Department Differences",formatter:M=>({name:M.employee||M.name||"",source:`${M.rosterDept||"\u2014"} \u2192 ${M.payrollDept||"\u2014"}`,isMissingFromTarget:!0}),escapeHtml:x}))||"";return`
        <section class="pf-hero" id="pf-step-hero">
            <p class="pf-hero-copy">${x(Pe)} | Step ${e.id}</p>
        ...
        <section class="pf-step-guide">
            <article class="pf-step-card pf-step-detail pf-config-card">
                ...
                <div class="pf-signoff-action">
                    ...
                    ${ge(`<button type="button" class="pf-action-toggle pf-clickable" id="roster-refresh-btn" title="Refresh analysis">${We}</button>`,"Refresh")}
                </div>
            </article>
            <article class="pf-step-card pf-step-detail pf-config-card">
                <div class="pf-config-head">
    ...
    `}function Xo(e){var A;let t=Se(3),n=t?O(t.note):"",o=(t?O(t.reviewer):"")||Ae(),a=t?ye(O(t.signOff)):"",s=V.loading?'<p class="pf-step-note">Preparing reconciliation data\u2026</p>':V.lastError?`<p class="pf-step-note">${x(V.lastError)}</p>`:"",l=!!(a||O(pe[3])),c=V.prDataTotal!==null,r=V.prDataTotal,i=V.cleanTotal,u=(A=V.reconDifference)!=null?A:r!=null&&i!=null?r-i:null,p=u!==null&&Math.abs(u)<.01,f=le(V.cleanTotal),d=V.bankDifference!=null?le(V.bankDifference):"---",h=V.bankDifference==null?"":Math.abs(V.bankDifference)<.5?"Difference within acceptable tolerance.":"Difference exceeds tolerance and should be resolved.",v=to(V.bankAmount),w=(B,S,I)=>{let g=!c,P;return g?P='<span class="pf-je-check-circle pf-je-circle--pending"></span>':I?P=`<span class="pf-je-check-circle pf-je-circle--pass">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg>
        ...
        <section class="pf-step-guide">
            <article class="pf-step-card pf-step-detail pf-config-card">
                ...
                <div class="pf-signoff-action">
                    ...
                    ${ge(`<button type="button" class="pf-action-toggle pf-clickable" id="validation-refresh-btn" title="Refresh reconciliation">${We}</button>`,"Refresh")}
                </div>
            </article>
            <article class="pf-step-card pf-step-detail pf-config-card">
                <div class="pf-config-head">
    ...
    `}function Qo(e){let t=Se(4),n=t?O(t.note):"",o=(t?O(t.reviewer):"")||Ae(),a=t?ye(O(t.signOff)):"",s=!!(a||O(pe[4])),l=Ce.loading?'<p class="pf-step-note">Preparing executive summary\u2026</p>':Ce.lastError?`<p class="pf-step-note">${x(Ce.lastError)}</p>`:"",c=cn({id:"expense-review-copilot",body:"Want help analyzing your data? Just ask!",placeholder:"Where should I focus this pay period?",buttonLabel:"Ask CoPilot"});return`
        <section class="pf-hero" id="pf-step-hero">
            <p class="pf-hero-copy">${x(Pe)} | Step ${e.id}</p>
            <h2 class="pf-hero-title">${x(e.title)}</h2>
        ...
        <section class="pf-step-guide">
            ...
            <article class="pf-step-card pf-step-detail pf-config-card">
                ...
                <div class="pf-signoff-action">
                    ...
                    ${ge(`<button type="button" class="pf-action-toggle" id="expense-refresh-btn" title="Refresh expense data">${We}</button>`,"Refresh")}
                </div>
            </article>
            ${Ho()}
                ${c}
    ...
    `}function Zo(e){var A,B,S;let t=Se(5),n=t?O(t.note):"",o=t?Re(t.note):!1,a=(t?O(t.reviewer):"")||Ae(),s=t?ye(O(t.signOff)):"",l=!!(s||O(pe[5])),c=z.lastError?`<p class="pf-step-note">${x(z.lastError)}</p>`:"",r=z.debitTotal!==null,i=(A=z.debitTotal)!=null?A:0,u=(B=z.creditTotal)!=null?B:0,p=i-u,f=(S=V.cleanTotal)!=null?S:0,d=r,h=r&&Math.abs(p-f)<.01,v=(I,g)=>{let P=!r,D;return P?D='<span class="pf-je-check-circle pf-je-circle--pending"></span>':g?D=`<span class="pf-je-check-circle pf-je-circle--pass">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg>
        ...
        `},w=r?le(i):"\u2014",m=r?le(u):"\u2014",b=r?le(p):"\u2014",k=r?le(f):"\u2014",_=`
        ${v(`Total Debits = ${w}`,d)}
        ${v(`Total Credits = ${m}`,d)}
        ${v(`Line Amount (Debit - Credit) = ${b}`,d)}
        ${v(`JE Total matches PR_Data_Clean (${k})`,h)}
    `;return`
        <section class="pf-hero" id="pf-step-hero">
            <p class="pf-hero-copy">${x(Pe)} | Step ${e.id}</p>
            <h2 class="pf-hero-title">${x(e.title)}</h2>
        ...
        <section class="pf-step-guide">
            <article class="pf-step-card pf-step-detail pf-config-card">
                ...
                <div class="pf-signoff-action">
                    ${ge(`<button type="button" class="pf-action-toggle pf-clickable" id="je-create-btn" title="Generate from PR_Data_Clean">${dt}</button>`,"Generate")}
                    ${ge(`<button type="button" class="pf-action-toggle pf-clickable" id="je-run-btn" title="Refresh validation">${We}</button>`,"Refresh")}
                    ${ge(`<button type="button" class="pf-action-toggle pf-clickable" id="je-export-btn" title="Export as CSV">${Sn}</button>`,"Export")}
                </div>
            </article>
            <article class="pf-step-card pf-step-detail pf-config-card">
                <div class="pf-config-head">
    ...
    `}function ea(e){let t=be.filter(a=>a.id!==6).map(a=>({id:a.id,title:a.title,complete:ha(a.id)})),n=t.every(a=>a.complete),o=t.map(a=>`
            <article class="pf-step-card pf-step-detail pf-config-card">
                <div class="pf-config-head pf-notes-header">
    ...
    `}function ta(e){let t=it.find(_=>_.id===e)||{id:e!=null?e:"-",title:"Workflow Step",summary:"",description:"",checklist:[]};if(e===1)return qo(t);if(e===2)return Ko(t);if(e===3)return Xo(t);if(e===4)return Qo(t);if(e===5)return Zo(t);if(e===6)return ea(t);let n=!1,o=Se(e),a=o?O(o.note):"",s=o?Re(o.note):!1,l=(o?O(o.reviewer):"")||Ae(),c=o?ye(O(o.signOff)):"",r=o&&pe[e]?!!(c||O(pe[e])):!!c,i=(t.highlights||[]).map(_=>`
        ...
        `).join(""),u=(t.checklist||[]).map(_=>`<li>${x(_)}</li>`).join("")||"",p=n?"":t.description||"Detailed guidance will appear here.",f=[];!n&&t.ctaLabel&&f.push(`<button type="button" class="pf-pill-btn" id="step-action-btn">${x(t.ctaLabel)}</button>`),n||f.push('<button type="button" class="pf-pill-btn pf-pill-btn--ghost" id="step-back-btn">Back to Step List</button>');let d=f.length?`<div class="pf-pill-row pf-config-actions">${f.join("")}</div>`:"",h=Xt(),v=n?`
    ...
    `}function na(e,t){let n=ne.focusedIndex===t?"pf-step-card--active":"",o=Rn(aa(e.id));return`
...
${n}`:"");if(e.value!==o){e.value=o;let a=Se(2);a&&U(a.note,o)}}function Wn(e){let t=e!=null&&e.target&&e.target instanceof HTMLInputElement?e.target:document.getElementById("bank-amount-input"),n=Qt(t==null?void 0:t.value),o=to(n);t&&(t.value=o),qe({bankAmount:n},{rerender:!1})}function La(){let e=be.findIndex(t=>t.id===3);e!==-1&&Ze(Math.min(be.length-1,e+1))}function Ma(){let e=be.findIndex(t=>t.id===4);e!==-1&&Ze(Math.min(be.length-1,e+1))}async function Ba(){if(!se()){window.alert("Excel runtime is unavailable.");return}if(window.confirm(`Archive Payroll Run
