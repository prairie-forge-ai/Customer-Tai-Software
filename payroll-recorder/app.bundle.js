...
- Missing or incomplete mappings`},Lt=[];function pn(e={}){var o;let t={...dn,...e},n=((o=t.quickActions)==null?void 0:o.map(a=>`<button type="button" class="pf-ada-chip" data-action="${a.id}" data-prompt="${Do(a.prompt)}">${a.label}</button>`).join(""))||"";return`
...
I'm reading your actual spreadsheet data, so I can give you specific answers!`}var gn=ut.ADA_IMAGE_URL;async function Bt(e,t,n){if(typeof Excel=="undefined"){console.warn("Excel runtime not available for homepage sheet");return}try{await Excel.run(async o=>{let a=o.workbook.worksheets.getItemOrNullObject(e);a.load("isNullObject, name"),await o.sync();let s;a.isNullObject?(s=o.workbook.worksheets.add(e),await o.sync(),await fn(o,s,t,n)):(s=a,await fn(o,s,t,n)),s.activate(),s.getRange("A1").select(),await o.sync()})}catch(o){console.error(`Error activating homepage sheet ${e}:`,o)}}async function fn(e,t,n,o){try{let i=t.getUsedRangeOrNullObject();i.load("isNullObject"),await e.sync(),i.isNullObject||(i.clear(),await e.sync())}catch{}t.showGridlines=!1,t.getRange("A:A").format.columnWidth=400,t.getRange("B:B").format.columnWidth=50,t.getRange("1:1").format.rowHeight=60,t.getRange("2:2").format.rowHeight=30;let a=[[n,""],[o,""],["",""],["",""]],s=t.getRangeByIndexes(0,0,4,2);s.values=a;let l=t.getRange("A1:Z100");l.format.fill.color="#0f0f0f";let c=t.getRange("A1");c.format.font.bold=!0,c.format.font.size=36,c.format.font.color="#ffffff",c.format.font.name="Segoe UI Light",c.format.verticalAlignment="Center";let r=t.getRange("A2");r.format.font.size=14,r.format.font.color="#a0a0a0",r.format.font.name="Segoe UI",r.format.verticalAlignment="Top",t.freezePanes.freezeRows(0),t.freezePanes.freezeColumns(0),await e.sync()}var mn={"module-selector":{sheetName:"SS_Homepage",title:"ForgeSuite",subtitle:"Select a module from the side panel to get started."},"payroll-recorder":{sheetName:"PR_Homepage",title:"Payroll Recorder",subtitle:"Normalize payroll exports, enforce controls, and prep journal entries without leaving Excel."},"pto-accrual":{sheetName:"PTO_Homepage",title:"PTO Accrual",subtitle:"Calculate employee PTO liabilities, compare period-over-period changes, and prepare accrual journal entries."}};function Ft(e){return mn[e]||mn["module-selector"]}function hn(){Vt();let e=document.createElement("button");return e.className="pf-ada-fab",e.id="pf-ada-fab",e.setAttribute("aria-label","Ask Ada"),e.setAttribute("title","Ask Ada"),e.innerHTML=`
        ...
        />
    `,document.body.appendChild(e),e.addEventListener("click",$o),e}function Vt(){let e=document.getElementById("pf-ada-fab");e&&e.remove();let t=document.getElementById("pf-ada-modal-overlay");t&&t.remove()}function $o(){let e=document.getElementById("pf-ada-modal-overlay");e&&e.remove();let t=document.createElement("div");t.className="pf-ada-modal-overlay",t.id="pf-ada-modal-overlay",t.innerHTML=`
        <div class="pf-ada-modal">
            <div class="pf-ada-modal__header">
                ...
                <img class="pf-ada-modal__avatar" src="${gn}" alt="Ada" />
    ...
    `,document.body.appendChild(t),requestAnimationFrame(()=>{t.classList.add("is-visible")});let n=document.getElementById("ada-modal-close");n==null||n.addEventListener("click",Mt),t.addEventListener("click",a=>{a.target===t&&Mt()});let o=a=>{a.key==="Escape"&&(Mt(),document.removeEventListener("keydown",o))};document.addEventListener("keydown",o)}function Mt(){let e=document.getElementById("pf-ada-modal-overlay");e&&(e.classList.remove("is-visible"),setTimeout(()=>{e.remove()},300))}var Io=["January","February","March","April","May","June","July","August","September","October","November","December"],bn=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],No=["Su","Mo","Tu","We","Th","Fr","Sa"],Fe=null;function wn(e,t={}){let n=document.getElementById(e);if(!n)return;let{onChange:o=null,minDate:a=null,maxDate:s=null,readonly:l=!1}=t,c=n.closest(".pf-datepicker-wrapper");c||(c=document.createElement("div"),c.className="pf-datepicker-wrapper",n.parentNode.insertBefore(c,n),c.appendChild(n)),n.type="text",n.readOnly=!0,n.classList.add("pf-datepicker-input");let r=n.value?yn(n.value):null,i=r?new Date(r):new Date;r&&(n.value=vn(r));let u=document.createElement("span");u.className="pf-datepicker-icon",u.innerHTML='<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>',c.appendChild(u);let p=document.createElement("div");p.className="pf-datepicker-dropdown",p.id=`${e}-dropdown`,c.appendChild(p);function f(){var k,_,A,B,S,I;let m=i.getFullYear(),b=i.getMonth();p.innerHTML=`
        ...
        `,(k=p.querySelector(".pf-datepicker-prev-year"))==null||k.addEventListener("click",g=>{g.stopPropagation(),i.setFullYear(i.getFullYear()-1),f()}),(_=p.querySelector(".pf-datepicker-prev"))==null||_.addEventListener("click",g=>{g.stopPropagation(),i.setMonth(i.getMonth()-1),f()}),(A=p.querySelector(".pf-datepicker-next"))==null||A.addEventListener("click",g=>{g.stopPropagation(),i.setMonth(i.getMonth()+1),f()}),(B=p.querySelector(".pf-datepicker-next-year"))==null||B.addEventListener("click",g=>{g.stopPropagation(),i.setFullYear(i.getFullYear()+1),f()}),p.querySelectorAll(".pf-datepicker-day:not(.disabled)").forEach(g=>{g.addEventListener("click",P=>{P.stopPropagation();let D=parseInt(g.dataset.day),G=parseInt(g.dataset.month),Q=parseInt(g.dataset.year);h(new Date(Q,G,D))})}),(S=p.querySelector(".pf-datepicker-today"))==null||S.addEventListener("click",g=>{g.stopPropagation(),h(new Date)}),(I=p.querySelector(".pf-datepicker-clear"))==null||I.addEventListener("click",g=>{g.stopPropagation(),h(null)})}function d(m,b,k){let _=new Date(m,b,1).getDay(),A=new Date(m,b+1,0).getDate(),B=new Date(m,b,0).getDate(),S=new Date;S.setHours(0,0,0,0);let I="";for(let D=_-1;D>=0;D--){let G=B-D,Q=b===0?11:b-1,J=b===0?m-1:m;I+=`<span class="pf-datepicker-day other-month" data-day="${G}" data-month="${Q}" data-year="${J}">${G}</span>`}for(let D=1;D<=A;D++){let G=new Date(m,b,D),Q=G.getTime()===S.getTime(),J=k&&G.getTime()===k.getTime(),F="pf-datepicker-day";Q&&(F+=" today"),J&&(F+=" selected"),a&&G<a&&(F+=" disabled"),s&&G>s&&(F+=" disabled"),I+=`<span class="${F}" data-day="${D}" data-month="${b}" data-year="${m}">${D}</span>`}let P=Math.ceil((_+A)/7)*7-(_+A);for(let D=1;D<=P;D++){let G=b===11?0:b+1,Q=b===11?m+1:m;I+=`<span class="pf-datepicker-day other-month" data-day="${D}" data-month="${G}" data-year="${Q}">${D}</span>`}return I}function h(m){r=m,m?(n.value=vn(m),n.dataset.value=jt(m),i=new Date(m)):(n.value="",n.dataset.value=""),w(),o&&o(m?jt(m):""),n.dispatchEvent(new Event("change",{bubbles:!0}))}function y(){if(!l){if(Fe&&Fe!==e){let m=document.getElementById(`${Fe}-dropdown`);m==null||m.classList.remove("open")}Fe=e,f(),p.classList.add("open"),c.classList.add("open")}}function w(){p.classList.remove("open"),c.classList.remove("open"),Fe===e&&(Fe=null)}return n.addEventListener("click",m=>{m.stopPropagation(),p.classList.contains("open")?w():y()}),u.addEventListener("click",m=>{m.stopPropagation(),p.classList.contains("open")?w():y()}),document.addEventListener("click",m=>{c.contains(m.target)||w()}),document.addEventListener("keydown",m=>{m.key==="Escape"&&w()}),{getValue:()=>r?jt(r):"",setValue:m=>{let b=yn(m);h(b)},open:y,close:w}}function yn(e){if(!e)return null;if(/^\d{4}-\d{2}-\d{2}$/.test(e)){let[o,a,s]=e.split("-").map(Number);return new Date(o,a-1,s)}let t=e.match(/^(\w+)\s+(\d+),\s+(\d{4})$/);if(t){let o=bn.findIndex(a=>a.toLowerCase()===t[1].toLowerCase().substring(0,3));if(o>=0)return new Date(parseInt(t[3]),o,parseInt(t[2]))}if(/^\d{1,2}\/\d{1,2}\/\d{4}$/.test(e)){let[o,a,s]=e.split("/").map(Number);return new Date(s,o-1,a)}let n=new Date(e);return isNaN(n.getTime())?null:n}function vn(e){return e?`${bn[e.getMonth()]} ${e.getDate()}, ${e.getFullYear()}`:""}function jt(e){if(!e)return"";let t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${t}-${n}-${o}`}var En=`
    <svg
...
`.trim(),Oo={config:`
    ...
    `};function xn(e){return e&&Oo[e]||""}var Ht=`
    <svg
...
`.trim();function Xe(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Gt(e,t){return`
        <div class="pf-labeled-btn">
            ${e}
            <span class="pf-btn-label">${t}</span>
        </div>
    `}function De({textareaId:e,value:t,permanentId:n,isPermanent:o,hintId:a,saveButtonId:s,isSaved:l=!1,placeholder:c="Enter notes here..."}){let r=o?Ut:Ht,i=s?`<button type="button" class="pf-action-toggle pf-save-btn ${l?"is-saved":""}" id="${s}" data-save-input="${e}" title="Save notes">${Pn}</button>`:"",u=n?`<button type="button" class="pf-action-toggle pf-notes-lock ${o?"is-locked":""}" id="${n}" aria-pressed="${o}" title="Lock notes (retain after archive)">${r}</button>`:"";return`
        <article class="pf-step-card pf-step-detail pf-notes-card">
            ...
            <div class="pf-notes-body">
                <textarea id="${e}" rows="6" placeholder="${Xe(c)}">${Xe(t||"")}</textarea>
    ...
    `}function Qe(e,t){e&&(e.classList.toggle("is-locked",t),e.setAttribute("aria-pressed",String(t)),e.innerHTML=t?Ut:Ht)}function Ve(e,t){e&&e.classList.toggle("is-saved",t)}function zt(e=document){let t=e.querySelectorAll(".pf-save-btn[data-save-input]"),n=[];return t.forEach(o=>{let a=o.getAttribute("data-save-input"),s=document.getElementById(a);if(!s)return;let l=()=>{Ve(o,!1)};s.addEventListener("input",l),n.push(()=>s.removeEventListener("input",l))}),()=>n.forEach(o=>o())}function Nn(e,t){if(e===0)return{canComplete:!0,blockedBy:null,message:""};for(let n=0;n<e;n++)if(!t[n])return{canComplete:!1,blockedBy:n,message:`Complete Step ${n} before signing off on this step.`};return{canComplete:!0,blockedBy:null,message:""}}function On(e){let t=document.querySelector(".pf-workflow-toast");t&&t.remove();let n=document.createElement("div");n.className="pf-workflow-toast pf-workflow-toast--warning",n.innerHTML=`
        <span class="pf-workflow-toast-icon">\u26A0\uFE0F</span>
        <span class="pf-workflow-toast-message">${e}</span>
    `,document.body.appendChild(n),requestAnimationFrame(()=>{n.classList.add("pf-workflow-toast--visible")}),setTimeout(()=>{n.classList.remove("pf-workflow-toast--visible"),setTimeout(()=>n.remove(),300)},4e3)}var Wt={fillColor:"#000000",fontColor:"#FFFFFF",bold:!0},Jt={currency:"$#,##0.00",currencyWithNegative:"$#,##0.00;($#,##0.00)",number:"#,##0.00",integer:"#,##0",percent:"0.00%",date:"yyyy-mm-dd",dateTime:"yyyy-mm-dd hh:mm"};function Tn(e){e.format.fill.color=Wt.fillColor,e.format.font.color=Wt.fontColor,e.format.font.bold=Wt.bold}function yt(e,t,n,o=!1){if(n<=0)return;let a=e.getRangeByIndexes(1,t,n,1);a.numberFormat=[[o?Jt.currencyWithNegative:Jt.currency]]}function Ln(e,t,n,o=Jt.date){if(n<=0)return;let a=e.getRangeByIndexes(1,t,n,1);a.numberFormat=[[o]]}var St="payroll-recorder";var $e="Payroll Recorder",Ls=$.CONFIG||"SS_PF_Config",Yt=["SS_PF_Config"];var To="Normalize payroll exports, enforce controls, and prep journal entries without leaving Excel. Every run follows the same guidance so you stay audit-ready.",we=dt.map(({id:e,title:t})=>({id:e,title:t})),M={TYPE:0,FIELD:1,VALUE:2,PERMANENT:3,TITLE:-1},Lo="Run Settings";var Mn="N";var Mo="PR_JE_Debit_Total",Bo="PR_JE_Credit_Total",Fo="PR_JE_Difference",Ne={0:{note:"PR_Notes_Config",reviewer:"PR_Reviewer_Config",signOff:"PR_SignOff_Config"},1:{note:"PR_Notes_Import",reviewer:"PR_Reviewer_Import",signOff:"PR_SignOff_Import"},2:{note:"PR_Notes_Headcount",reviewer:"PR_Reviewer_Headcount",signOff:"PR_SignOff_Headcount"},3:{note:"PR_Notes_Validate",reviewer:"PR_Reviewer_Validate",signOff:"PR_SignOff_Validate"},4:{note:"PR_Notes_Review",reviewer:"PR_Reviewer_Review",signOff:"PR_SignOff_Review"},5:{note:"PR_Notes_JE",reviewer:"PR_Reviewer_JE",signOff:"PR_SignOff_JE"},6:{note:"PR_Notes_Archive",reviewer:"PR_Reviewer_Archive",signOff:"PR_SignOff_Archive"}},me={0:"PR_Complete_Config",1:"PR_Complete_Import",2:"PR_Complete_Headcount",3:"PR_Complete_Validate",4:"PR_Complete_Review",5:"PR_Complete_JE",6:"PR_Complete_Archive"},Vo={1:$.DATA,2:$.DATA_CLEAN,3:$.DATA_CLEAN,4:$.EXPENSE_REVIEW,5:$.JE_DRAFT},et="PR_Reviewer",qn="PR_Payroll_Provider",vt="User opted to skip the headcount review this period.",re={statusText:"",focusedIndex:0,activeView:"home",activeStepId:null,stepStatuses:we.reduce((e,t)=>({...e,[t.id]:"pending"}),{})},Y={loaded:!1,values:{},permanents:{},overrides:{accountingPeriod:!1,jeId:!1}},je=new Map,bt=null,nt=["PR_Payroll_Date","Payroll Date (YYYY-MM-DD)","Payroll_Date","Payroll Date","Payroll_Date_(YYYY-MM-DD)"],H={skipAnalysis:!1,roster:{rosterCount:null,payrollCount:null,difference:null,mismatches:[]},departments:{rosterCount:null,payrollCount:null,difference:null,mismatches:[]},loading:!1,hasAnalyzed:!1,lastError:null},Ct=null,V={loading:!1,lastError:null,prDataTotal:null,cleanTotal:null,reconDifference:null,bankAmount:"",bankDifference:null,plugEnabled:!1},Se={loading:!1,lastError:null,periods:[],copilotResponse:"",completenessCheck:{currentPeriod:null,historicalPeriods:null}},z={debitTotal:null,creditTotal:null,difference:null,loading:!1,lastError:null};async function jo(){if(console.log("Completeness Check - Starting..."),!ce()){console.log("Completeness Check - Excel runtime not available");return}try{await Excel.run(async e=>{var a,s,l,c;let t=e.workbook.worksheets.getItemOrNullObject($.DATA_CLEAN),n=e.workbook.worksheets.getItemOrNullObject($.ARCHIVE_SUMMARY);t.load("isNullObject"),n.load("isNullObject"),await e.sync();let o={currentPeriod:null,historicalPeriods:null};if(!t.isNullObject){let r=t.getUsedRangeOrNullObject();if(r.load("values"),await e.sync(),!r.isNullObject&&r.values&&r.values.length>1){let i=(r.values[0]||[]).map(f=>String(f||"").toLowerCase().trim()),u=i.findIndex(f=>f.includes("amount")),p=u>=0?u:i.findIndex(f=>f==="total"||f==="all-in"||f==="allin"||f==="all-in total"||f==="gross"||f==="total pay");if(console.log("Completeness Check - PR_Data_Clean headers:",i),console.log("Completeness Check - Amount column index:",u,"Total column index:",p),p>=0){let d=r.values.slice(1).reduce((w,m)=>w+(Number(m[p])||0),0),h=((l=(s=(a=Se.periods)==null?void 0:a[0])==null?void 0:s.summary)==null?void 0:l.total)||0;console.log("Completeness Check - PR_Data_Clean sum:",d,"Current period total:",h);let y=Math.abs(d-h)<1;o.currentPeriod={match:y,prDataClean:d,currentTotal:h}}else console.warn("Completeness Check - No amount/total column found in PR_Data_Clean")}}if(!n.isNullObject){let r=n.getUsedRangeOrNullObject();if(r.load("values"),await e.sync(),!r.isNullObject&&r.values&&r.values.length>1){let i=(r.values[0]||[]).map(d=>String(d||"").toLowerCase().trim()),u=i.findIndex(d=>d.includes("pay period")||d.includes("payroll date")||d==="date"||d==="period"||d.includes("period")),p=i.findIndex(d=>d.includes("amount")),f=p>=0?p:i.findIndex(d=>d==="total"||d==="all-in"||d==="allin"||d==="all-in total"||d==="total payroll"||d.includes("total"));if(console.log("Completeness Check - PR_Archive_Summary headers:",i),console.log("Completeness Check - Date column index:",u,"Total column index:",f),f>=0&&u>=0){let d=r.values.slice(1),h=(Se.periods||[]).slice(1,6);console.log("Completeness Check - Looking for periods:",h.map(S=>S.key||S.label));let y=new Map;for(let S of d){let I=S[u],g=Vn(I);if(g){let P=Number(S[f])||0,D=y.get(g)||0;y.set(g,D+P)}}console.log("Completeness Check - Archive lookup keys:",Array.from(y.keys())),console.log("Completeness Check - Archive lookup values:",Array.from(y.entries()));let w=0,m=0,b=0,k=[];for(let S of h){let I=S.key||S.label||"",g=Vn(I),P=((c=S.summary)==null?void 0:c.total)||0;m+=P;let D=y.get(g);D!==void 0?(w+=D,b++,k.push({period:I,calculated:P,archive:D,match:Math.abs(P-D)<1})):(console.warn(`Completeness Check - Period ${I} (normalized: ${g}) not found in archive`),k.push({period:I,calculated:P,archive:null,match:!1}))}console.log("Completeness Check - Period details:",k),console.log("Completeness Check - Matched",b,"of",h.length,"periods"),console.log("Completeness Check - Archive sum:",w,"Periods sum:",m);let _=b===h.length&&h.length>0,A=Math.abs(w-m)<1,B=_&&A;o.historicalPeriods={match:B,archiveSum:w,periodsSum:m,matchedCount:b,totalPeriods:h.length,details:k}}else console.warn("Completeness Check - Missing date or total column in PR_Archive_Summary"),console.warn("  Date column index:",u,"Total column index:",f)}}Se.completenessCheck=o,console.log("Completeness Check - Results:",JSON.stringify(o))}),console.log("Completeness Check - Complete!")}catch(e){console.error("Payroll completeness check failed:",e)}}function Ho(){var y,w;let e=Se.completenessCheck||{},t=((y=Se.periods)==null?void 0:y.length)>0,n=m=>`$${Math.round(m||0).toLocaleString()}`,o=m=>{let b=Math.abs(m);return b<1?"\u2014":`${m>0?"+":"-"}$${Math.round(b).toLocaleString()}`},a=(m,b,k,_,A,B,S)=>{let I=(k||0)-(A||0),g,P;S?(g='<span class="pf-complete-status pf-complete-status--pending">\u23F3</span>',P="pending"):B?(g='<span class="pf-complete-status pf-complete-status--pass">\u2713</span>',P="pass"):(g='<span class="pf-complete-status pf-complete-status--fail">\u2717</span>',P="fail");let D=S?"":`
            <div class="pf-complete-diff ${P}">
                ${o(I)}
            </div>
        `;return`
            <div class="pf-complete-row ${P}">
    ...
    `}function Uo(e){switch(e){case 0:return{title:"Configuration",content:`
                ...
                `}}}ln(()=>Go());async function Go(){try{await zo(),await Zn();let e=Ft(St);await Bt(e.sheetName,e.title,e.subtitle),ue()}catch(e){throw console.error("[Payroll] Module initialization failed:",e),e}}async function zo(){try{await Tt(St),console.log(`[Payroll] Tab visibility applied for ${St}`)}catch(e){console.warn("[Payroll] Could not apply tab visibility:",e)}}function ue(){var r;let e=document.body;if(!e)return;let t=re.focusedIndex<=0?"disabled":"",n=re.focusedIndex>=we.length-1?"disabled":"",o=re.activeView==="config",a=re.activeView==="step",s=!o&&!a,l=o?Yo():a?ta(re.activeStepId):Jo();e.innerHTML=`
        <div class="pf-root">
            ${Wo(t,n)}
            ${l}
            ${oa()}
        </div>
    `;let c=document.getElementById("pf-info-fab-payroll");if(s)c&&c.remove();else if((r=window.PrairieForge)!=null&&r.mountInfoFab){let i=Uo(re.activeStepId);PrairieForge.mountInfoFab({title:i.title,content:i.content,buttonId:"pf-info-fab-payroll"})}if(sa(),o)ca();else if(a)try{da(re.activeStepId)}catch(i){console.warn("Payroll Recorder: failed to bind step interactions",i)}else la();pa(),s?hn():Vt()}function Wo(e,t){let n=O("SS_Company_Name")||"your company";return`
    ...
    `}function Yo(){if(!Y.loaded)return`
            <section class="pf-step-guide">
                <article class="pf-step-card pf-step-detail">
                    <p class="pf-step-title">Loading configuration\u2026</p>
                </article>
            </section>
        `;let e=Ne[0],t=ve(xt()),n=ve(O("PR_Accounting_Period")),o=O("PR_Journal_Entry_ID"),a=O("SS_Accounting_Software"),s=tn(),l=O("SS_Company_Name"),c=O(et)||Pe(),r=e?O(e.note):"",i=e?xe(e.note):!1,u=(e?O(e.reviewer):"")||Pe(),p=e?ve(O(e.signOff)):"",f=!!(p||O(me[0]));return`
        <section class="pf-hero" id="pf-config-hero">
            <p class="pf-hero-copy">${x($e)} | Step 0</p>
    ...
    `}function qo(e){let t=_e(1),n=t?xe(t.note):!1,o=t?O(t.note):"",a=(t?O(t.reviewer):"")||Pe(),s=t?ve(O(t.signOff)):"",l=!!(s||O(me[1])),c=tn();return`
        <section class="pf-hero" id="pf-step-hero">
            <p class="pf-hero-copy">${x($e)} | Step ${e.id}</p>
        ...
        <section class="pf-step-guide">
            <article class="pf-step-card pf-step-detail pf-config-card">
                ...
                <div class="pf-signoff-action">
                    ${ye(c?`<a href="${x(c)}" target="_blank" rel="noopener noreferrer" class="pf-action-toggle pf-clickable" title="Open payroll provider">${ht}</a>`:`<button type="button" class="pf-action-toggle pf-clickable" id="import-provider-btn" disabled title="Add provider link in Configuration">${ht}</button>`,"Provider")}
                    ${ye(`<button type="button" class="pf-action-toggle pf-clickable" id="import-open-data-btn" title="Open PR_Data sheet">${ft}</button>`,"PR_Data")}
                    ${ye(`<button type="button" class="pf-action-toggle pf-clickable" id="import-clear-btn" title="Clear PR_Data to start over">${In}</button>`,"Clear")}
                </div>
            </article>
            ${t?`
    ...
    `}function Ko(e){var G,Q,J,F,q,ne,Ce,oe,Z,ee,ie,ae,te;let t=_e(2),n=t?O(t.note):"",o=t?xe(t.note):!1,a=(t?O(t.reviewer):"")||Pe(),s=t?ve(O(t.signOff)):"",l=!!(s||O(me[2])),c=Dt(),r=H.roster||{},i=H.departments||{},u=H.hasAnalyzed,p="";H.loading?p='<p class="pf-step-note">Analyzing roster and payroll data\u2026</p>':H.lastError&&(p=`<p class="pf-step-note">${x(H.lastError)}</p>`);let f=(ge,st,At)=>{let Oe=!u,Te;Oe?Te='<span class="pf-je-check-circle pf-je-circle--pending"></span>':At?Te=`<span class="pf-je-check-circle pf-je-circle--pass">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg>
            </span>`:Te=`<span class="pf-je-check-circle pf-je-circle--fail">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
            </span>`;let Le=u?` = ${st}`:"";return`
        ...
        ${f("Difference",d,d===0)}
    `,b=(q=i.rosterCount)!=null?q:0,k=(ne=r.rosterCount)!=null?ne:0,_=(Ce=r.payrollCount)!=null?Ce:0,A=u&&b>0&&b<Math.max(k,_)?`<p class="pf-step-note pf-step-note--info">\u2139\uFE0F Only ${b} employees appear in both lists, so only those can be compared for department alignment.</p>`:"",B=`
        ${f("Expected departments",(oe=i.rosterCount)!=null?oe:"\u2014",!0)}
        ${f("PR_Data departments",(Z=i.payrollCount)!=null?Z:"\u2014",!0)}
        ${f("Difference",h,h===0)}
    `,S=y.filter(ge=>ge.type==="missing_from_payroll").length,I=y.filter(ge=>ge.type==="missing_from_roster").length,g=y.length>0?`Employee Mismatches (${S} missing from payroll, ${I} not in roster)`:"Employee Mismatches",P=y.length&&!H.skipAnalysis&&u&&((ie=(ee=window.PrairieForge)==null?void 0:ee.renderMismatchTiles)==null?void 0:ie.call(ee,{mismatches:y,label:g,sourceLabel:"Roster",targetLabel:"Payroll Data",escapeHtml:x}))||"",D=w.length&&!H.skipAnalysis&&u&&((te=(ae=window.PrairieForge)==null?void 0:ae.renderMismatchTiles)==null?void 0:te.call(ae,{mismatches:w,label:"Employees with Department Differences",formatter:ge=>({name:ge.employee||ge.name||"",source:`${ge.rosterDept||"\u2014"} \u2192 ${ge.payrollDept||"\u2014"}`,isMissingFromTarget:!0}),escapeHtml:x}))||"";return`
        <section class="pf-hero" id="pf-step-hero">
            <p class="pf-hero-copy">${x($e)} | Step ${e.id}</p>
        ...
        <section class="pf-step-guide">
            <article class="pf-step-card pf-step-detail pf-config-card">
                ...
                <div class="pf-signoff-action">
                    ${ye(`<button type="button" class="pf-action-toggle pf-clickable" id="roster-run-btn" title="Run headcount analysis">${gt}</button>`,"Run")}
                    ${ye(`<button type="button" class="pf-action-toggle pf-clickable" id="roster-refresh-btn" title="Refresh analysis">${Ke}</button>`,"Refresh")}
                </div>
            </article>
            <article class="pf-step-card pf-step-detail pf-config-card">
                <div class="pf-config-head">
    ...
    `}function Xo(e){var A;let t=_e(3),n=t?O(t.note):"",o=(t?O(t.reviewer):"")||Pe(),a=t?ve(O(t.signOff)):"",s=V.loading?'<p class="pf-step-note">Preparing reconciliation data\u2026</p>':V.lastError?`<p class="pf-step-note">${x(V.lastError)}</p>`:"",l=!!(a||O(me[3])),c=V.prDataTotal!==null,r=V.prDataTotal,i=V.cleanTotal,u=(A=V.reconDifference)!=null?A:r!=null&&i!=null?r-i:null,p=u!==null&&Math.abs(u)<.01,f=pe(V.cleanTotal),d=V.bankDifference!=null?pe(V.bankDifference):"---",h=V.bankDifference==null?"":Math.abs(V.bankDifference)<.5?"Difference within acceptable tolerance.":"Difference exceeds tolerance and should be resolved.",y=oo(V.bankAmount),w=(B,S,I)=>{let g=!c,P;return g?P='<span class="pf-je-check-circle pf-je-circle--pending"></span>':I?P=`<span class="pf-je-check-circle pf-je-circle--pass">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg>
    ...
    `;return`
        ...
        <section class="pf-step-guide">
            <article class="pf-step-card pf-step-detail pf-config-card">
                ...
                <div class="pf-signoff-action">
                    ${ye(`<button type="button" class="pf-action-toggle pf-clickable" id="validation-run-btn" title="Run reconciliation">${gt}</button>`,"Run")}
                    ${ye(`<button type="button" class="pf-action-toggle pf-clickable" id="validation-refresh-btn" title="Refresh reconciliation">${Ke}</button>`,"Refresh")}
                </div>
            </article>
            <article class="pf-step-card pf-step-detail pf-config-card">
                <div class="pf-config-head">
    ...
    `}function Qo(e){let t=_e(4),n=t?O(t.note):"",o=(t?O(t.reviewer):"")||Pe(),a=t?ve(O(t.signOff)):"",s=!!(a||O(me[4])),l=Se.loading?'<p class="pf-step-note">Preparing executive summary\u2026</p>':Se.lastError?`<p class="pf-step-note">${x(Se.lastError)}</p>`:"",c=pn({id:"expense-review-copilot",body:"Want help analyzing your data? Just ask!",placeholder:"Where should I focus this pay period?",buttonLabel:"Ask CoPilot"});return`
        <section class="pf-hero" id="pf-step-hero">
            <p class="pf-hero-copy">${x($e)} | Step ${e.id}</p>
            <h2 class="pf-hero-title">${x(e.title)}</h2>
        ...
        <section class="pf-step-guide">
            ...
            <article class="pf-step-card pf-step-detail pf-config-card">
                ...
                <div class="pf-signoff-action">
                    ${ye(`<button type="button" class="pf-action-toggle" id="expense-run-btn" title="Run expense review analysis">${gt}</button>`,"Run")}
                    ${ye(`<button type="button" class="pf-action-toggle" id="expense-refresh-btn" title="Refresh expense data">${Ke}</button>`,"Refresh")}
                </div>
            </article>
            ${Ho()}
                ${c}
    ...
    `}function Zo(e){var A,B,S;let t=_e(5),n=t?O(t.note):"",o=t?xe(t.note):!1,a=(t?O(t.reviewer):"")||Pe(),s=t?ve(O(t.signOff)):"",l=!!(s||O(me[5])),c=z.lastError?`<p class="pf-step-note">${x(z.lastError)}</p>`:"",r=z.debitTotal!==null,i=(A=z.debitTotal)!=null?A:0,u=(B=z.creditTotal)!=null?B:0,p=i-u,f=(S=V.cleanTotal)!=null?S:0,d=r,h=r&&Math.abs(p-f)<.01,y=(I,g)=>{let P=!r,D;return P?D='<span class="pf-je-check-circle pf-je-circle--pending"></span>':g?D=`<span class="pf-je-check-circle pf-je-circle--pass">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg>
    ...
    `;return`
        ...
        <section class="pf-step-guide">
            <article class="pf-step-card pf-step-detail pf-config-card">
                ...
                <div class="pf-signoff-action">
                    ${ye(`<button type="button" class="pf-action-toggle pf-clickable" id="je-create-btn" title="Generate from PR_Data_Clean">${ft}</button>`,"Generate")}
                    ${ye(`<button type="button" class="pf-action-toggle pf-clickable" id="je-run-btn" title="Refresh validation">${Ke}</button>`,"Refresh")}
                    ${ye(`<button type="button" class="pf-action-toggle pf-clickable" id="je-export-btn" title="Export as CSV">${_n}</button>`,"Export")}
                </div>
            </article>
            <article class="pf-step-card pf-step-detail pf-config-card">
                <div class="pf-config-head">
    ...
    `}function ta(e){let t=dt.find(_=>_.id===e)||{id:e!=null?e:"-",title:"Workflow Step",summary:"",description:"",checklist:[]};if(e===1)return qo(t);if(e===2)return Ko(t);if(e===3)return Xo(t);if(e===4)return Qo(t);if(e===5)return Zo(t);if(e===6)return ea(t);let n=!1,o=_e(e),a=o?O(o.note):"",s=o?xe(o.note):!1,l=(o?O(o.reviewer):"")||Pe(),c=o?ve(O(o.signOff)):"",r=o&&me[e]?!!(c||O(me[e])):!!c,i=(t.highlights||[]).map(_=>`
        ...
        `).join(""),u=(t.checklist||[]).map(_=>`<li>${x(_)}</li>`).join("")||"",p=n?"":t.description||"Detailed guidance will appear here.",f=[];!n&&t.ctaLabel&&f.push(`<button type="button" class="pf-pill-btn" id="step-action-btn">${x(t.ctaLabel)}</button>`),n||f.push('<button type="button" class="pf-pill-btn pf-pill-btn--ghost" id="step-back-btn">Back to Step List</button>');let d=f.length?`<div class="pf-pill-row pf-config-actions">${f.join("")}</div>`:"",h=tn(),y=n?`
            <div class="pf-link-card">
                ...
                <div class="pf-link-list">
                    ...
                    >
                        <span class="pf-link-item__icon">${ht}</span>
        ...
        `:"";return`
        <section class="pf-hero" id="pf-step-hero">
            <p class="pf-hero-copy">${x($e)} | Step ${t.id}</p>
    ...
    `}function na(e,t){let n=re.focusedIndex===t?"pf-step-card--active":"",o=xn(aa(e.id));return`
    ...
    `}function oa(){return`
        <footer class="pf-brand-footer">
            <div class="pf-brand-text">
                ...
                <div class="pf-brand-meta">\xA9 Prairie Forge LLC, 2025. All rights reserved. Version ${rn}</div>
                <button type="button" class="pf-config-link" id="showConfigSheets">CONFIGURATION</button>
            </div>
        </footer>
    `}function aa(e){return e===0?"config":e===1?"import":e===2?"headcount":e===3?"validate":e===4?"review":e===5?"journal":e===6?"archive":""}function sa(){var n,o,a,s,l,c,r,i;(n=document.getElementById("nav-home"))==null||n.addEventListener("click",()=>{var u;Kn(),(u=document.getElementById("pf-hero"))==null||u.scrollIntoView({behavior:"smooth",block:"start"})}),(o=document.getElementById("nav-selector"))==null||o.addEventListener("click",()=>{window.location.href="../module-selector/index.html"}),(a=document.getElementById("nav-prev"))==null||a.addEventListener("click",()=>Fn(-1)),(s=document.getElementById("nav-next"))==null||s.addEventListener("click",()=>Fn(1));let e=document.getElementById("nav-quick-toggle"),t=document.getElementById("quick-access-dropdown");e==null||e.addEventListener("click",u=>{u.stopPropagation(),t==null||t.classList.toggle("hidden"),e.classList.toggle("is-active")}),document.addEventListener("click",u=>{!(t!=null&&t.contains(u.target))&&!(e!=null&&e.contains(u.target))&&(t==null||t.classList.add("hidden"),e==null||e.classList.remove("is-active"))}),(l=document.getElementById("nav-roster"))==null||l.addEventListener("click",()=>{Bn("SS_Employee_Roster"),t==null||t.classList.add("hidden"),e==null||e.classList.remove("is-active")}),(c=document.getElementById("nav-accounts"))==null||c.addEventListener("click",()=>{Bn("SS_Chart_of_Accounts"),t==null||t.classList.add("hidden"),e==null||e.classList.remove("is-active")}),(r=document.getElementById("nav-expense-map"))==null||r.addEventListener("click",async()=>{t==null||t.classList.add("hidden"),e==null||e.classList.remove("is-active"),await ia()}),(i=document.getElementById("showConfigSheets"))==null||i.addEventListener("click",async()=>{await ra()})}async function ra(){if(typeof Excel=="undefined"){console.log("Excel not available");return}try{await Excel.run(async e=>{let t=e.workbook.worksheets;t.load("items/name,visibility"),await e.sync();let n=0;t.items.forEach(a=>{a.name.toUpperCase().startsWith("SS_")&&(a.visibility=Excel.SheetVisibility.visible,console.log(`[Config] Made visible: ${a.name}`),n++)}),await e.sync();let o=e.workbook.worksheets.getItemOrNullObject("SS_PF_Config");o.load("isNullObject"),await e.sync(),o.isNullObject||(o.activate(),o.getRange("A1").select(),await e.sync()),console.log(`[Config] ${n} system sheets now visible`)})}catch(e){console.error("[Config] Error unhiding system sheets:",e)}}async function Bn(e){if(!e||typeof Excel=="undefined")return;let t={SS_Employee_Roster:["Employee","Department","Pay_Rate","Status","Hire_Date"],SS_Chart_of_Accounts:["Account_Number","Account_Name","Type","Category"]};try{await Excel.run(async n=>{let o=n.workbook.worksheets.getItemOrNullObject(e);if(o.load("isNullObject,visibility"),await n.sync(),o.isNullObject){o=n.workbook.worksheets.add(e);let a=t[e]||["Column1","Column2"],s=o.getRange(`A1:${String.fromCharCode(64+a.length)}1`);s.values=[a],s.format.font.bold=!0,s.format.fill.color="#f0f0f0",s.format.autofitColumns(),await n.sync()}else o.visibility=Excel.SheetVisibility.visible,await n.sync();o.activate(),o.getRange("A1").select(),await n.sync(),console.log(`[Quick Access] Opened sheet: ${e}`)})}catch(n){console.error("Error opening reference sheet:",n)}}async function ia(){try{await Excel.run(async e=>{let t=e.workbook.worksheets.getItemOrNullObject("PR_Expense_Mapping");if(t.load("isNullObject,visibility"),await e.sync(),t.isNullObject){t=e.workbook.worksheets.add("PR_Expense_Mapping");let n=["Expense_Category","GL_Account","Description","Active"],o=t.getRange("A1:D1");o.values=[n],o.format.font.bold=!0}else t.visibility=Excel.SheetVisibility.visible,await e.sync();t.activate(),t.getRange("A1").select(),await e.sync(),console.log("[Quick Access] Opened PR_Expense_Mapping")})}catch(e){console.error("Error navigating to PR_Expense_Mapping:",e)}}function la(){document.querySelectorAll("[data-step-card]").forEach(e=>{let t=Number(e.getAttribute("data-step-index"));e.addEventListener("click",()=>ot(t))})}function ca(){var c,r,i,u;let e=document.getElementById("config-user-name");e==null||e.addEventListener("change",p=>{let f=p.target.value.trim();U(et,f);let d=document.getElementById("config-reviewer-name");d&&!d.value&&(d.value=f)}),wn("config-payroll-date",{onChange:p=>{if(U("PR_Payroll_Date",p),!!p){if(!Y.overrides.accountingPeriod){let f=ya(p);if(f){let d=document.getElementById("config-accounting-period");d&&(d.value=f),U("PR_Accounting_Period",f)}}if(!Y.overrides.jeId){let f=va(p);if(f){let d=document.getElementById("config-je-id");d&&(d.value=f),U("PR_Journal_Entry_ID",f)}}}}});let t=_e(0),n=document.getElementById("config-accounting-period");n==null||n.addEventListener("change",p=>{Y.overrides.accountingPeriod=!!p.target.value,U("PR_Accounting_Period",p.target.value||"")});let o=document.getElementById("config-je-id");o==null||o.addEventListener("change",p=>{Y.overrides.jeId=!!p.target.value,U("PR_Journal_Entry_ID",p.target.value.trim())}),(c=document.getElementById("config-company-name"))==null||c.addEventListener("change",p=>{U("SS_Company_Name",p.target.value.trim())}),(r=document.getElementById("config-payroll-provider"))==null||r.addEventListener("change",p=>{let f=p.target.value.trim();U(qn,f)}),(i=document.getElementById("config-accounting-link"))==null||i.addEventListener("change",p=>{U("SS_Accounting_Software",p.target.value.trim())});let a=document.getElementById("config-notes");if(a==null||a.addEventListener("input",p=>{t&&U(t.note,p.target.value,{debounceMs:400})}),t){let p=document.getElementById("config-notes-permanent");p&&(p.addEventListener("click",()=>{let d=!p.classList.contains("is-locked");Qe(p,d),eo(t.note,d)}),Qe(p,xe(t.note)));let f=document.getElementById("config-notes-save");f==null||f.addEventListener("click",()=>{a&&(U(t.note,a.value),Ve(f,!0))})}let s=document.getElementById("config-reviewer-name");s==null||s.addEventListener("change",p=>{let f=p.target.value.trim();t&&U(t.reviewer,f),U(et,f);let d=document.getElementById("config-signoff-date");if(f&&d&&!d.value){let h=at();d.value=h,t&&U(t.signOff,h)}}),(u=document.getElementById("config-signoff-date"))==null||u.addEventListener("change",p=>{t&&U(t.signOff,p.target.value||"")});let l=document.getElementById("config-signoff-save");if(l==null||l.addEventListener("click",()=>{var h;let p=((h=s==null?void 0:s.value)==null?void 0:h.trim())||"",f=document.getElementById("config-signoff-date"),d=(f==null?void 0:f.value)||"";t&&(U(t.reviewer,p),U(t.signOff,d)),U(et,p),Ve(l,!0)}),zt(),t){let p=O(t.signOff),f=O(me[0]),d=!!(p||f==="Y"||f===!0);console.log(`[Step 0] Binding signoff toggle. signOff="${p}", complete="${f}", isComplete=${d}`),Qn({buttonId:"config-signoff-toggle",inputId:"config-signoff-date",fieldName:t.signOff,completeField:me[0],initialActive:d,stepId:0})}}function da(e){var n,o,a,s,l,c,r,i,u,p,f,d,h,y,w,m,b,k,_,A,B;if((n=document.getElementById("step-back-btn"))==null||n.addEventListener("click",()=>{Kn()}),(o=document.getElementById("step-action-btn"))==null||o.addEventListener("click",()=>{let S=dt.find(I=>I.id===e);window.alert(S!=null&&S.ctaLabel?`${S.ctaLabel} coming soon.`:"Step actions coming soon.")}),e===1&&((a=document.getElementById("import-open-data-btn"))==null||a.addEventListener("click",()=>fa()),(s=document.getElementById("import-clear-btn"))==null||s.addEventListener("click",()=>ma())),e===2&&((l=document.getElementById("headcount-skip-btn"))==null||l.addEventListener("click",()=>{H.skipAnalysis=!H.skipAnalysis;let S=document.getElementById("headcount-skip-btn");S==null||S.classList.toggle("is-active",H.skipAnalysis),H.skipAnalysis&&Zt(),kt()}),(c=document.getElementById("roster-run-btn"))==null||c.addEventListener("click",()=>Qt()),(r=document.getElementById("roster-refresh-btn"))==null||r.addEventListener("click",()=>Qt()),(i=document.getElementById("roster-review-btn"))==null||i.addEventListener("click",()=>{var I;let S=((I=H.roster)==null?void 0:I.mismatches)||[];Jn("Roster Differences",S,{sourceLabel:"Roster",targetLabel:"Payroll Data"})}),(u=document.getElementById("dept-review-btn"))==null||u.addEventListener("click",()=>{var I;let S=((I=H.departments)==null?void 0:I.mismatches)||[];Jn("Department Differences",S,{sourceLabel:"Roster",targetLabel:"Payroll",formatter:g=>({name:g.employee,source:`${g.rosterDept} \u2192 ${g.payrollDept}`,isMissingFromTarget:!0})})})),e===3&&((p=document.getElementById("validation-run-btn"))==null||p.addEventListener("click",()=>Wn()),(f=document.getElementById("validation-refresh-btn"))==null||f.addEventListener("click",()=>Wn()),(d=document.getElementById("bank-amount-input"))==null||d.addEventListener("blur",Yn),(h=document.getElementById("bank-amount-input"))==null||h.addEventListener("keydown",S=>{S.key==="Enter"&&Yn(S)})),e===5&&((y=document.getElementById("je-run-btn"))==null||y.addEventListener("click",()=>Ga()),(w=document.getElementById("je-save-btn"))==null||w.addEventListener("click",()=>za()),(m=document.getElementById("je-create-btn"))==null||m.addEventListener("click",()=>Wa()),(b=document.getElementById("je-export-btn"))==null||b.addEventListener("click",()=>Ja())),e===4){let S=document.querySelector(".pf-step-guide");if(S){let I="https://your-project.supabase.co/functions/v1/copilot";un(S,{id:"expense-review-copilot",contextProvider:Ea(),systemPrompt:`You are Prairie Forge CoPilot, an expert financial analyst assistant for payroll expense review.
...
When asked about readiness, be specific about what passes and what needs attention.`})}(k=document.getElementById("expense-run-btn"))==null||k.addEventListener("click",()=>{Gn()}),(_=document.getElementById("expense-refresh-btn"))==null||_.addEventListener("click",()=>{Gn()})}let t=_e(e);if(console.log(`[Step ${e}] Binding interactions, fields:`,t),t){let S=e===1?"step-notes-1":"step-notes-input",I=document.getElementById(S);console.log(`[Step ${e}] Notes input found:`,!!I,`(id: ${S})`);let g=e===1?document.getElementById("step-notes-save-1"):e===2?document.getElementById("step-notes-save-2"):e===3?document.getElementById("step-notes-save-3"):e===4?document.getElementById("step-notes-save-4"):e===5?document.getElementById("step-notes-save-5"):document.getElementById("step-notes-save");I==null||I.addEventListener("input",Z=>{U(t.note,Z.target.value,{debounceMs:400}),e===2&&(H.skipAnalysis&&Zt(),kt())}),g==null||g.addEventListener("click",()=>{I&&(U(t.note,I.value),Ve(g,!0))});let P=e===1?"step-reviewer-1":"step-reviewer-name",D=document.getElementById(P);D==null||D.addEventListener("change",Z=>{let ee=Z.target.value.trim();U(t.reviewer,ee);let ie=e===1?document.getElementById("step-signoff-1"):e===2?document.getElementById("step-signoff-date"):e===3?document.getElementById("step-signoff-3"):e===4?document.getElementById("step-signoff-4"):e===5?document.getElementById("step-signoff-5"):document.getElementById(`step-signoff-${e}`);if(ee&&ie&&!ie.value){let ae=at();ie.value=ae,U(t.signOff,ae)}});let G=e===1?"step-signoff-1":e===2?"step-signoff-date":e===3?"step-signoff-3":e===4?"step-signoff-4":e===5?"step-signoff-5":`step-signoff-${e}`;console.log(`[Step ${e}] Signoff input ID: ${G}, found:`,!!document.getElementById(G)),(A=document.getElementById(G))==null||A.addEventListener("change",Z=>{U(t.signOff,Z.target.value||"")});let Q=e===1?"step-notes-lock-1":"step-notes-permanent",J=document.getElementById(Q);J&&(J.addEventListener("click",()=>{let Z=!J.classList.contains("is-locked");Qe(J,Z),eo(t.note,Z),e===2&&kt()}),Qe(J,xe(t.note)));let F=e===1?document.getElementById("step-signoff-save-1"):e===2?document.getElementById("headcount-signoff-save"):e===3?document.getElementById("step-signoff-save-3"):e===4?document.getElementById("step-signoff-save-4"):e===5?document.getElementById("step-signoff-save-5"):document.getElementById(`step-signoff-save-${e}`);F==null||F.addEventListener("click",()=>{var ie,ae;let Z=((ie=D==null?void 0:D.value)==null?void 0:ie.trim())||"",ee=((ae=document.getElementById(G))==null?void 0:ae.value)||"";U(t.reviewer,Z),U(t.signOff,ee),Ve(F,!0)}),zt();let q=me[e],ne=q?!!O(q):!1,Ce=O(t.signOff),oe=e===1?"step-signoff-toggle-1":e===2?"headcount-signoff-toggle":e===3?"validation-signoff-toggle":e===4?"expense-signoff-toggle":e===5?"step-signoff-toggle-5":`step-signoff-toggle-${e}`;console.log(`[Step ${e}] Toggle button ID: ${oe}, found:`,!!document.getElementById(oe)),Qn({buttonId:oe,inputId:G,fieldName:t.signOff,completeField:q,requireNotesCheck:e===2?Dt:null,initialActive:!!(Ce||ne),stepId:e,onComplete:e===3?La:e===4?Ma:e===2?Ta:null})}e===2&&kt(),e===6&&((B=document.getElementById("archive-run-btn"))==null||B.addEventListener("click",Ba))}function ot(e){if(Number.isNaN(e)||e<0||e>=we.length)return;let t=we[e];if(!t)return;Ct=e;let n=t.id===0?"config":"step";en({focusedIndex:e,activeView:n,activeStepId:t.id});let o=Vo[t.id];o&&$a(o),t.id===2&&!H.hasAnalyzed&&Qt()}function Fn(e){if(re.activeView==="home"&&e>0){ot(0);return}let t=re.focusedIndex+e,n=Math.max(0,Math.min(we.length-1,t));ot(n)}function pa(){if(re.activeView!=="home"||Ct===null)return;let e=document.querySelector(`[data-step-card][data-step-index="${Ct}"]`);Ct=null,e==null||e.scrollIntoView({behavior:"smooth",block:"center"})}async function Kn(){let e=Ft(St);await Bt(e.sheetName,e.title,e.subtitle),en({activeView:"home",activeStepId:null})}function en(e){Object.assign(re,e),ue()}function Pe(){return O(et)||O("SS_Default_Reviewer")||""}function qt(e,t){e&&(e.classList.toggle("is-active",t),e.setAttribute("aria-pressed",String(t)))}function Xn(e){let t=document.getElementById("je-save-btn");t&&t.classList.toggle("is-saved",e)}function ua(){let e={};return console.log("[Signoff] Checking step completion status..."),Object.keys(Ne).forEach(t=>{let n=parseInt(t,10),o=Ne[n];if(!o){e[n]=!1;return}let a=O(o.signOff),s=me[n],l=O(s),c=!!a||l==="Y"||l===!0;e[n]=c,console.log(`[Signoff] Step ${n}: signOff="${a}", complete="${l}" \u2192 ${c?"COMPLETE":"pending"}`)}),console.log("[Signoff] Status summary:",e),e}function Qn({buttonId:e,inputId:t,fieldName:n,completeField:o,requireNotesCheck:a,onComplete:s,initialActive:l=!1,stepId:c=null}){let r=document.getElementById(e);if(!r){console.warn(`[Signoff] Button not found: ${e}`);return}let i=t?document.getElementById(t):null,u=l||!!(i!=null&&i.value);qt(r,u),console.log(`[Signoff] Bound ${e}, initial active: ${u}, stepId: ${c}`),r.addEventListener("click",()=>{if(console.log(`[Signoff] Done button clicked: ${e}, stepId: ${c}`),c!==null&&c>0){let f=ua(),{canComplete:d,message:h}=Nn(c,f),y=r.classList.contains("is-active");if(console.log(`[Signoff] canComplete: ${d}, isCurrentlyActive: ${y}`),!y&&!d){console.log(`[Signoff] BLOCKED: ${h}`),On(h);return}}if(a&&!a()){window.alert("Please add notes before completing this step.");return}let p=!r.classList.contains("is-active");if(console.log(`[Signoff] ${e} clicked, toggling to: ${p}`),qt(r,p),i&&(i.value=p?at():""),n){let f=p?at():"";console.log(`[Signoff] Writing ${n} = "${f}"`),U(n,f)}if(o){let f=p?"Y":"";console.log(`[Signoff] Writing ${o} = "${f}"`),U(o,f)}p&&typeof s=="function"&&s()}),i&&i.addEventListener("change",()=>{let p=!!i.value,f=r.classList.contains("is-active");p!==f&&(console.log(`[Signoff] Date input changed, syncing button to: ${p}`),qt(r,p),n&&U(n,i.value||""),o&&U(o,p?"Y":""))})}async function fa(){if(!ce()){window.alert("Open this module inside Excel to access the data sheet.");return}try{await Excel.run(async e=>{let t=e.workbook.worksheets.getItem($.DATA);t.activate(),t.getRange("A1").select(),await e.sync()})}catch(e){console.error("Unable to open PR_Data sheet",e),window.alert(`Unable to open ${$.DATA}. Confirm the sheet exists in this workbook.`)}}async function ma(){if(!ce()){window.alert("Open this module inside Excel to clear data.");return}if(window.confirm("Are you sure you want to clear all data from PR_Data? This cannot be undone."))try{await Excel.run(async t=>{let n=t.workbook.worksheets.getItem($.DATA),o=n.getUsedRangeOrNullObject();o.load("isNullObject"),await t.sync(),o.isNullObject||(n.getRange("A2:Z10000").clear(Excel.ClearApplyTo.contents),await t.sync()),n.activate(),n.getRange("A1").select(),await t.sync()}),window.alert("PR_Data cleared successfully.")}catch(t){console.error("Unable to clear PR_Data sheet",t),window.alert("Unable to clear PR_Data. Please try again.")}}async function Ie(e){var a,s;if(!Yt.length)return null;if(bt){let l=e.workbook.tables.getItemOrNullObject(bt);if(l.load("name"),await e.sync(),!l.isNullObject)return l;bt=null}let t=e.workbook.tables;t.load("items/name"),await e.sync();let n=((a=t.items)==null?void 0:a.map(l=>l.name))||[];console.log("[Payroll] Looking for config table:",Yt),console.log("[Payroll] Found tables in workbook:",n);let o=(s=t.items)==null?void 0:s.find(l=>Yt.includes(l.name));return o?(console.log("[Payroll] \u2713 Config table found:",o.name),bt=o.name,e.workbook.tables.getItem(o.name)):(console.warn("[Payroll] \u26A0\uFE0F CONFIG TABLE NOT FOUND!"),console.warn("[Payroll] Expected table named: SS_PF_Config"),console.warn("[Payroll] Available tables:",n),console.warn("[Payroll] To fix: Select your data in SS_PF_Config sheet \u2192 Insert \u2192 Table \u2192 Name it 'SS_PF_Config'"),null)}async function Zn(){if(!ce()){Y.loaded=!0;return}try{await Excel.run(async e=>{let t=await Ie(e);if(!t){console.warn("Payroll Recorder: SS_PF_Config table is missing."),Y.loaded=!0;return}let n=t.getDataBodyRange();n.load("values"),await e.sync();let o=n.values||[],a={},s={};o.forEach(l=>{var r,i;let c=le(l[M.FIELD]);c&&(a[c]=(r=l[M.VALUE])!=null?r:"",s[c]=(i=l[M.PERMANENT])!=null?i:"")}),Y.values=a,Y.permanents=s,Y.overrides.accountingPeriod=!!(a.PR_Accounting_Period||a.Accounting_Period),Y.overrides.jeId=!!(a.PR_Journal_Entry_ID||a.Journal_Entry_ID),Y.loaded=!0})}catch(e){console.warn("Payroll Recorder: unable to load PF_Config table.",e),Y.loaded=!0}}function O(e){var t;return(t=Y.values[e])!=null?t:""}function ga(){let e=Object.keys(Y.values||{});return nt.find(n=>e.includes(n))||nt[0]}function xt(){return O(ga())}function tn(){return(O(qn)||O("Payroll_Provider_Link")||"").trim()}function xe(e){return to(Y.permanents[e])}function ha(e){let t=me[e];return t?to(O(t)):!1}function eo(e,t){let n=le(e);n&&(Y.permanents[n]=t?"Y":"N",wa(n,t?"Y":"N"))}function to(e){let t=String(e!=null?e:"").trim().toLowerCase();return t==="true"||t==="y"||t==="yes"||t==="1"}function le(e){return String(e!=null?e:"").trim()}function no(e){let t=String(e!=null?e:"").trim().toLowerCase();return t?["total","totals","grand total","subtotal","summary","employee","employee name","name","full name","header","column","n/a","none","blank","null","undefined"].some(o=>t===o||t===o.replace(/\s+/g,"")):!0}function ve(e){if(!e)return"";let t=_t(e);return t?`${t.year}-${String(t.month).padStart(2,"0")}-${String(t.day).padStart(2,"0")}`:""}function ya(e){let t=_t(e);return t?t.year<1900||t.year>2100?(console.warn("deriveAccountingPeriod - Invalid year:",t.year,"from input:",e),""):`${["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][t.month-1]} ${t.year}`:""}function va(e){let t=_t(e);return t?t.year<1900||t.year>2100?(console.warn("deriveJeId - Invalid year:",t.year,"from input:",e),""):`PR-AUTO-${t.year}-${String(t.month).padStart(2,"0")}-${String(t.day).padStart(2,"0")}`:""}function at(){return Rt(new Date)}function U(e,t,n={}){var l;let o=le(e);Y.values[o]=t!=null?t:"";let a=(l=n.debounceMs)!=null?l:0;if(!a){let c=je.get(o);c&&clearTimeout(c),je.delete(o),tt(o,t!=null?t:"");return}je.has(o)&&clearTimeout(je.get(o));let s=setTimeout(()=>{je.delete(o),tt(o,t!=null?t:"")},a);je.set(o,s)}var ba=["PR_Accounting_Period","PTO_Accounting_Period","Accounting_Period"];async function tt(e,t){let n=le(e);if(Y.values[n]=t!=null?t:"",console.log(`[Payroll] Writing config: ${n} = "${t}"`),!ce()){console.warn("[Payroll] Excel runtime not available - cannot write");return}let o=ba.some(a=>n===a||n.toLowerCase()===a.toLowerCase());try{await Excel.run(async a=>{var f;let s=await Ie(a);if(!s){console.error("[Payroll] \u274C Cannot write - config table not found");return}let l=s.getDataBodyRange(),c=s.getHeaderRowRange();l.load("values"),c.load("values"),await a.sync();let r=c.values[0]||[],i=l.values||[],u=r.length;console.log(`[Payroll] Table has ${i.length} rows, ${u} columns`);let p=[];if(i.forEach((d,h)=>{le(d[M.FIELD])===n&&p.push(h)}),p.length===0){Y.permanents[n]=(f=Y.permanents[n])!=null?f:Mn;let d=new Array(u).fill("");if(M.TYPE>=0&&M.TYPE<u&&(d[M.TYPE]=Lo),M.FIELD>=0&&M.FIELD<u&&(d[M.FIELD]=n),M.VALUE>=0&&M.VALUE<u&&(d[M.VALUE]=t!=null?t:""),M.PERMANENT>=0&&M.PERMANENT<u&&(d[M.PERMANENT]=Mn),console.log("[Payroll] Adding NEW row:",d),s.rows.add(null,[d]),await a.sync(),o){let h=s.rows;h.load("count"),await a.sync();let y=h.count-1,m=s.rows.getItemAt(y).getRange().getCell(0,M.VALUE);m.numberFormat=[["@"]],m.values=[[t!=null?t:""]],await a.sync(),console.log(`[Payroll] \u2713 Applied text format to ${n}`)}console.log(`[Payroll] \u2713 New row added for ${n}`)}else{let d=p[0];console.log(`[Payroll] Updating existing row ${d} for ${n}`);let h=l.getCell(d,M.VALUE);if(o&&(h.numberFormat=[["@"]]),h.values=[[t!=null?t:""]],await a.sync(),console.log(`[Payroll] \u2713 Updated ${n}`),p.length>1){console.log(`[Payroll] Found ${p.length-1} duplicate rows for ${n}, removing...`);let y=p.slice(1).reverse();for(let w of y)try{s.rows.getItemAt(w).delete()}catch(m){console.warn(`[Payroll] Could not delete duplicate row ${w}:`,m.message)}await a.sync(),console.log(`[Payroll] \u2713 Removed duplicate rows for ${n}`)}}})}catch(a){console.error(`[Payroll] \u274C Write failed for ${e}:`,a)}}async function wa(e,t){let n=le(e);if(n&&ce()){Y.permanents[n]=t;try{await Excel.run(async o=>{let a=await Ie(o);if(!a){console.warn(`Payroll Recorder: unable to locate config table when toggling ${e} permanent flag.`);return}let s=a.getDataBodyRange();s.load("values"),await o.sync();let c=(s.values||[]).findIndex(r=>le(r[M.FIELD])===n);c!==-1&&(s.getCell(c,M.PERMANENT).values=[[t]],await o.sync())})}catch(o){console.warn(`Payroll Recorder: unable to update permanent flag for ${e}`,o)}}}function _t(e){if(!e)return null;let t=String(e).trim(),n=/^(\d{4})-(\d{2})-(\d{2})/.exec(t);if(n){let l=Number(n[1]),c=Number(n[2]),r=Number(n[3]);if(l&&c&&r)return{year:l,month:c,day:r}}let o=/^(\d{1,2})\/(\d{1,2})\/(\d{4})/.exec(t);if(o){let l=Number(o[1]),c=Number(o[2]),r=Number(o[3]);if(r&&l&&c)return{year:r,month:l,day:c}}let a=Number(e);if(Number.isFinite(a)&&a>4e4&&a<6e4){let c=Math.floor(a-25569)*86400*1e3,r=new Date(c);if(!isNaN(r.getTime())){let i=`${r.getUTCFullYear()}-${String(r.getUTCMonth()+1).padStart(2,"0")}-${String(r.getUTCDate()).padStart(2,"0")}`;return console.log("DEBUG parseDateInput - Converted Excel serial",a,"to",i),{year:r.getUTCFullYear(),month:r.getUTCMonth()+1,day:r.getUTCDate()}}}let s=new Date(t);return isNaN(s.getTime())?(console.warn("DEBUG parseDateInput - Could not parse date value:",e),null):{year:s.getFullYear(),month:s.getMonth()+1,day:s.getDate()}}function Rt(e){if(e._isUTC){let a=e.getUTCFullYear(),s=String(e.getUTCMonth()+1).padStart(2,"0"),l=String(e.getUTCDate()).padStart(2,"0");return`${a}-${s}-${l}`}let t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${t}-${n}-${o}`}function Vn(e){if(!e)return null;if(typeof e=="string"){let n=e.match(/^(\d{4})-(\d{2})-(\d{2})/);if(n)return`${n[1]}-${n[2]}-${n[3]}`}let t=_t(e);return t?`${t.year}-${String(t.month).padStart(2,"0")}-${String(t.day).padStart(2,"0")}`:null}function Ea(){return async()=>{if(!ce())return null;try{return await Excel.run(async e=>{var l,c,r;let t={timestamp:new Date().toISOString(),period:null,summary:{},departments:[],recentPeriods:[],dataQuality:{}},n=await Ie(e);if(n){let i=n.getDataBodyRange();i.load("values"),await e.sync();let u=i.values||[];for(let p of u){let f=String(p[M.FIELD]||"").trim(),d=p[M.VALUE];f.toLowerCase().includes("accounting")&&f.toLowerCase().includes("period")&&(t.period=String(d||"").trim())}}let o=e.workbook.worksheets.getItemOrNullObject($.DATA_CLEAN);if(o.load("isNullObject"),await e.sync(),!o.isNullObject){let i=o.getUsedRangeOrNullObject();if(i.load("values"),await e.sync(),!i.isNullObject&&((l=i.values)==null?void 0:l.length)>1){let u=i.values[0].map(b=>be(b)),p=i.values.slice(1),f=u.findIndex(b=>b.includes("amount")),d=He(u),h=u.findIndex(b=>b.includes("employee")),y=0,w=new Set,m=new Map;for(let b of p){let k=Number(b[f])||0;if(y+=k,h>=0){let _=String(b[h]||"").trim();_&&w.add(_)}if(d>=0){let _=String(b[d]||"").trim();_&&m.set(_,(m.get(_)||0)+k)}}t.summary={total:y,employeeCount:w.size,avgPerEmployee:w.size?y/w.size:0,rowCount:p.length},t.departments=Array.from(m.entries()).map(([b,k])=>({name:b,total:k,percentOfTotal:y?k/y:0})).sort((b,k)=>k.total-b.total),t.dataQuality.dataCleanReady=!0,t.dataQuality.rowCount=p.length}}let a=e.workbook.worksheets.getItemOrNullObject($.ARCHIVE_SUMMARY);if(a.load("isNullObject"),await e.sync(),!a.isNullObject){let i=a.getUsedRangeOrNullObject();if(i.load("values"),await e.sync(),!i.isNullObject&&((c=i.values)==null?void 0:c.length)>1){let u=i.values[0].map(d=>be(d)),p=u.findIndex(d=>d.includes("period")),f=u.findIndex(d=>d.includes("total"));t.recentPeriods=i.values.slice(1,6).map(d=>({period:d[p]||"",total:Number(d[f])||0})),t.dataQuality.archiveAvailable=!0,t.dataQuality.periodsAvailable=t.recentPeriods.length}}let s=e.workbook.worksheets.getItemOrNullObject($.JE_DRAFT);if(s.load("isNullObject"),await e.sync(),!s.isNullObject){let i=s.getUsedRangeOrNullObject();if(i.load("values"),await e.sync(),!i.isNullObject&&((r=i.values)==null?void 0:r.length)>1){let u=i.values[0].map(y=>be(y)),p=u.findIndex(y=>y.includes("debit")),f=u.findIndex(y=>y.includes("credit")),d=0,h=0;for(let y of i.values.slice(1))d+=Number(y[p])||0,h+=Number(y[f])||0;t.journalEntry={totalDebit:d,totalCredit:h,difference:Math.abs(d-h),isBalanced:Math.abs(d-h)<.01,lineCount:i.values.length-1},t.dataQuality.jeDraftReady=!0}}return console.log("CoPilot context gathered:",t),t})}catch(e){return console.warn("CoPilot context provider error:",e),null}}}function x(e){return String(e!=null?e:"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ye(e,t){return`
        <div class="pf-labeled-button">
            ${e}
            <span class="pf-button-label">${x(t)}</span>
        </div>
    `}function ce(){return typeof Excel!="undefined"&&typeof Excel.run=="function"}function _e(e){return Ne[e]||null}function ka(){var n,o,a,s;let e=Math.abs((o=(n=H.roster)==null?void 0:n.difference)!=null?o:0),t=Math.abs((s=(a=H.departments)==null?void 0:a.difference)!=null?s:0);return e>0||t>0}function Dt(){return!H.skipAnalysis&&ka()}function pe(e){return e==null||Number.isNaN(e)?"---":typeof e!="number"?e:e.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}function oo(e){let t=nn(e);return Number.isFinite(t)?t.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}):""}function Ca(e=[]){return e.map(t=>(t||[]).map(n=>{if(n==null)return"";let o=String(n);return/[",\n]/.test(o)?`"${o.replace(/"/g,'""')}"`:o}).join(",")).join(`
`)}function Ra(e,t){let n=new Blob([t],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(n),a=document.createElement("a");a.href=o,a.download=e,document.body.appendChild(a),a.click(),a.remove(),setTimeout(()=>URL.revokeObjectURL(o),1e3)}function nn(e){if(typeof e=="number")return e;if(e==null)return NaN;let t=String(e).replace(/[^0-9.-]/g,""),n=Number.parseFloat(t);return Number.isFinite(n)?n:NaN}function Sa(e){if(e instanceof Date)return Rt(e);if(typeof e=="number"&&!Number.isNaN(e)){let o=xa(e);return o?Rt(o):""}let t=String(e!=null?e:"").trim();if(!t)return"";if(/^\d{4}-\d{2}-\d{2}$/.test(t))return t;let n=new Date(t);return Number.isNaN(n.getTime())?t:Rt(n)}function xa(e){if(!Number.isFinite(e))return null;let t=Math.floor(e-25569);if(!Number.isFinite(t))return null;let n=t*86400*1e3,o=new Date(n);return o._isUTC=!0,o}function _a(e){if(!e)return"";let t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function wt(e){if(e==null||e==="")return 0;let t=Number(e);return Number.isFinite(t)?t:0}function Da(e){let t=fe(e).toLowerCase();return t?t.includes("burden")||t.includes("tax")||t.includes("benefit")||t.includes("fica")||t.includes("insurance")||t.includes("health")||t.includes("medicare")?"burden":t.includes("bonus")||t.includes("commission")||t.includes("variable")||t.includes("overtime")||t.includes("per diem")?"variable":"fixed":"variable"}function jn(e){if(!e||e.length<2)return[];let t=(e[0]||[]).map(a=>be(a));console.log("parseExpenseRows - headers:",t);let n={payrollDate:t.findIndex(a=>a.includes("payroll")&&a.includes("date")),employee:t.findIndex(a=>a.includes("employee")),department:t.findIndex(a=>a.includes("department")),fixed:t.findIndex(a=>a.includes("fixed")),variable:t.findIndex(a=>a.includes("variable")),burden:t.findIndex(a=>a.includes("burden")),amount:t.findIndex(a=>a.includes("amount")),expenseReview:t.findIndex(a=>a.includes("expense")&&a.includes("review")),category:t.findIndex(a=>a.includes("payroll")&&a.includes("category"))};if(console.log("parseExpenseRows - column indexes:",n),n.payrollDate>=0){let a=new Set;for(let s=1;s<e.length;s++){let l=e[s][n.payrollDate];l&&a.add(String(l))}console.log("parseExpenseRows - unique payroll dates found:",[...a].slice(0,20))}let o=[];for(let a=1;a<e.length;a+=1){let s=e[a],l=Sa(n.payrollDate>=0?s[n.payrollDate]:null);if(!l)continue;let c=n.employee>=0?fe(s[n.employee]):"",r=n.department>=0&&fe(s[n.department])||"Unassigned",i=n.fixed>=0?wt(s[n.fixed]):null,u=n.variable>=0?wt(s[n.variable]):null,p=n.burden>=0?wt(s[n.burden]):null,f=0,d=0,h=0;if(i!==null||u!==null||p!==null)f=i!=null?i:0,d=u!=null?u:0,h=p!=null?p:0;else{let y=n.amount>=0?wt(s[n.amount]):0,w=Da(n.expenseReview>=0?s[n.expenseReview]:s[n.category]);w==="fixed"?f=y:w==="burden"?h=y:d=y}f===0&&d===0&&h===0||o.push({period:l,employee:c,department:r||"Unassigned",fixed:f,variable:d,burden:h})}return o}function Hn(e){let t=new Map;e.forEach(o=>{let a=o.period;if(!a)return;t.has(a)||t.set(a,{key:a,label:_a(a),employees:new Set,departments:new Map,summary:{fixed:0,variable:0,burden:0}});let s=t.get(a);s.employees.add(o.employee||`EMP-${s.employees.size+1}`);let l=o.department||"Unassigned";s.departments.has(l)||s.departments.set(l,{name:l,fixed:0,variable:0,burden:0,employees:new Set});let c=s.departments.get(l);c.fixed+=o.fixed,c.variable+=o.variable,c.burden+=o.burden,c.employees.add(o.employee||`EMP-${c.employees.size+1}`),s.summary.fixed+=o.fixed,s.summary.variable+=o.variable,s.summary.burden+=o.burden});let n=[];return t.forEach(o=>{let a=o.summary.fixed+o.summary.variable+o.summary.burden,s=Array.from(o.departments.values()).map(r=>{let i=r.fixed+r.variable,u=i+r.burden;return{name:r.name,fixed:r.fixed,variable:r.variable,gross:i,burden:r.burden,allIn:u,percent:a?u/a:0,headcount:r.employees.size,delta:0}});s.sort((r,i)=>i.allIn-r.allIn);let l={employeeCount:o.employees.size,fixed:o.summary.fixed,variable:o.summary.variable,burden:o.summary.burden,total:a,burdenRate:a?o.summary.burden/a:0,delta:0},c={name:"Totals",fixed:o.summary.fixed,variable:o.summary.variable,gross:o.summary.fixed+o.summary.variable,burden:o.summary.burden,allIn:a,percent:a?1:0,headcount:o.employees.size,delta:0,isTotal:!0};n.push({key:o.key,label:o.label,summary:l,departments:s,totalsRow:c})}),n.sort((o,a)=>o.key<a.key?1:-1)}function Un(e,t){console.log("buildExpenseReviewPeriods - cleanValues rows:",(e==null?void 0:e.length)||0),console.log("buildExpenseReviewPeriods - archiveValues rows:",(t==null?void 0:t.length)||0);let n=Hn(jn(e)),o=Hn(jn(t));console.log("buildExpenseReviewPeriods - currentPeriods:",n.map(i=>{var u,p;return{key:i.key,employees:(u=i.summary)==null?void 0:u.employeeCount,total:(p=i.summary)==null?void 0:p.total}})),console.log("buildExpenseReviewPeriods - archivePeriods:",o.map(i=>{var u,p;return{key:i.key,employees:(u=i.summary)==null?void 0:u.employeeCount,total:(p=i.summary)==null?void 0:p.total}}));let a=new Map(o.map(i=>[i.key,i])),s=[];n.length&&(s.push(n[0]),a.delete(n[0].key)),o.forEach(i=>{s.length>=6||s.some(u=>u.key===i.key)||s.push(i)}),console.log("buildExpenseReviewPeriods - combined before filter:",s.map(i=>{var u,p;return{key:i.key,employees:(u=i.summary)==null?void 0:u.employeeCount,total:(p=i.summary)==null?void 0:p.total}}));let l=3,c=1e3,r=s.filter(i=>{var d,h,y,w,m;if(!i||!i.key)return console.log("buildExpenseReviewPeriods - EXCLUDED (no key):",i),!1;let u=((d=i.summary)==null?void 0:d.total)||(((h=i.summary)==null?void 0:h.fixed)||0)+(((y=i.summary)==null?void 0:y.variable)||0)+(((w=i.summary)==null?void 0:w.burden)||0),p=((m=i.summary)==null?void 0:m.employeeCount)||0;if(s.indexOf(i)===0)return console.log(`buildExpenseReviewPeriods - INCLUDED (current): ${i.key} - ${p} employees, $${u}`),!0;let f=p>=l&&u>=c;return console.log(`buildExpenseReviewPeriods - ${f?"INCLUDED":"EXCLUDED"}: ${i.key} - ${p} employees, $${u} (needs >=${l} emp, >=$${c})`),f}).sort((i,u)=>i.key<u.key?1:-1).slice(0,6);return console.log("buildExpenseReviewPeriods - FINAL periods:",r.map(i=>i.key)),r.forEach((i,u)=>{let p=r[u+1],f=p?i.summary.total-p.summary.total:0;i.summary.delta=f;let d=new Map(((p==null?void 0:p.departments)||[]).map(h=>[h.name,h]));i.departments.forEach(h=>{let y=d.get(h.name);h.delta=y?h.allIn-y.allIn:0}),i.totalsRow.delta=f}),r}async function Gn(){if(!ce()){Et({loading:!1,lastError:"Excel runtime is unavailable."});return}Et({loading:!0,lastError:null});try{let e=await Excel.run(async t=>{let n=t.workbook.worksheets.getItemOrNullObject($.DATA_CLEAN),o=t.workbook.worksheets.getItemOrNullObject($.ARCHIVE_SUMMARY),a=t.workbook.worksheets.getItemOrNullObject($.EXPENSE_REVIEW);if(n.load("isNullObject, name"),o.load("isNullObject, name"),a.load("isNullObject, name"),await t.sync(),console.log("Expense Review - Sheet check:",{cleanSheet:n.isNullObject?"MISSING":n.name,archiveSheet:o.isNullObject?"MISSING":o.name,reviewSheet:a.isNullObject?"MISSING":a.name}),a.isNullObject){console.log("Creating PR_Expense_Review sheet...");let r=t.workbook.worksheets.add($.EXPENSE_REVIEW);await t.sync();let i=t.workbook.worksheets.getItem($.EXPENSE_REVIEW),u=[],p=[];if(!n.isNullObject){let d=n.getUsedRangeOrNullObject();d.load("values"),await t.sync(),u=d.isNullObject?[]:d.values||[]}if(!o.isNullObject){let d=o.getUsedRangeOrNullObject();d.load("values"),await t.sync(),p=d.isNullObject?[]:d.values||[]}let f=Un(u,p);return await zn(t,i,f),f}let s=[],l=[];if(n.isNullObject)console.warn("Expense Review - PR_Data_Clean sheet not found, using empty data");else{let r=n.getUsedRangeOrNullObject();r.load("values"),await t.sync(),s=r.isNullObject?[]:r.values||[],console.log("Expense Review - PR_Data_Clean rows:",s.length)}if(o.isNullObject)console.warn("Expense Review - PR_Archive_Summary sheet not found, using empty data");else{let r=o.getUsedRangeOrNullObject();r.load("values"),await t.sync(),l=r.isNullObject?[]:r.values||[],console.log("Expense Review - PR_Archive_Summary rows:",l.length)}let c=Un(s,l);return console.log("Expense Review - Periods built:",c.length),await zn(t,a,c),c});Et({loading:!1,periods:e,lastError:null}),await jo(),ue()}catch(e){console.error("Expense Review: unable to build executive summary",e),console.error("Error details:",e.message,e.stack),Et({loading:!1,lastError:`Unable to build the Expense Review: ${e.message||"Unknown error"}`,periods:[]})}}async function zn(e,t,n){if(!t){console.error("writeExpenseReviewSheet: sheet is null/undefined");return}console.log("writeExpenseReviewSheet: Building executive dashboard with",n.length,"periods");try{let v=t.getUsedRangeOrNullObject();v.load("address");let R=t.charts;R.load("items"),await e.sync(),v.isNullObject||(v.clear(),await e.sync());for(let j=R.items.length-1;j>=0;j--)R.items[j].delete();await e.sync()}catch(v){console.warn("Could not clear sheet:",v)}let o=n[0]||{},a=n[1]||{},s=o.summary||{},l=a.summary||{},c=O("PR_Accounting_Period")||xt()||"",r=Number(s.total)||0,i=Number(l.total)||0,u=r-i,p=i?u/i:0,f=Number(s.employeeCount)||0,d=Number(l.employeeCount)||0,h=f-d,y=f?r/f:0,w=d?i/d:0,m=y-w,b=Aa(n),k=Pa(o,n),_=o.label||o.key||"Current Period",A=new Date().toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"}),B=v=>v>0?"\u25B2":v<0?"\u25BC":"\u2014",S=n.map(v=>{var R;return((R=v.summary)==null?void 0:R.total)||0}).filter(v=>v>0),I=n.map(v=>{let R=v.summary||{},j=R.employeeCount||0;return j>0?(R.total||0)/j:0}).filter(v=>v>0),g=n.slice(0,-1).map((v,R)=>{var de,K,W;let j=((de=v.summary)==null?void 0:de.total)||0,se=((W=(K=n[R+1])==null?void 0:K.summary)==null?void 0:W.total)||0;return se>0?(j-se)/se:0}),P=(v,R=null)=>{let j=R!==null?[...v,R]:v;if(!j.length)return{min:0,max:0,avg:0};let se=Math.min(...j),de=Math.max(...j),K=v.length?v:j,W=K.reduce((Re,Ee)=>Re+Ee,0)/K.length;return{min:se,max:de,avg:W}},D=P(S,r),G=P(I,y),Q=P(g),J=(v,R,j,se=20)=>{if(j<=R)return"\u2591".repeat(se);let de=j-R,K=Math.max(0,Math.min(1,(v-R)/de)),W=Math.round(K*(se-1)),Re="";for(let Ee=0;Ee<se;Ee++)Ee===W?Re+="\u25CF":Re+="\u2591";return Re},F=Number(s.fixed)||0,q=Number(s.variable)||0,ne=Number(s.burden)||0,Ce=F+q,oe=r?ne/r:0,Z=Number(l.fixed)||0,ee=Number(l.variable)||0,ie=Number(l.burden)||0,ae=i?ie/i:0,te=o.departments||[],ge=te.filter(v=>{let R=(v.name||"").toLowerCase();return R.includes("sales")||R.includes("marketing")}),st=te.filter(v=>{let R=(v.name||"").toLowerCase();return!R.includes("sales")&&!R.includes("marketing")}),At=ge.reduce((v,R)=>v+(R.variable||0),0),Oe=ge.reduce((v,R)=>v+(R.headcount||0),0),Te=st.reduce((v,R)=>v+(R.variable||0),0),Le=st.reduce((v,R)=>v+(R.headcount||0),0),Pt=Oe?At/Oe:0,$t=Le?Te/Le:0,It=f?F/f:0,T=[],C=0,E={};E.headerStart=C;let on=c||_;if(typeof c=="number"||!isNaN(Number(c))&&c){let v=Number(c);if(v>4e4&&v<6e4){let R=new Date(1899,11,30);on=new Date(R.getTime()+v*24*60*60*1e3).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})}}T.push(["PAYROLL EXPENSE REVIEW"]),C++,T.push([`Period: ${on}`]),C++,T.push([`Generated: ${A}`]),C++,T.push([""]),C++,E.headerEnd=C-1,E.execSummaryStart=C,T.push(["EXECUTIVE SUMMARY"]),C++,E.execSummaryHeader=C-1,T.push([""]),C++,T.push(["","Pay Date","Headcount","Fixed Salary","Variable Salary","Burden","Total Payroll","Burden Rate"]),C++,E.execSummaryColHeaders=C-1,T.push(["Current Pay Period",o.label||o.key||"",f,F,q,ne,r,oe]),C++,E.execSummaryCurrentRow=C-1,T.push(["Same Period Prior Month",a.label||a.key||"",d,Z,ee,ie,i,ae]),C++,E.execSummaryPriorRow=C-1,T.push([""]),C++,T.push([""]),C++,E.execSummaryEnd=C-1,E.deptBreakdownStart=C,T.push(["CURRENT PERIOD BREAKDOWN (DEPARTMENT)"]),C++,E.deptBreakdownHeader=C-1,T.push([""]),C++,T.push(["Payroll Date",o.label||o.key||""]),C++,T.push([""]),C++,T.push(["Department","Fixed Salary","Variable Salary","Gross Pay","Burden","All-In Total","% of Total","Headcount"]),C++,E.deptColHeaders=C-1;let io=[...te].sort((v,R)=>(R.allIn||0)-(v.allIn||0));if(E.deptDataStart=C,io.forEach(v=>{T.push([v.name||"",v.fixed||0,v.variable||0,v.gross||0,v.burden||0,v.allIn||0,v.percent||0,v.headcount||0]),C++}),E.deptDataEnd=C-1,o.totalsRow){let v=o.totalsRow;T.push(["TOTAL",v.fixed||0,v.variable||0,v.gross||0,v.burden||0,v.allIn||0,1,v.headcount||0]),C++,E.deptTotalsRow=C-1}T.push([""]),C++,T.push([""]),C++,E.deptBreakdownEnd=C-1,E.historicalStart=C,T.push(["HISTORICAL CONTEXT"]),C++,E.historicalHeader=C-1,T.push([`Visual comparison of current period vs. historical range (${n.length} periods). The dot (\u25CF) shows where you currently stand.`]),C++,T.push([""]),C++;let X=v=>`$${Math.round(v/1e3)}K`,rt=v=>`${(v*100).toFixed(1)}%`;T.push(["","Metric","Low","Range","High","","Current","Average"]),C++,E.historicalColHeaders=C-1;let lo=n.map(v=>{var R;return((R=v.summary)==null?void 0:R.fixed)||0}).filter(v=>v>0),co=n.map(v=>{var R;return((R=v.summary)==null?void 0:R.variable)||0}),po=n.map(v=>{let R=v.summary||{};return R.total?(R.burden||0)/R.total:0}),uo=n.map(v=>{let R=v.summary||{},j=R.employeeCount||0;return j>0?(R.fixed||0)/j:0}).filter(v=>v>0),Ue=P(lo,F),Ge=P(co,q),ze=P(po,oe),We=P(uo,It);E.spectrumRows=[];let fo=J(r,D.min,D.max,25);T.push(["","Total Payroll",X(D.min),fo,X(D.max),"",X(r),X(D.avg)]),C++,E.spectrumRows.push(C-1);let mo=J(F,Ue.min,Ue.max,25);T.push(["","Total Fixed Payroll",X(Ue.min),mo,X(Ue.max),"",X(F),X(Ue.avg)]),C++,E.spectrumRows.push(C-1);let go=J(q,Ge.min,Ge.max,25);T.push(["","Total Variable Payroll",X(Ge.min),go,X(Ge.max),"",X(q),X(Ge.avg)]),C++,E.spectrumRows.push(C-1),T.push([""]),C++;let ho=J(It,We.min,We.max,25);T.push(["","Avg Fixed Payroll / Employee",X(We.min),ho,X(We.max),"",X(It),X(We.avg)]),C++,E.spectrumRows.push(C-1);let yo=n.map(v=>{let j=(v.departments||[]).filter(K=>{let W=(K.name||"").toLowerCase();return W.includes("sales")||W.includes("marketing")}),se=j.reduce((K,W)=>K+(W.variable||0),0),de=j.reduce((K,W)=>K+(W.headcount||0),0);return de>0?se/de:0}),it=P(yo,Pt),vo=n.map(v=>{let j=(v.departments||[]).filter(K=>{let W=(K.name||"").toLowerCase();return!W.includes("sales")&&!W.includes("marketing")}),se=j.reduce((K,W)=>K+(W.variable||0),0),de=j.reduce((K,W)=>K+(W.headcount||0),0);return de>0?se/de:0}),lt=P(vo,$t);if(Oe>0){let v=J(Pt,it.min,it.max,25);T.push(["","Avg Variable / Sales & Marketing",X(it.min),v,X(it.max),"",X(Pt),`${Oe} emp`]),C++,E.spectrumRows.push(C-1)}if(Le>0){let v=J($t,lt.min,lt.max,25);T.push(["","Avg Variable / Other Depts",X(lt.min),v,X(lt.max),"",X($t),`${Le} emp`]),C++,E.spectrumRows.push(C-1)}T.push([""]),C++;let bo=J(oe,ze.min,ze.max,25);T.push(["","Burden Rate (%)",rt(ze.min),bo,rt(ze.max),"",rt(oe),rt(ze.avg)]),C++,E.spectrumRows.push(C-1),T.push([""]),C++,T.push([""]),C++,E.historicalEnd=C-1,E.trendsStart=C,T.push(["PERIOD TRENDS"]),C++,E.trendsHeader=C-1,T.push([""]),C++,T.push(["Pay Period","Total Payroll","Fixed Payroll","Variable Payroll","Burden","Headcount"]),C++,E.trendColHeaders=C-1;let an=n.slice(0,6).reverse();E.trendDataStart=C,an.forEach(v=>{let R=v.summary||{};T.push([v.label||v.key||"",R.total||0,R.fixed||0,R.variable||0,R.burden||0,R.employeeCount||0]),C++}),E.trendDataEnd=C-1,T.push([""]),C++,E.trendsEnd=C-1,E.chartStart=C;for(let v=0;v<15;v++)T.push([""]),C++;E.payrollChartEnd=C-1,E.headcountChartStart=C;for(let v=0;v<12;v++)T.push([""]),C++;E.headcountChartEnd=C-1,console.log("writeExpenseReviewSheet: Writing",T.length,"rows");let sn=T.map(v=>{let R=Array.isArray(v)?v:[""];for(;R.length<10;)R.push("");return R.slice(0,10)});try{let v=t.getRangeByIndexes(0,0,sn.length,10);v.values=sn,await e.sync()}catch(v){throw console.error("writeExpenseReviewSheet: Write failed",v),v}try{t.getRange("A:A").format.columnWidth=200,t.getRange("B:B").format.columnWidth=130,t.getRange("C:C").format.columnWidth=100,t.getRange("D:D").format.columnWidth=200,t.getRange("E:E").format.columnWidth=100,t.getRange("F:F").format.columnWidth=100,t.getRange("G:G").format.columnWidth=100,t.getRange("H:H").format.columnWidth=100,t.getRange("I:I").format.columnWidth=80,t.getRange("J:J").format.columnWidth=80,await e.sync();let v=t.getRange("A1");v.format.font.bold=!0,v.format.font.size=22,v.format.font.color="#1e293b",t.getRange("A2").format.font.size=11,t.getRange("A2").format.font.color="#64748b",t.getRange("A3").format.font.size=10,t.getRange("A3").format.font.color="#94a3b8",await e.sync();let R=t.getRange(`A${E.execSummaryHeader+1}`);R.format.font.bold=!0,R.format.font.size=14,R.format.font.color="#1e293b";let j=t.getRange(`A${E.execSummaryColHeaders+1}:H${E.execSummaryColHeaders+1}`);j.format.font.bold=!0,j.format.font.size=10,j.format.fill.color="#1e293b",j.format.font.color="#ffffff";let se=t.getRange(`A${E.execSummaryCurrentRow+1}:H${E.execSummaryCurrentRow+1}`);se.format.fill.color="#dcfce7",se.format.font.bold=!0;let de=t.getRange(`A${E.execSummaryPriorRow+1}:H${E.execSummaryPriorRow+1}`);de.format.fill.color="#f1f5f9";for(let L of[E.execSummaryCurrentRow+1,E.execSummaryPriorRow+1])t.getRange(`C${L}`).numberFormat=[["#,##0"]],t.getRange(`D${L}`).numberFormat=[["$#,##0"]],t.getRange(`E${L}`).numberFormat=[["$#,##0"]],t.getRange(`F${L}`).numberFormat=[["$#,##0"]],t.getRange(`G${L}`).numberFormat=[["$#,##0"]],t.getRange(`H${L}`).numberFormat=[["0.00%"]];await e.sync();let K=t.getRange(`A${E.deptBreakdownHeader+1}`);K.format.font.bold=!0,K.format.font.size=14,K.format.font.color="#1e293b";let W=t.getRange(`A${E.deptColHeaders+1}:H${E.deptColHeaders+1}`);W.format.font.bold=!0,W.format.font.size=10,W.format.fill.color="#1e293b",W.format.font.color="#ffffff";for(let L=E.deptDataStart;L<=E.deptDataEnd;L++){let N=L+1;t.getRange(`B${N}`).numberFormat=[["$#,##0"]],t.getRange(`C${N}`).numberFormat=[["$#,##0"]],t.getRange(`D${N}`).numberFormat=[["$#,##0"]],t.getRange(`E${N}`).numberFormat=[["$#,##0"]],t.getRange(`F${N}`).numberFormat=[["$#,##0"]],t.getRange(`G${N}`).numberFormat=[["0.00%"]],t.getRange(`H${N}`).numberFormat=[["#,##0"]],(L-E.deptDataStart)%2===1&&(t.getRange(`A${N}:H${N}`).format.fill.color="#f8fafc")}if(E.deptTotalsRow){let L=t.getRange(`A${E.deptTotalsRow+1}:H${E.deptTotalsRow+1}`);L.format.font.bold=!0,L.format.fill.color="#1e293b",L.format.font.color="#ffffff";let N=E.deptTotalsRow+1;t.getRange(`B${N}`).numberFormat=[["$#,##0"]],t.getRange(`C${N}`).numberFormat=[["$#,##0"]],t.getRange(`D${N}`).numberFormat=[["$#,##0"]],t.getRange(`E${N}`).numberFormat=[["$#,##0"]],t.getRange(`F${N}`).numberFormat=[["$#,##0"]],t.getRange(`G${N}`).numberFormat=[["0%"]],t.getRange(`H${N}`).numberFormat=[["#,##0"]]}await e.sync();let Re=t.getRange(`A${E.historicalHeader+1}`);Re.format.font.bold=!0,Re.format.font.size=14,Re.format.font.color="#1e293b",t.getRange(`A${E.historicalHeader+2}`).format.font.size=10,t.getRange(`A${E.historicalHeader+2}`).format.font.color="#64748b",t.getRange(`A${E.historicalHeader+2}`).format.font.italic=!0;let Ee=t.getRange(`A${E.historicalColHeaders+1}:H${E.historicalColHeaders+1}`);Ee.format.font.bold=!0,Ee.format.font.size=10,Ee.format.fill.color="#e2e8f0",Ee.format.font.color="#334155",t.getRange(`C${E.historicalColHeaders+1}`).format.horizontalAlignment="Center",t.getRange(`E${E.historicalColHeaders+1}`).format.horizontalAlignment="Center",t.getRange(`G${E.historicalColHeaders+1}`).format.horizontalAlignment="Center",t.getRange(`H${E.historicalColHeaders+1}`).format.horizontalAlignment="Center",E.spectrumRows.forEach(L=>{t.getRange(`D${L+1}`).format.font.name="Consolas",t.getRange(`D${L+1}`).format.font.size=14,t.getRange(`D${L+1}`).format.font.color="#6366f1",t.getRange(`D${L+1}`).format.horizontalAlignment="Center",t.getRange(`B${L+1}`).format.font.color="#334155",t.getRange(`C${L+1}`).format.font.color="#94a3b8",t.getRange(`C${L+1}`).format.horizontalAlignment="Center",t.getRange(`E${L+1}`).format.font.color="#94a3b8",t.getRange(`E${L+1}`).format.horizontalAlignment="Center",t.getRange(`G${L+1}`).format.font.bold=!0,t.getRange(`G${L+1}`).format.font.color="#1e293b",t.getRange(`G${L+1}`).format.horizontalAlignment="Center",t.getRange(`H${L+1}`).format.font.color="#94a3b8",t.getRange(`H${L+1}`).format.horizontalAlignment="Center"}),await e.sync();let Nt=t.getRange(`A${E.trendsHeader+1}`);Nt.format.font.bold=!0,Nt.format.font.size=14,Nt.format.font.color="#1e293b";let ct=t.getRange(`A${E.trendColHeaders+1}:F${E.trendColHeaders+1}`);ct.format.font.bold=!0,ct.format.font.size=10,ct.format.fill.color="#1e293b",ct.format.font.color="#ffffff";for(let L=E.trendDataStart;L<=E.trendDataEnd;L++){let N=L+1;t.getRange(`B${N}`).numberFormat=[["$#,##0"]],t.getRange(`C${N}`).numberFormat=[["$#,##0"]],t.getRange(`D${N}`).numberFormat=[["$#,##0"]],t.getRange(`E${N}`).numberFormat=[["$#,##0"]],t.getRange(`F${N}`).numberFormat=[["#,##0"]],(L-E.trendDataStart)%2===1&&(t.getRange(`A${N}:F${N}`).format.fill.color="#f8fafc")}if(await e.sync(),an.length>=2){try{let L=t.getRange(`A${E.trendColHeaders+1}:E${E.trendDataEnd+1}`),N=t.charts.add(Excel.ChartType.lineMarkers,L,Excel.ChartSeriesBy.columns);N.setPosition(`A${E.chartStart+1}`,`J${E.payrollChartEnd+1}`),N.title.text="Payroll Expense Trends",N.title.format.font.size=14,N.title.format.font.bold=!0,N.legend.position=Excel.ChartLegendPosition.bottom,N.format.fill.setSolidColor("#ffffff"),N.format.border.lineStyle=Excel.ChartLineStyle.continuous,N.format.border.color="#e2e8f0";let Je=N.axes.getItem(Excel.ChartAxisType.category);Je.categoryType=Excel.ChartAxisCategoryType.textAxis,Je.setCategoryNames(t.getRange(`A${E.trendDataStart+1}:A${E.trendDataEnd+1}`)),await e.sync();let ke=N.series;ke.load("count"),await e.sync();let he=["#3b82f6","#22c55e","#f97316","#8b5cf6"];for(let Me=0;Me<Math.min(ke.count,he.length);Me++){let Ye=ke.getItemAt(Me);Ye.format.line.color=he[Me],Ye.format.line.weight=2,Ye.markerStyle=Excel.ChartMarkerStyle.circle,Ye.markerSize=6,Ye.markerBackgroundColor=he[Me]}await e.sync(),console.log("writeExpenseReviewSheet: Payroll chart created successfully")}catch(L){console.warn("writeExpenseReviewSheet: Payroll chart creation failed (non-critical)",L)}try{let L=t.getRange(`A${E.trendColHeaders+1}:F${E.trendDataEnd+1}`),N=t.charts.add(Excel.ChartType.lineMarkers,L,Excel.ChartSeriesBy.columns);N.setPosition(`A${E.headcountChartStart+1}`,`J${E.headcountChartEnd+1}`),N.title.text="Headcount Trend",N.title.format.font.size=12,N.title.format.font.bold=!0,N.legend.visible=!1,N.format.fill.setSolidColor("#ffffff"),N.format.border.lineStyle=Excel.ChartLineStyle.continuous,N.format.border.color="#e2e8f0";let Je=N.axes.getItem(Excel.ChartAxisType.category);Je.categoryType=Excel.ChartAxisCategoryType.textAxis,Je.setCategoryNames(t.getRange(`A${E.trendDataStart+1}:A${E.trendDataEnd+1}`)),await e.sync();let ke=N.series;ke.load("count, items/name"),await e.sync();for(let he=ke.count-2;he>=0;he--)ke.getItemAt(he).delete();if(await e.sync(),ke.load("count"),await e.sync(),ke.count>0){let he=ke.getItemAt(0);he.format.line.color="#64748b",he.format.line.weight=2.5,he.markerStyle=Excel.ChartMarkerStyle.circle,he.markerSize=8,he.markerBackgroundColor="#64748b"}await e.sync(),console.log("writeExpenseReviewSheet: Headcount chart created successfully")}catch(L){console.warn("writeExpenseReviewSheet: Headcount chart creation failed (non-critical)",L)}}t.freezePanes.freezeRows(E.execSummaryEnd+1),t.pageLayout.orientation=Excel.PageOrientation.landscape,t.getRange("A1").select(),await e.sync(),console.log("writeExpenseReviewSheet: Formatting applied successfully")}catch(v){console.warn("writeExpenseReviewSheet: Formatting error (non-critical)",v)}}function Aa(e){var o;return!e||!e.length?!1:(((o=e[0].summary)==null?void 0:o.categories)||[]).some(a=>{let s=(a.name||"").toLowerCase();return s.includes("commission")||s.includes("bonus")||s.includes("variable")})}function Pa(e,t){var l;if(!e||t.length<2)return!1;let n=t.map(c=>{var r;return((r=c.summary)==null?void 0:r.total)||0}).filter(c=>c>0);if(n.length<2)return!1;let o=n.reduce((c,r)=>c+r,0)/n.length,a=((l=e.summary)==null?void 0:l.total)||0;return(o>0?a/o:1)<.9}async function $a(e){if(!(!ce()||!e))try{await Excel.run(async t=>{let n=t.workbook.worksheets.getItemOrNullObject(e);n.load("name"),await t.sync(),!n.isNullObject&&(n.activate(),n.getRange("A1").select(),await t.sync())})}catch(t){console.warn(`Payroll Recorder: unable to activate worksheet ${e}`,t)}}async function Qt(){if(!ce()){H.lastError="Excel runtime is unavailable.",H.hasAnalyzed=!0,H.loading=!1,ue();return}H.loading=!0,H.lastError=null,ue();try{let e=await Excel.run(async t=>{let n=t.workbook.worksheets.getItem("SS_Employee_Roster"),o=t.workbook.worksheets.getItem($.DATA),a=n.getUsedRangeOrNullObject(),s=o.getUsedRangeOrNullObject();a.load("values"),s.load("values"),await t.sync();let l=a.isNullObject?[]:a.values||[],c=s.isNullObject?[]:s.values||[],r=Na(l),i=Oa(c),u=[];r.employeeMap.forEach((d,h)=>{i.employeeMap.has(h)||u.push({name:d.name||"Unknown Employee",type:"missing_from_payroll",message:"In roster but NOT in payroll data",department:d.department||"\u2014"})}),i.employeeMap.forEach((d,h)=>{r.employeeMap.has(h)||u.push({name:d.name||"Unknown Employee",type:"missing_from_roster",message:"In payroll but NOT in roster",department:d.department||"\u2014"})}),u.sort((d,h)=>d.type!==h.type?d.type.localeCompare(h.type):(d.name||"").localeCompare(h.name||""));let p=[],f=0;return r.employeeMap.forEach((d,h)=>{let y=i.employeeMap.get(h);if(!y)return;let w=fe(d.department),m=fe(y.department);!w&&!m||(f+=1,w!==m&&p.push({employee:d.name||y.name||"Employee",rosterDept:w||"\u2014",payrollDept:m||"\u2014"}))}),console.log("Headcount Analysis Results:",{rosterCount:r.activeCount,payrollCount:i.totalEmployees,difference:r.activeCount-i.totalEmployees,missingFromPayroll:u.filter(d=>d.type==="missing_from_payroll").length,missingFromRoster:u.filter(d=>d.type==="missing_from_roster").length,deptMismatches:p.length}),{roster:{rosterCount:r.activeCount,payrollCount:i.totalEmployees,difference:r.activeCount-i.totalEmployees,mismatches:u},departments:{rosterCount:f,payrollCount:f,difference:p.length,mismatches:p}}});H.roster=e.roster,H.departments=e.departments,H.hasAnalyzed=!0}catch(e){console.warn("Headcount Review: unable to analyze data",e),H.lastError="Unable to analyze headcount data. Try re-running the analysis."}finally{H.loading=!1,ue()}}function Ze(e={},{rerender:t=!0}={}){Object.assign(V,e);let n=Number(V.prDataTotal),o=Number(V.cleanTotal);V.reconDifference=Number.isFinite(n)&&Number.isFinite(o)?n-o:null;let a=nn(V.bankAmount);V.bankDifference=Number.isFinite(o)&&!Number.isNaN(a)?o-a:null,V.plugEnabled=V.bankDifference!=null&&Math.abs(V.bankDifference)>=.5,t?ue():Ia()}function Ia(){if(re.activeStepId!==3)return;let e=(o,a)=>{let s=document.getElementById(o);s&&(s.value=a)};e("pr-data-total-value",pe(V.prDataTotal)),e("clean-total-value",pe(V.cleanTotal)),e("recon-diff-value",pe(V.reconDifference)),e("bank-clean-total-value",pe(V.cleanTotal)),e("bank-diff-value",V.bankDifference!=null?pe(V.bankDifference):"---");let t=document.getElementById("bank-diff-hint");t&&(t.textContent=V.bankDifference==null?"":Math.abs(V.bankDifference)<.5?"Difference within acceptable tolerance.":"Difference exceeds tolerance and should be resolved.");let n=document.getElementById("bank-plug-btn");n&&(n.disabled=!V.plugEnabled)}function Et(e={},{rerender:t=!0}={}){Object.assign(Se,e),t&&ue()}async function Wn(){if(!ce()){Ze({loading:!1,lastError:"Excel runtime is unavailable.",prDataTotal:null,cleanTotal:null});return}Ze({loading:!0,lastError:null});try{let e="";await Excel.run(async n=>{let o=await Ie(n);if(console.log("DEBUG - Config table found:",!!o),o){let a=o.getDataBodyRange();a.load("values"),await n.sync();let s=a.values||[];console.log("DEBUG - Config table rows:",s.length),console.log("DEBUG - Looking for payroll date aliases:",nt),console.log("DEBUG - CONFIG_COLUMNS.FIELD:",M.FIELD,"CONFIG_COLUMNS.VALUE:",M.VALUE);for(let l of s){let c=String(l[M.FIELD]||"").trim(),r=l[M.VALUE],i=nt.some(u=>c===u||le(c)===le(u));if((c.toLowerCase().includes("payroll")||c.toLowerCase().includes("date"))&&console.log("DEBUG - Potential date field:",c,"=",r,"| isMatch:",i),i){let u=l[M.VALUE];console.log("DEBUG - Found payroll date field!",c,"raw value:",u),e=ve(u)||"",console.log("DEBUG - Formatted payroll date:",e);break}}e||(console.warn("DEBUG - No payroll date found in config! Available fields:"),s.forEach((l,c)=>{console.log(`  Row ${c}: Field="${l[M.FIELD]}" Value="${l[M.VALUE]}"`)}))}else console.warn("DEBUG - Config table not found!")}),console.log("DEBUG prepareValidationData - Final Payroll Date:",e||"(empty)");let t=await Excel.run(async n=>{var I;let o=n.workbook.worksheets.getItem($.DATA),a=n.workbook.worksheets.getItem($.EXPENSE_MAPPING),s=n.workbook.worksheets.getItem($.DATA_CLEAN),l=o.getUsedRangeOrNullObject(),c=a.getUsedRangeOrNullObject(),r=s.getUsedRangeOrNullObject();l.load("values"),c.load("values"),r.load(["address","rowCount"]),await n.sync();let i=l.isNullObject?[]:l.values||[],u=c.isNullObject?[]:c.values||[];console.log("DEBUG prepareValidationData - PR_Data rows:",i.length),console.log("DEBUG prepareValidationData - PR_Data headers:",i[0]),console.log("DEBUG prepareValidationData - PR_Expense_Mapping rows:",u.length);let p=((I=u[0])==null?void 0:I.map(g=>be(g)))||[],f=g=>p.findIndex(g),d={category:f(g=>g.includes("category")),accountNumber:f(g=>g.includes("account")&&(g.includes("number")||g.includes("#"))),accountName:f(g=>g.includes("account")&&g.includes("name")),expenseReview:f(g=>g.includes("expense")&&g.includes("review"))},h=new Map;u.slice(1).forEach(g=>{var D,G,Q;let P=d.category>=0?Kt(g[d.category]):"";P&&h.set(P,{accountNumber:d.accountNumber>=0&&(D=g[d.accountNumber])!=null?D:"",accountName:d.accountName>=0&&(G=g[d.accountName])!=null?G:"",expenseReview:d.expenseReview>=0&&(Q=g[d.expenseReview])!=null?Q:""})});let y=s.getRangeByIndexes(0,0,1,8);y.load("values"),await n.sync();let w=y.values[0]||[],m=w.map(g=>be(g));console.log("DEBUG prepareValidationData - PR_Data_Clean headers:",w),console.log("DEBUG prepareValidationData - PR_Data_Clean normalized:",m),console.log("DEBUG - PR_Data_Clean headers:",w),console.log("DEBUG - PR_Data_Clean normalized headers:",m);let b=m.findIndex(g=>(g.includes("payroll")||g.includes("period"))&&g.includes("date"));console.log("DEBUG - payrollDate column index:",b),b===-1&&(console.warn("DEBUG - No payroll date column found! Looking for header containing 'payroll'/'period' AND 'date'"),m.forEach((g,P)=>console.log(`  Col ${P}: "${g}"`)));let k={payrollDate:b,employee:m.findIndex(g=>g.includes("employee")),department:He(m),payrollCategory:m.findIndex(g=>g.includes("payroll")&&g.includes("category")),accountNumber:m.findIndex(g=>g.includes("account")&&(g.includes("number")||g.includes("#"))),accountName:m.findIndex(g=>g.includes("account")&&g.includes("name")),amount:m.findIndex(g=>g.includes("amount")),expenseReview:m.findIndex(g=>g.includes("expense")&&g.includes("review"))};console.log("DEBUG prepareValidationData - fieldMap:",k);let _=w.length,A=[],B=0,S=0;if(i.length>=2){let g=i[0],P=g.map(F=>be(F));console.log("DEBUG prepareValidationData - Normalized headers:",P);let D=P.findIndex(F=>F.includes("employee")),G=He(P);console.log("DEBUG prepareValidationData - Employee column index:",D,"searching for 'employee' in:",P[6]),console.log("DEBUG prepareValidationData - Department column index:",G);let Q=h.size>0,J=P.reduce((F,q,ne)=>{if(ne===D||ne===G||!q||q.includes("total")||q.includes("gross")||q.includes("date")||q.includes("period"))return F;let Ce=Kt(g[ne]||q);return Q&&!h.has(Ce)||F.push(ne),F},[]);console.log("DEBUG prepareValidationData - Numeric columns:",J.length,J);for(let F=1;F<i.length;F+=1){let q=i[F],ne=D>=0?fe(q[D]):"";if(!ne||ne.toLowerCase().includes("total"))continue;let Ce=G>=0&&q[G]||"";J.forEach(oe=>{let Z=q[oe],ee=Number(Z);if(!Number.isFinite(ee)||ee===0)return;B+=ee;let ie=g[oe]||P[oe]||`Column ${oe+1}`,ae=h.get(Kt(ie))||{};S+=ee;let te=new Array(_).fill("");k.payrollDate>=0?te[k.payrollDate]=e:_>0&&(te[0]=e),A.length===0&&(console.log("DEBUG - Building first PR_Data_Clean row:"),console.log("  payrollDate value:",e),console.log("  fieldMap.payrollDate:",k.payrollDate),console.log("  Writing to column index:",k.payrollDate>=0?k.payrollDate:0)),k.employee>=0&&(te[k.employee]=ne),k.department>=0&&(te[k.department]=Ce),k.payrollCategory>=0&&(te[k.payrollCategory]=ie),k.accountNumber>=0&&(te[k.accountNumber]=ae.accountNumber||""),k.accountName>=0&&(te[k.accountName]=ae.accountName||""),k.amount>=0&&(te[k.amount]=ee),k.expenseReview>=0&&(te[k.expenseReview]=ae.expenseReview||""),A.push(te)})}}if(console.log("DEBUG prepareValidationData - Clean rows generated:",A.length),console.log("DEBUG prepareValidationData - PR_Data total:",B,"Clean total:",S),console.log("DEBUG prepareValidationData - columnCount:",_,"cleanRange.address:",r.address),!r.isNullObject&&r.address){console.log("DEBUG prepareValidationData - Clearing data rows...");let g=Math.max(0,(r.rowCount||0)-1),P=Math.max(1,g);s.getRangeByIndexes(1,0,P,_).clear(),await n.sync(),console.log("DEBUG prepareValidationData - Data rows cleared")}if(console.log("DEBUG prepareValidationData - About to write",A.length,"rows with",_,"columns"),A.length>0){let g=s.getRangeByIndexes(1,0,A.length,_);g.values=A,console.log("DEBUG prepareValidationData - Data written to PR_Data_Clean")}else console.log("DEBUG prepareValidationData - No rows to write!");return await n.sync(),{prDataTotal:B,cleanTotal:S}});Ze({loading:!1,lastError:null,prDataTotal:t.prDataTotal,cleanTotal:t.cleanTotal})}catch(e){console.warn("Validate & Reconcile: unable to prepare PR_Data_Clean",e),Ze({loading:!1,prDataTotal:null,cleanTotal:null,lastError:"Unable to prepare reconciliation data. Try again."})}}function Na(e){let t={activeCount:0,departmentCount:0,employeeMap:new Map};if(!e||!e.length)return t;let{headers:n,dataStartIndex:o}=ro(e,["employee"]);if(!n.length||o==null)return t;let a=so(n),s=n.findIndex(r=>r.includes("termination")),l=He(n);if(a===-1)return t;let c=new Set;for(let r=o;r<e.length;r+=1){let i=e[r],u=i[a],p=ao(u);if(!p||no(p))continue;let f=s>=0?i[s]:"",d=l>=0?i[l]:"";!fe(f)&&!c.has(p)&&(c.add(p),t.activeCount+=1),d&&(t.departmentCount+=1),t.employeeMap.has(p)||t.employeeMap.set(p,{name:fe(u)||p,department:fe(d),termination:f})}return t}function Oa(e){let t={totalEmployees:0,departmentCount:0,employeeMap:new Map};if(!e||!e.length)return t;let{headers:n,dataStartIndex:o}=ro(e,["employee"]);if(!n.length||o==null)return t;let a=so(n),s=He(n);if(a===-1)return t;let l=new Set;for(let c=o;c<e.length;c+=1){let r=e[c],i=r[a],u=ao(i);if(!u||no(u))continue;l.has(u)||(l.add(u),t.totalEmployees+=1);let p=s>=0?r[s]:"";p&&(t.departmentCount+=1),t.employeeMap.has(u)||t.employeeMap.set(u,{name:fe(i)||u,department:fe(p)})}return t}function be(e){return fe(e).toLowerCase()}function ao(e){return fe(e).toLowerCase()}function so(e=[]){let t=e.findIndex(o=>o.includes("employee")&&o.includes("name"));return t>=0?t:e.findIndex(o=>o.includes("employee"))}function ro(e,t=[]){let n=[],o=null;return(e||[]).some((a,s)=>{let l=(a||[]).map(be);return t.every(r=>l.some(i=>i.includes(r)))?(n=l,o=s,!0):!1}),{headers:n,dataStartIndex:o!=null?o+1:null}}function fe(e){return e==null?"":String(e).trim()}function Kt(e){return fe(e).toLowerCase()}function He(e=[]){let t=e.map((l,c)=>({idx:c,value:be(l)})),n=t.find(({value:l})=>l.includes("department")&&l.includes("description"));if(n)return console.log("DEBUG pickDepartmentIndex - Using 'Department Description' at index:",n.idx),n.idx;let o=t.find(({value:l})=>l.includes("department")&&l.includes("name"));if(o)return console.log("DEBUG pickDepartmentIndex - Using 'Department Name' at index:",o.idx),o.idx;let a=t.find(({value:l})=>l.includes("department")&&!l.includes("id")&&!l.includes("#")&&!l.includes("code")&&!l.includes("number"));if(a)return console.log("DEBUG pickDepartmentIndex - Using non-ID department at index:",a.idx),a.idx;let s=t.find(({value:l})=>l.includes("department"));return s&&console.log("DEBUG pickDepartmentIndex - Using fallback department at index:",s.idx),s?s.idx:-1}function Jn(e,t,n={}){if(Xt(),!t||!t.length)return;let o=document.createElement("div");o.className="pf-modal";let a=t.filter(r=>r.type==="missing_from_payroll"),s=t.filter(r=>r.type==="missing_from_roster"),l=t.filter(r=>!r.type),c="";if(a.length>0&&(c+=`
    ...
    `,o.addEventListener("click",r=>{r.target===o&&Xt()}),o.querySelectorAll("[data-modal-close]").forEach(r=>{r.addEventListener("click",Xt)}),document.body.appendChild(o)}function Xt(){var e;(e=document.querySelector(".pf-modal"))==null||e.remove()}function kt(){let e=document.getElementById("headcount-signoff-toggle");if(!e)return;let t=Dt(),n=document.getElementById("step-notes-input"),o=(n==null?void 0:n.value.trim())||"";e.disabled=t&&!o;let a=document.getElementById("headcount-notes-hint");a&&(a.textContent=t?"Please document outstanding differences before signing off.":""),H.skipAnalysis&&Zt()}function Ta(){var n;let e=Dt(),t=((n=document.getElementById("step-notes-input"))==null?void 0:n.value.trim())||"";if(e&&!t){window.alert("Please enter a brief explanation of the outstanding differences before completing this step.");return}en({statusText:"Headcount Review signed off."})}function Zt(){let e=document.getElementById("step-notes-input");if(!e)return;let t=e.value||"",n=t.startsWith(vt)?t.slice(vt.length).replace(/^\s+/,""):t.replace(new RegExp(`^${vt}\\s*`,"i"),"").trimStart(),o=vt+(n?`
${n}`:"");if(e.value!==o){e.value=o;let a=_e(2);a&&U(a.note,o)}}function Yn(e){let t=e!=null&&e.target&&e.target instanceof HTMLInputElement?e.target:document.getElementById("bank-amount-input"),n=nn(t==null?void 0:t.value),o=oo(n);t&&(t.value=o),Ze({bankAmount:n},{rerender:!1})}function La(){let e=we.findIndex(t=>t.id===3);e!==-1&&ot(Math.min(we.length-1,e+1))}function Ma(){let e=we.findIndex(t=>t.id===4);e!==-1&&ot(Math.min(we.length-1,e+1))}async function Ba(){if(!ce()){window.alert("Excel runtime is unavailable.");return}if(window.confirm(`Archive Payroll Run
