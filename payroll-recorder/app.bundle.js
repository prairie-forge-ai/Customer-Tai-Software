...
`.trim();function We(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Mt(e,t){return`
    ...
    `;let c=document.getElementById("pf-info-fab-payroll");if(s)c&&c.remove();else if((r=window.PrairieForge)!=null&&r.mountInfoFab){let i=Lo(te.activeStepId);PrairieForge.mountInfoFab({title:i.title,content:i.content,buttonId:"pf-info-fab-payroll"})}if(Qo(),o)ta();else if(a)try{na(te.activeStepId)}catch(i){console.warn("Payroll Recorder: failed to bind step interactions",i)}else ea();oa(),s?un():Tt()}function Vo(e,t){let n=P("SS_Company_Name")||"your company";return`
    ...
    `}function jo(){if(!W.loaded)return`
        ...
        `;let e=$e[0],t=ye(Ct()),n=ye(P("PR_Accounting_Period")),o=P("PR_Journal_Entry_ID"),a=P("SS_Accounting_Software"),s=qt(),l=P("SS_Company_Name"),c=P(qe)||De(),r=e?P(e.note):"",i=e?Re(e.note):!1,u=(e?P(e.reviewer):"")||De(),f=e?ye(P(e.signOff)):"",p=!!(f||P(de[0]));return`
    ...
    `}function Ho(e){let t=Se(1),n=t?Re(t.note):!1,o=t?P(t.note):"",a=(t?P(t.reviewer):"")||De(),s=t?ye(P(t.signOff)):"",l=!!(s||P(de[1])),c=qt();return`
        ...
        <section class="pf-step-guide">
            <article class="pf-step-card pf-step-detail pf-config-card">
                ...
                <div class="pf-signoff-action">
                    ${ge(c?`<a href="${S(c)}" target="_blank" rel="noopener noreferrer" class="pf-action-toggle pf-clickable" title="Open payroll provider">${ut}</a>`:`<button type="button" class="pf-action-toggle pf-clickable" id="import-provider-btn" disabled title="Add provider link in Configuration">${ut}</button>`,"Provider")}
    ...
    `}function Uo(e){var $,V,x,T,m,I,L,Q,ue,K;let t=Se(2),n=t?P(t.note):"",o=t?Re(t.note):!1,a=(t?P(t.reviewer):"")||De(),s=t?ye(P(t.signOff)):"",l=!!(s||P(de[2])),c=Rt(),r=H.roster||{},i=H.departments||{},u=H.hasAnalyzed,f="";H.loading?f='<p class="pf-step-note">Analyzing roster and payroll data\u2026</p>':H.lastError&&(f=`<p class="pf-step-note">${S(H.lastError)}</p>`);let p=(M,Y,ne)=>{let xe=!u,X;xe?X='<span class="pf-je-check-circle pf-je-circle--pending"></span>':ne?X=`<span class="pf-je-check-circle pf-je-circle--pass">
        ...
        ${p("Difference",d,d===0)}
    `,E=`
        ${p("Expected departments",(m=i.rosterCount)!=null?m:"\u2014",!0)}
        ${p("PR_Data departments",(I=i.payrollCount)!=null?I:"\u2014",!0)}
        ${p("Difference",g,g===0)}
    `,k=v.length&&!H.skipAnalysis&&u&&((Q=(L=window.PrairieForge)==null?void 0:L.renderMismatchTiles)==null?void 0:Q.call(L,{mismatches:v,label:"Employees Driving the Difference",sourceLabel:"Roster",targetLabel:"Payroll Data",escapeHtml:S}))||"",_=w.length&&!H.skipAnalysis&&u&&((K=(ue=window.PrairieForge)==null?void 0:ue.renderMismatchTiles)==null?void 0:K.call(ue,{mismatches:w,label:"Employees with Department Differences",formatter:M=>({name:M.employee||M.name||"",source:`${M.rosterDept||"\u2014"} \u2192 ${M.payrollDept||"\u2014"}`,isMissingFromTarget:!0}),escapeHtml:S}))||"";return`
        <section class="pf-hero" id="pf-step-hero">
            <p class="pf-hero-copy">${S(Pe)} | Step ${e.id}</p>
        ...
        <section class="pf-step-guide">
            <article class="pf-step-card pf-step-detail pf-config-card">
                ...
                <div class="pf-signoff-action">
                    ${ge(`<button type="button" class="pf-action-toggle pf-clickable" id="roster-run-btn" title="Run headcount analysis">${pt}</button>`,"Run")}
    ...
    `;return`
        ...
        <section class="pf-step-guide">
            <article class="pf-step-card pf-step-detail pf-config-card">
                ...
                <div class="pf-signoff-action">
                    ${ge(`<button type="button" class="pf-action-toggle pf-clickable" id="validation-run-btn" title="Run reconciliation">${pt}</button>`,"Run")}
    ...
    `}function zo(e){let t=Se(4),n=t?P(t.note):"",o=(t?P(t.reviewer):"")||De(),a=t?ye(P(t.signOff)):"",s=!!(a||P(de[4])),l=ke.loading?'<p class="pf-step-note">Preparing executive summary\u2026</p>':ke.lastError?`<p class="pf-step-note">${S(ke.lastError)}</p>`:"",c=rn({id:"expense-review-copilot",body:"Want help analyzing your data? Just ask!",placeholder:"Where should I focus this pay period?",buttonLabel:"Ask CoPilot"});return`
        ...
        <section class="pf-step-guide">
            ...
            <article class="pf-step-card pf-step-detail pf-config-card">
                ...
                <div class="pf-signoff-action">
                    ${ge(`<button type="button" class="pf-action-toggle" id="expense-run-btn" title="Run expense review analysis">${pt}</button>`,"Run")}
    ...
    `}function Wo(e){var $,V,x;let t=Se(5),n=t?P(t.note):"",o=t?Re(t.note):!1,a=(t?P(t.reviewer):"")||De(),s=t?ye(P(t.signOff)):"",l=!!(s||P(de[5])),c=G.lastError?`<p class="pf-step-note">${S(G.lastError)}</p>`:"",r=G.debitTotal!==null,i=($=G.debitTotal)!=null?$:0,u=(V=G.creditTotal)!=null?V:0,f=i-u,p=(x=F.cleanTotal)!=null?x:0,d=r,g=r&&Math.abs(f-p)<.01,v=(T,m)=>{let I=!r,L;return I?L='<span class="pf-je-check-circle pf-je-circle--pending"></span>':m?L=`<span class="pf-je-check-circle pf-je-circle--pass">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg>
    ...
    `}function Jo(e){let t=be.filter(a=>a.id!==6).map(a=>({id:a.id,title:a.title,complete:ia(a.id)})),n=t.every(a=>a.complete),o=t.map(a=>`
            <article class="pf-step-card pf-step-detail pf-config-card">
                <div class="pf-config-head pf-notes-header">
    ...
    `}function Yo(e){let t=rt.find(_=>_.id===e)||{id:e!=null?e:"-",title:"Workflow Step",summary:"",description:"",checklist:[]};if(e===1)return Ho(t);if(e===2)return Uo(t);if(e===3)return Go(t);if(e===4)return zo(t);if(e===5)return Wo(t);if(e===6)return Jo(t);let n=!1,o=Se(e),a=o?P(o.note):"",s=o?Re(o.note):!1,l=(o?P(o.reviewer):"")||De(),c=o?ye(P(o.signOff)):"",r=o&&de[e]?!!(c||P(de[e])):!!c,i=(t.highlights||[]).map(_=>`
        ...
        `).join(""),u=(t.checklist||[]).map(_=>`<li>${S(_)}</li>`).join("")||"",f=n?"":t.description||"Detailed guidance will appear here.",p=[];!n&&t.ctaLabel&&p.push(`<button type="button" class="pf-pill-btn" id="step-action-btn">${S(t.ctaLabel)}</button>`),n||p.push('<button type="button" class="pf-pill-btn pf-pill-btn--ghost" id="step-back-btn">Back to Step List</button>');let d=p.length?`<div class="pf-pill-row pf-config-actions">${p.join("")}</div>`:"",g=qt(),v=n?`
            <div class="pf-link-card">
                ...
                <div class="pf-link-list">
                    ...
                    >
                        <span class="pf-link-item__icon">${ut}</span>
    ...
    `}function Xo(e){return e===0?"config":e===1?"import":e===2?"headcount":e===3?"validate":e===4?"review":e===5?"journal":e===6?"archive":""}function Qo(){var n,o,a,s,l,c,r;(n=document.getElementById("nav-home"))==null||n.addEventListener("click",()=>{var i;Hn(),(i=document.getElementById("pf-hero"))==null||i.scrollIntoView({behavior:"smooth",block:"start"})}),(o=document.getElementById("nav-selector"))==null||o.addEventListener("click",()=>{window.location.href="../module-selector/index.html"}),(a=document.getElementById("nav-prev"))==null||a.addEventListener("click",()=>In(-1)),(s=document.getElementById("nav-next"))==null||s.addEventListener("click",()=>In(1));let e=document.getElementById("nav-quick-toggle"),t=document.getElementById("quick-access-dropdown");e==null||e.addEventListener("click",i=>{i.stopPropagation(),t==null||t.classList.toggle("hidden"),e.classList.toggle("is-active")}),document.addEventListener("click",i=>{!(t!=null&&t.contains(i.target))&&!(e!=null&&e.contains(i.target))&&(t==null||t.classList.add("hidden"),e==null||e.classList.remove("is-active"))}),(l=document.getElementById("nav-roster"))==null||l.addEventListener("click",()=>{Pn("SS_Employee_Roster"),t==null||t.classList.add("hidden"),e==null||e.classList.remove("is-active")}),(c=document.getElementById("nav-accounts"))==null||c.addEventListener("click",()=>{Pn("SS_Chart_of_Accounts"),t==null||t.classList.add("hidden"),e==null||e.classList.remove("is-active")}),(r=document.getElementById("nav-expense-map"))==null||r.addEventListener("click",async()=>{t==null||t.classList.add("hidden"),e==null||e.classList.remove("is-active"),await Zo()})}async function Pn(e){if(!e||typeof Excel=="undefined")return;let t={SS_Employee_Roster:["Employee","Department","Pay_Rate","Status","Hire_Date"],SS_Chart_of_Accounts:["Account_Number","Account_Name","Type","Category"]};try{await Excel.run(async n=>{let o=n.workbook.worksheets.getItemOrNullObject(e);if(o.load("isNullObject"),await n.sync(),o.isNullObject){o=n.workbook.worksheets.add(e);let a=t[e]||["Column1","Column2"],s=o.getRange(`A1:${String.fromCharCode(64+a.length)}1`);s.values=[a],s.format.font.bold=!0,s.format.fill.color="#f0f0f0",s.format.autofitColumns(),await n.sync()}o.activate(),o.getRange("A1").select(),await n.sync()})}catch(n){console.error("Error opening reference sheet:",n)}}async function Zo(){try{await Excel.run(async e=>{let t=e.workbook.worksheets.getItemOrNullObject("PR_Expense_Mapping");if(t.load("isNullObject"),await e.sync(),t.isNullObject){t=e.workbook.worksheets.add("PR_Expense_Mapping");let n=["Expense_Category","GL_Account","Description","Active"],o=t.getRange("A1:D1");o.values=[n],o.format.font.bold=!0}t.activate(),t.getRange("A1").select(),await e.sync()})}catch(e){console.error("Error navigating to PR_Expense_Mapping:",e)}}function ea(){document.querySelectorAll("[data-step-card]").forEach(e=>{let t=Number(e.getAttribute("data-step-index"));e.addEventListener("click",()=>Qe(t))})}function ta(){var r,i,u,f;let e=document.getElementById("config-user-name");e==null||e.addEventListener("change",p=>{let d=p.target.value.trim();U(qe,d);let g=document.getElementById("config-reviewer-name");g&&!g.value&&(g.value=d)});let t=document.getElementById("config-payroll-date");t==null||t.addEventListener("change",p=>{let d=p.target.value||"";if(U(Wn(),d),!!d){if(!W.overrides.accountingPeriod){let g=la(d);if(g){let v=document.getElementById("config-accounting-period");v&&(v.value=g),U("PR_Accounting_Period",g)}}if(!W.overrides.jeId){let g=ca(d);if(g){let v=document.getElementById("config-je-id");v&&(v.value=g),U("PR_Journal_Entry_ID",g)}}}});let n=Se(0),o=document.getElementById("config-accounting-period");o==null||o.addEventListener("change",p=>{W.overrides.accountingPeriod=!!p.target.value,U("PR_Accounting_Period",p.target.value||"")});let a=document.getElementById("config-je-id");a==null||a.addEventListener("change",p=>{W.overrides.jeId=!!p.target.value,U("PR_Journal_Entry_ID",p.target.value.trim())}),(r=document.getElementById("config-company-name"))==null||r.addEventListener("change",p=>{U("SS_Company_Name",p.target.value.trim())}),(i=document.getElementById("config-payroll-provider"))==null||i.addEventListener("change",p=>{let d=p.target.value.trim();U(jn,d)}),(u=document.getElementById("config-accounting-link"))==null||u.addEventListener("change",p=>{U("SS_Accounting_Software",p.target.value.trim())});let s=document.getElementById("config-notes");if(s==null||s.addEventListener("input",p=>{n&&U(n.note,p.target.value,{debounceMs:400})}),n){let p=document.getElementById("config-notes-permanent");p&&(p.addEventListener("click",()=>{let g=!p.classList.contains("is-locked");Je(p,g),Jn(n.note,g)}),Je(p,Re(n.note)));let d=document.getElementById("config-notes-save");d==null||d.addEventListener("click",()=>{s&&(U(n.note,s.value),Te(d,!0))})}let l=document.getElementById("config-reviewer-name");l==null||l.addEventListener("change",p=>{let d=p.target.value.trim();n&&U(n.reviewer,d),U(qe,d);let g=document.getElementById("config-signoff-date");if(d&&g&&!g.value){let v=Ze();g.value=v,n&&U(n.signOff,v)}}),(f=document.getElementById("config-signoff-date"))==null||f.addEventListener("change",p=>{n&&U(n.signOff,p.target.value||"")});let c=document.getElementById("config-signoff-save");if(c==null||c.addEventListener("click",()=>{var v;let p=((v=l==null?void 0:l.value)==null?void 0:v.trim())||"",d=document.getElementById("config-signoff-date"),g=(d==null?void 0:d.value)||"";n&&(U(n.reviewer,p),U(n.signOff,g)),U(qe,p),Te(c,!0)}),Vt(),n){let p=P(n.signOff),d=P(de[0]),g=!!(p||d==="Y"||d===!0);console.log(`[Step 0] Binding signoff toggle. signOff="${p}", complete="${d}", isComplete=${g}`),Gn({buttonId:"config-signoff-toggle",inputId:"config-signoff-date",fieldName:n.signOff,completeField:de[0],initialActive:g,stepId:0})}}function na(e){var n,o,a,s,l,c,r,i,u,f,p,d,g,v,w,h,E,k,_,$,V;if((n=document.getElementById("step-back-btn"))==null||n.addEventListener("click",()=>{Hn()}),(o=document.getElementById("step-action-btn"))==null||o.addEventListener("click",()=>{let x=rt.find(T=>T.id===e);window.alert(x!=null&&x.ctaLabel?`${x.ctaLabel} coming soon.`:"Step actions coming soon.")}),e===1&&((a=document.getElementById("import-open-data-btn"))==null||a.addEventListener("click",()=>sa()),(s=document.getElementById("import-clear-btn"))==null||s.addEventListener("click",()=>ra())),e===2&&((l=document.getElementById("headcount-skip-btn"))==null||l.addEventListener("click",()=>{H.skipAnalysis=!H.skipAnalysis;let x=document.getElementById("headcount-skip-btn");x==null||x.classList.toggle("is-active",H.skipAnalysis),H.skipAnalysis&&Jt(),vt()}),(c=document.getElementById("roster-run-btn"))==null||c.addEventListener("click",()=>Wt()),(r=document.getElementById("roster-refresh-btn"))==null||r.addEventListener("click",()=>Wt()),(i=document.getElementById("roster-review-btn"))==null||i.addEventListener("click",()=>{var T;let x=((T=H.roster)==null?void 0:T.mismatches)||[];Vn("Roster Differences",x,{sourceLabel:"Roster",targetLabel:"Payroll Data"})}),(u=document.getElementById("dept-review-btn"))==null||u.addEventListener("click",()=>{var T;let x=((T=H.departments)==null?void 0:T.mismatches)||[];Vn("Department Differences",x,{sourceLabel:"Roster",targetLabel:"Payroll",formatter:m=>({name:m.employee,source:`${m.rosterDept} \u2192 ${m.payrollDept}`,isMissingFromTarget:!0})})})),e===3&&((f=document.getElementById("validation-run-btn"))==null||f.addEventListener("click",()=>Mn()),(p=document.getElementById("validation-refresh-btn"))==null||p.addEventListener("click",()=>Mn()),(d=document.getElementById("bank-amount-input"))==null||d.addEventListener("blur",Fn),(g=document.getElementById("bank-amount-input"))==null||g.addEventListener("keydown",x=>{x.key==="Enter"&&Fn(x)})),e===5&&((v=document.getElementById("je-run-btn"))==null||v.addEventListener("click",()=>Oa()),(w=document.getElementById("je-save-btn"))==null||w.addEventListener("click",()=>Ta()),(h=document.getElementById("je-create-btn"))==null||h.addEventListener("click",()=>La()),(E=document.getElementById("je-export-btn"))==null||E.addEventListener("click",()=>Ba())),e===4){let x=document.querySelector(".pf-step-guide");if(x){let T="https://your-project.supabase.co/functions/v1/copilot";ln(x,{id:"expense-review-copilot",contextProvider:pa(),systemPrompt:`You are Prairie Forge CoPilot, an expert financial analyst assistant for payroll expense review.
...
Continue?`))try{if(console.log("[Archive] Step 1: Creating archive workbook..."),!await Da()){window.alert("Archive cancelled or failed. No data was modified.");return}console.log("[Archive] Step 1 complete: Archive workbook created"),console.log("[Archive] Step 2: Updating PR_Archive_Summary..."),await Pa(),console.log("[Archive] Step 2 complete: Archive summary updated"),console.log("[Archive] Step 3: Clearing working data..."),await Ia(),console.log("[Archive] Step 3 complete: Working data cleared"),console.log("[Archive] Step 4: Clearing non-permanent notes..."),await $a(),console.log("[Archive] Step 4 complete: Notes cleared"),console.log("[Archive] Step 5: Resetting config values..."),await Na(),console.log("[Archive] Step 5 complete: Config reset"),console.log("[Archive] Archive workflow complete!"),await zn(),le(),window.alert(`Archive Complete!
