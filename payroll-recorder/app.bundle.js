...
`.trim();function We(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Mt(e,t){return`
    ...
    `}function jo(e){let t=Se(1),n=t?Re(t.note):!1,o=t?P(t.note):"",a=(t?P(t.reviewer):"")||De(),s=t?ye(P(t.signOff)):"",l=!!(s||P(de[1])),c=qt();return`
    ...
    `}function Ho(e){var $,V,x,T,g,I,L,Q,pe,K;let t=Se(2),n=t?P(t.note):"",o=t?Re(t.note):!1,a=(t?P(t.reviewer):"")||De(),s=t?ye(P(t.signOff)):"",l=!!(s||P(de[2])),c=Rt(),r=H.roster||{},i=H.departments||{},p=H.hasAnalyzed,f="";H.loading?f='<p class="pf-step-note">Analyzing roster and payroll data\u2026</p>':H.lastError&&(f=`<p class="pf-step-note">${S(H.lastError)}</p>`);let u=(M,Y,ne)=>{let xe=!p,X;xe?X='<span class="pf-je-check-circle pf-je-circle--pending"></span>':ne?X=`<span class="pf-je-check-circle pf-je-circle--pass">
        ...
        `},d=($=r.difference)!=null?$:0,m=(V=i.difference)!=null?V:0,y=Array.isArray(r.mismatches)?r.mismatches.filter(Boolean):[],w=Array.isArray(i.mismatches)?i.mismatches.filter(Boolean):[],h=`
        ${u("SS_Employee_Roster count",(x=r.rosterCount)!=null?x:"\u2014",!0)}
        ${u("PR_Data employee count",(T=r.payrollCount)!=null?T:"\u2014",!0)}
        ${u("Difference",d,d===0)}
    `,E=`
        ${u("Expected departments",(g=i.rosterCount)!=null?g:"\u2014",!0)}
        ${u("PR_Data departments",(I=i.payrollCount)!=null?I:"\u2014",!0)}
        ${u("Difference",m,m===0)}
    `,k=y.length&&!H.skipAnalysis&&p&&((Q=(L=window.PrairieForge)==null?void 0:L.renderMismatchTiles)==null?void 0:Q.call(L,{mismatches:y,label:"Employees Driving the Difference",sourceLabel:"Roster",targetLabel:"Payroll Data",escapeHtml:S}))||"",_=w.length&&!H.skipAnalysis&&p&&((K=(pe=window.PrairieForge)==null?void 0:pe.renderMismatchTiles)==null?void 0:K.call(pe,{mismatches:w,label:"Employees with Department Differences",formatter:M=>({name:M.employee||M.name||"",source:`${M.rosterDept||"\u2014"} \u2192 ${M.payrollDept||"\u2014"}`,isMissingFromTarget:!0}),escapeHtml:S}))||"";return`
        <section class="pf-hero" id="pf-step-hero">
            <p class="pf-hero-copy">${S(Pe)} | Step ${e.id}</p>
    ...
    `}function zo(e){var $,V,x;let t=Se(5),n=t?P(t.note):"",o=t?Re(t.note):!1,a=(t?P(t.reviewer):"")||De(),s=t?ye(P(t.signOff)):"",l=!!(s||P(de[5])),c=G.lastError?`<p class="pf-step-note">${S(G.lastError)}</p>`:"",r=G.debitTotal!==null,i=($=G.debitTotal)!=null?$:0,p=(V=G.creditTotal)!=null?V:0,f=i-p,u=(x=F.cleanTotal)!=null?x:0,d=r,m=r&&Math.abs(f-u)<.01,y=(T,g)=>{let I=!r,L;return I?L='<span class="pf-je-check-circle pf-je-circle--pending"></span>':g?L=`<span class="pf-je-check-circle pf-je-circle--pass">
        ...
        ${y(`Total Debits = ${w}`,d)}
        ${y(`Total Credits = ${h}`,d)}
        ${y(`Line Amount (Debit - Credit) = ${E}`,d)}
    ...
    `}function Jo(e){let t=rt.find(_=>_.id===e)||{id:e!=null?e:"-",title:"Workflow Step",summary:"",description:"",checklist:[]};if(e===1)return jo(t);if(e===2)return Ho(t);if(e===3)return Uo(t);if(e===4)return Go(t);if(e===5)return zo(t);if(e===6)return Wo(t);let n=!1,o=Se(e),a=o?P(o.note):"",s=o?Re(o.note):!1,l=(o?P(o.reviewer):"")||De(),c=o?ye(P(o.signOff)):"",r=o&&de[e]?!!(c||P(de[e])):!!c,i=(t.highlights||[]).map(_=>`
        ...
        `).join(""),p=(t.checklist||[]).map(_=>`<li>${S(_)}</li>`).join("")||"",f=n?"":t.description||"Detailed guidance will appear here.",u=[];!n&&t.ctaLabel&&u.push(`<button type="button" class="pf-pill-btn" id="step-action-btn">${S(t.ctaLabel)}</button>`),n||u.push('<button type="button" class="pf-pill-btn pf-pill-btn--ghost" id="step-back-btn">Back to Step List</button>');let d=u.length?`<div class="pf-pill-row pf-config-actions">${u.join("")}</div>`:"",m=qt(),y=n?`
