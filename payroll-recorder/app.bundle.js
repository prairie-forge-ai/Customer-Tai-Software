...
- Missing or incomplete mappings`},It=[];function rn(e={}){var o;let t={...sn,...e},n=((o=t.quickActions)==null?void 0:o.map(a=>`<button type="button" class="pf-ada-chip" data-action="${a.id}" data-prompt="${ko(a.prompt)}">${a.label}</button>`).join(""))||"";return`
        <article class="pf-ada" data-copilot="${t.id}">
            <header class="pf-ada-header">
                <div class="pf-ada-identity">
                    <img class="pf-ada-avatar" src="${Co}" alt="Ada" onerror="this.style.display='none'" />
    ...
    `}function ko(e){return String(e||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function ln(e,t={}){let n={...sn,...t},o=e.querySelector(`[data-copilot="${n.id}"]`);if(!o)return;let a=o.querySelector(`#${n.id}-messages`),s=o.querySelector(`#${n.id}-prompt`),l=o.querySelector(`#${n.id}-ask`),c=o.querySelector(`#${n.id}-status-dot`),r=o.querySelector(`#${n.id}-status-badge`),i=!1,p=(w,h="ready")=>{c&&(c.classList.remove("pf-ada-status-dot--busy","pf-ada-status-dot--offline"),h==="busy"&&c.classList.add("pf-ada-status-dot--busy"),h==="offline"&&c.classList.add("pf-ada-status-dot--offline")),r&&(r.title=w)},f=(w,h="assistant")=>{if(!a)return;let E=h==="user"?"pf-ada-bubble--user":h==="system"?"pf-ada-bubble--system":"pf-ada-bubble--ai",k=document.createElement("div");k.className=`pf-ada-bubble ${E}`,k.innerHTML=`<p>${g(w)}</p>`,a.appendChild(k),a.scrollTop=a.scrollHeight,It.push({role:h,content:w,timestamp:new Date().toISOString()})},u=()=>{if(!a)return;let w=document.createElement("div");w.className="pf-ada-bubble pf-ada-bubble--ai pf-ada-bubble--loading",w.id=`${n.id}-loading`,w.innerHTML=`
            <div class="pf-ada-typing">
                <span></span><span></span><span></span>
            </div>
        `,a.appendChild(w),a.scrollTop=a.scrollHeight},d=()=>{let w=document.getElementById(`${n.id}-loading`);w&&w.remove()},g=w=>String(w).replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\n\n/g,"</p><p>").replace(/\n- /g,"<br>\u2022 ").replace(/\n/g,"<br>"),v=async w=>{let h=w||(s==null?void 0:s.value.trim());if(!(!h||i)){i=!0,s&&(s.value=""),l&&(l.disabled=!0),f(h,"user"),u(),p("Analyzing...","busy");try{let E=null;if(typeof n.contextProvider=="function")try{E=await n.contextProvider()}catch(_){console.warn("CoPilot: Context provider failed",_)}let k;typeof n.onPrompt=="function"?k=await n.onPrompt(h,E,It):typeof n.apiEndpoint=="string"?k=await Ro(n.apiEndpoint,h,E,n.systemPrompt):k=So(h,E),d(),f(k,"assistant"),p("Ready to assist","ready")}catch(E){console.error("CoPilot error:",E),d(),f(`I encountered an issue: ${E.message}. Please try again.`,"system"),p("Error occurred","offline")}i=!1,l&&(l.disabled=!1),s==null||s.focus()}};l==null||l.addEventListener("click",()=>v()),s==null||s.addEventListener("keydown",w=>{w.key==="Enter"&&!w.shiftKey&&(w.preventDefault(),v())}),o.querySelectorAll(".pf-ada-chip").forEach(w=>{w.addEventListener("click",()=>{let h=w.dataset.prompt;h&&v(h)})})}async function Ro(e,t,n,o){let a=await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({prompt:t,context:n,systemPrompt:o,history:It.slice(-10)})});if(!a.ok)throw new Error(`API request failed: ${a.status}`);let s=await a.json();return s.message||s.response||"No response received."}function So(e,t){var o,a,s;let n=e.toLowerCase();return n.includes("diagnostic")||n.includes("check")?`Great question! Let me run through the diagnostics for you.
...
I'm reading your actual spreadsheet data, so I can give you specific answers!`}var un=lt.ADA_IMAGE_URL;async function Nt(e,t,n){if(typeof Excel=="undefined"){console.warn("Excel runtime not available for homepage sheet");return}try{await Excel.run(async o=>{let a=o.workbook.worksheets.getItemOrNullObject(e);a.load("isNullObject, name"),await o.sync();let s;a.isNullObject?(s=o.workbook.worksheets.add(e),await o.sync(),await cn(o,s,t,n)):(s=a,await cn(o,s,t,n)),s.activate(),s.getRange("A1").select(),await o.sync()})}catch(o){console.error(`Error activating homepage sheet ${e}:`,o)}}async function cn(e,t,n,o){try{let i=t.getUsedRangeOrNullObject();i.load("isNullObject"),await e.sync(),i.isNullObject||(i.clear(),await e.sync())}catch{}t.showGridlines=!1,t.getRange("A:A").format.columnWidth=400,t.getRange("B:B").format.columnWidth=50,t.getRange("1:1").format.rowHeight=60,t.getRange("2:2").format.rowHeight=30;let a=[[n,""],[o,""],["",""],["",""]],s=t.getRangeByIndexes(0,0,4,2);s.values=a;let l=t.getRange("A1:Z100");l.format.fill.color="#0f0f0f";let c=t.getRange("A1");c.format.font.bold=!0,c.format.font.size=36,c.format.font.color="#ffffff",c.format.font.name="Segoe UI Light",c.format.verticalAlignment="Center";let r=t.getRange("A2");r.format.font.size=14,r.format.font.color="#a0a0a0",r.format.font.name="Segoe UI",r.format.verticalAlignment="Top",t.freezePanes.freezeRows(0),t.freezePanes.freezeColumns(0),await e.sync()}var dn={"module-selector":{sheetName:"SS_Homepage",title:"ForgeSuite",subtitle:"Select a module from the side panel to get started."},"payroll-recorder":{sheetName:"PR_Homepage",title:"Payroll Recorder",subtitle:"Normalize payroll exports, enforce controls, and prep journal entries without leaving Excel."},"pto-accrual":{sheetName:"PTO_Homepage",title:"PTO Accrual",subtitle:"Calculate employee PTO liabilities, compare period-over-period changes, and prepare accrual journal entries."}};function Ot(e){return dn[e]||dn["module-selector"]}function pn(){Tt();let e=document.createElement("button");return e.className="pf-ada-fab",e.id="pf-ada-fab",e.setAttribute("aria-label","Ask Ada"),e.setAttribute("title","Ask Ada"),e.innerHTML=`
        ...
        />
    `,document.body.appendChild(e),e.addEventListener("click",xo),e}function Tt(){let e=document.getElementById("pf-ada-fab");e&&e.remove();let t=document.getElementById("pf-ada-modal-overlay");t&&t.remove()}function xo(){let e=document.getElementById("pf-ada-modal-overlay");e&&e.remove();let t=document.createElement("div");t.className="pf-ada-modal-overlay",t.id="pf-ada-modal-overlay",t.innerHTML=`
...
`.trim(),_o={config:`
    ...
    `};function vn(e){return e&&_o[e]||""}var Lt=`
    <svg
...
`.trim();function We(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Mt(e,t){return`
    ...
    `}function _e({textareaId:e,value:t,permanentId:n,isPermanent:o,hintId:a,saveButtonId:s,isSaved:l=!1,placeholder:c="Enter notes here..."}){let r=o?Bt:Lt,i=s?`<button type="button" class="pf-action-toggle pf-save-btn ${l?"is-saved":""}" id="${s}" data-save-input="${e}" title="Save notes">${Cn}</button>`:"",p=n?`<button type="button" class="pf-action-toggle pf-notes-lock ${o?"is-locked":""}" id="${n}" aria-pressed="${o}" title="Lock notes (retain after archive)">${r}</button>`:"";return`
    ...
    `,document.body.appendChild(n),requestAnimationFrame(()=>{n.classList.add("pf-workflow-toast--visible")}),setTimeout(()=>{n.classList.remove("pf-workflow-toast--visible"),setTimeout(()=>n.remove(),300)},4e3)}var Ft={fillColor:"#000000",fontColor:"#FFFFFF",bold:!0},jt={currency:"$#,##0.00",currencyWithNegative:"$#,##0.00;($#,##0.00)",number:"#,##0.00",integer:"#,##0",percent:"0.00%",date:"yyyy-mm-dd",dateTime:"yyyy-mm-dd hh:mm"};function _n(e){e.format.fill.color=Ft.fillColor,e.format.font.color=Ft.fontColor,e.format.font.bold=Ft.bold}function ft(e,t,n,o=!1){if(n<=0)return;let a=e.getRangeByIndexes(1,t,n,1);a.numberFormat=[[o?jt.currencyWithNegative:jt.currency]]}function An(e,t,n,o=jt.date){if(n<=0)return;let a=e.getRangeByIndexes(1,t,n,1);a.numberFormat=[[o]]}var Et="payroll-recorder";var Pe="Payroll Recorder",Ss=A.CONFIG||"SS_PF_Config",Ht=["SS_PF_Config"];var Ao="Normalize payroll exports, enforce controls, and prep journal entries without leaving Excel. Every run follows the same guidance so you stay audit-ready.",be=rt.map(({id:e,title:t})=>({id:e,title:t})),B={TYPE:0,FIELD:1,VALUE:2,PERMANENT:3,TITLE:-1},Do="Run Settings";var Dn="N";var Po="PR_JE_Debit_Total",Io="PR_JE_Credit_Total",$o="PR_JE_Difference",$e={0:{note:"PR_Notes_Config",reviewer:"PR_Reviewer_Config",signOff:"PR_SignOff_Config"},1:{note:"PR_Notes_Import",reviewer:"PR_Reviewer_Import",signOff:"PR_SignOff_Import"},2:{note:"PR_Notes_Headcount",reviewer:"PR_Reviewer_Headcount",signOff:"PR_SignOff_Headcount"},3:{note:"PR_Notes_Validate",reviewer:"PR_Reviewer_Validate",signOff:"PR_SignOff_Validate"},4:{note:"PR_Notes_Review",reviewer:"PR_Reviewer_Review",signOff:"PR_SignOff_Review"},5:{note:"PR_Notes_JE",reviewer:"PR_Reviewer_JE",signOff:"PR_SignOff_JE"},6:{note:"PR_Notes_Archive",reviewer:"PR_Reviewer_Archive",signOff:"PR_SignOff_Archive"}},de={0:"PR_Complete_Config",1:"PR_Complete_Import",2:"PR_Complete_Headcount",3:"PR_Complete_Validate",4:"PR_Complete_Review",5:"PR_Complete_JE",6:"PR_Complete_Archive"},No={1:A.DATA,2:A.DATA_CLEAN,3:A.DATA_CLEAN,4:A.EXPENSE_REVIEW,5:A.JE_DRAFT},qe="PR_Reviewer",jn="PR_Payroll_Provider",mt="User opted to skip the headcount review this period.",te={statusText:"",focusedIndex:0,activeView:"home",activeStepId:null,stepStatuses:be.reduce((e,t)=>({...e,[t.id]:"pending"}),{})},W={loaded:!1,values:{},permanents:{},overrides:{accountingPeriod:!1,jeId:!1}},Le=new Map,gt=null,Xe=["PR_Payroll_Date","Payroll Date (YYYY-MM-DD)","Payroll_Date","Payroll Date","Payroll_Date_(YYYY-MM-DD)"],H={skipAnalysis:!1,roster:{rosterCount:null,payrollCount:null,difference:null,mismatches:[]},departments:{rosterCount:null,payrollCount:null,difference:null,mismatches:[]},loading:!1,hasAnalyzed:!1,lastError:null},bt=null,F={loading:!1,lastError:null,prDataTotal:null,cleanTotal:null,reconDifference:null,bankAmount:"",bankDifference:null,plugEnabled:!1},ke={loading:!1,lastError:null,periods:[],copilotResponse:"",completenessCheck:{currentPeriod:null,historicalPeriods:null}},G={debitTotal:null,creditTotal:null,difference:null,loading:!1,lastError:null};async function Oo(){if(console.log("Completeness Check - Starting..."),!ae()){console.log("Completeness Check - Excel runtime not available");return}try{await Excel.run(async e=>{var a,s,l,c;let t=e.workbook.worksheets.getItemOrNullObject(A.DATA_CLEAN),n=e.workbook.worksheets.getItemOrNullObject(A.ARCHIVE_SUMMARY);t.load("isNullObject"),n.load("isNullObject"),await e.sync();let o={currentPeriod:null,historicalPeriods:null};if(!t.isNullObject){let r=t.getUsedRangeOrNullObject();if(r.load("values"),await e.sync(),!r.isNullObject&&r.values&&r.values.length>1){let i=(r.values[0]||[]).map(u=>String(u||"").toLowerCase().trim()),p=i.findIndex(u=>u.includes("amount")),f=p>=0?p:i.findIndex(u=>u==="total"||u==="all-in"||u==="allin"||u==="all-in total"||u==="gross"||u==="total pay");if(console.log("Completeness Check - PR_Data_Clean headers:",i),console.log("Completeness Check - Amount column index:",p,"Total column index:",f),f>=0){let d=r.values.slice(1).reduce((w,h)=>w+(Number(h[f])||0),0),g=((l=(s=(a=ke.periods)==null?void 0:a[0])==null?void 0:s.summary)==null?void 0:l.total)||0;console.log("Completeness Check - PR_Data_Clean sum:",d,"Current period total:",g);let v=Math.abs(d-g)<1;o.currentPeriod={match:v,prDataClean:d,currentTotal:g}}else console.warn("Completeness Check - No amount/total column found in PR_Data_Clean")}}if(!n.isNullObject){let r=n.getUsedRangeOrNullObject();if(r.load("values"),await e.sync(),!r.isNullObject&&r.values&&r.values.length>1){let i=(r.values[0]||[]).map(d=>String(d||"").toLowerCase().trim()),p=i.findIndex(d=>d.includes("pay period")||d.includes("payroll date")||d==="date"||d==="period"||d.includes("period")),f=i.findIndex(d=>d.includes("amount")),u=f>=0?f:i.findIndex(d=>d==="total"||d==="all-in"||d==="allin"||d==="all-in total"||d==="total payroll"||d.includes("total"));if(console.log("Completeness Check - PR_Archive_Summary headers:",i),console.log("Completeness Check - Date column index:",p,"Total column index:",u),u>=0&&p>=0){let d=r.values.slice(1),g=(ke.periods||[]).slice(1,6);console.log("Completeness Check - Looking for periods:",g.map(x=>x.key||x.label));let v=new Map;for(let x of d){let T=x[p],m=$n(T);m&&v.set(m,Number(x[u])||0)}console.log("Completeness Check - Archive lookup keys:",Array.from(v.keys()));let w=0,h=0,E=0,k=[];for(let x of g){let T=x.key||x.label||"",m=$n(T),I=((c=x.summary)==null?void 0:c.total)||0;h+=I;let L=v.get(m);L!==void 0?(w+=L,E++,k.push({period:T,calculated:I,archive:L,match:Math.abs(I-L)<1})):(console.warn(`Completeness Check - Period ${T} (normalized: ${m}) not found in archive`),k.push({period:T,calculated:I,archive:null,match:!1}))}console.log("Completeness Check - Period details:",k),console.log("Completeness Check - Matched",E,"of",g.length,"periods"),console.log("Completeness Check - Archive sum:",w,"Periods sum:",h);let _=E===g.length&&g.length>0,$=Math.abs(w-h)<1,V=_&&$;o.historicalPeriods={match:V,archiveSum:w,periodsSum:h,matchedCount:E,totalPeriods:g.length,details:k}}else console.warn("Completeness Check - Missing date or total column in PR_Archive_Summary"),console.warn("  Date column index:",p,"Total column index:",u)}}ke.completenessCheck=o,console.log("Completeness Check - Results:",JSON.stringify(o))}),console.log("Completeness Check - Complete!")}catch(e){console.error("Payroll completeness check failed:",e)}}function To(){var v,w;let e=ke.completenessCheck||{},t=((v=ke.periods)==null?void 0:v.length)>0,n=h=>`$${Math.round(h||0).toLocaleString()}`,o=h=>{let E=Math.abs(h);return E<1?"\u2014":`${h>0?"+":"-"}$${Math.round(E).toLocaleString()}`},a=(h,E,k,_,$,V,x)=>{let T=(k||0)-($||0),m,I;x?(m='<span class="pf-complete-status pf-complete-status--pending">\u23F3</span>',I="pending"):V?(m='<span class="pf-complete-status pf-complete-status--pass">\u2713</span>',I="pass"):(m='<span class="pf-complete-status pf-complete-status--fail">\u2717</span>',I="fail");let L=x?"":`
        ...
        `},s=e.currentPeriod,l=!t||s===null||s===void 0,c=a("Current Period","PR_Data_Clean Total",s==null?void 0:s.prDataClean,"Calculated Total",s==null?void 0:s.currentTotal,s==null?void 0:s.match,l),r=e.historicalPeriods,i=!t||r===null||r===void 0,p=(r==null?void 0:r.matchedCount)||0,f=(r==null?void 0:r.totalPeriods)||0,u=f>0?`Historical Periods (${p}/${f} matched)`:"Historical Periods",d=a(u,"PR_Archive_Summary (matched)",r==null?void 0:r.archiveSum,"Calculated Total",r==null?void 0:r.periodsSum,r==null?void 0:r.match,i),g="";return!i&&((w=r==null?void 0:r.details)==null?void 0:w.length)>0&&(g=`
    ...
    `}function Lo(e){switch(e){case 0:return{title:"Configuration",content:`
                ...
                `}}}on(()=>Bo());async function Bo(){try{await Mo(),await zn();let e=Ot(Et);await Nt(e.sheetName,e.title,e.subtitle),le()}catch(e){throw console.error("[Payroll] Module initialization failed:",e),e}}async function Mo(){try{await Pt(Et),console.log(`[Payroll] Tab visibility applied for ${Et}`)}catch(e){console.warn("[Payroll] Could not apply tab visibility:",e)}}function le(){var r;let e=document.body;if(!e)return;let t=te.focusedIndex<=0?"disabled":"",n=te.focusedIndex>=be.length-1?"disabled":"",o=te.activeView==="config",a=te.activeView==="step",s=!o&&!a,l=o?jo():a?Yo(te.activeStepId):Fo();e.innerHTML=`
        <div class="pf-root">
            ${Vo(t,n)}
            ${l}
            ${Ko()}
        </div>
    `;let c=document.getElementById("pf-info-fab-payroll");if(s)c&&c.remove();else if((r=window.PrairieForge)!=null&&r.mountInfoFab){let i=Lo(te.activeStepId);PrairieForge.mountInfoFab({title:i.title,content:i.content,buttonId:"pf-info-fab-payroll"})}if(Qo(),o)na();else if(a)try{oa(te.activeStepId)}catch(i){console.warn("Payroll Recorder: failed to bind step interactions",i)}else ta();aa(),s?pn():Tt()}function Vo(e,t){let n=P("SS_Company_Name")||"your company";return`
    ...
    `}function Fo(){return`
        <section class="pf-hero" id="pf-hero">
            ...
            <p class="pf-hero-copy">${Ao}</p>
            <p class="pf-hero-hint">${S(te.statusText||"")}</p>
        </section>
        <section class="pf-step-guide">
            <div class="pf-step-grid">
                ${be.map((e,t)=>qo(e,t)).join("")}
            </div>
        </section>
    `}function jo(){if(!W.loaded)return`
            <section class="pf-step-guide">
                <article class="pf-step-card pf-step-detail">
                    <p class="pf-step-title">Loading configuration\u2026</p>
                </article>
            </section>
        `;let e=$e[0],t=ye(Ct()),n=ye(P("PR_Accounting_Period")),o=P("PR_Journal_Entry_ID"),a=P("SS_Accounting_Software"),s=qt(),l=P("SS_Company_Name"),c=P(qe)||De(),r=e?P(e.note):"",i=e?Re(e.note):!1,p=(e?P(e.reviewer):"")||De(),f=e?ye(P(e.signOff)):"",u=!!(f||P(de[0]));return`
        ...
        <section class="pf-step-guide">
            ...
            ${e?Ae({reviewerInputId:"config-reviewer-name",reviewerValue:p,signoffInputId:"config-signoff-date",signoffValue:f,isComplete:u,saveButtonId:"config-signoff-save",completeButtonId:"config-signoff-toggle"}):""}
        </section>
    `}function Ho(e){let t=Se(1),n=t?Re(t.note):!1,o=t?P(t.note):"",a=(t?P(t.reviewer):"")||De(),s=t?ye(P(t.signOff)):"",l=!!(s||P(de[1])),c=qt();return`
    ...
    `}function Uo(e){var $,V,x,T,m,I,L,Q,pe,K;let t=Se(2),n=t?P(t.note):"",o=t?Re(t.note):!1,a=(t?P(t.reviewer):"")||De(),s=t?ye(P(t.signOff)):"",l=!!(s||P(de[2])),c=Rt(),r=H.roster||{},i=H.departments||{},p=H.hasAnalyzed,f="";H.loading?f='<p class="pf-step-note">Analyzing roster and payroll data\u2026</p>':H.lastError&&(f=`<p class="pf-step-note">${S(H.lastError)}</p>`);let u=(M,Y,ne)=>{let xe=!p,X;xe?X='<span class="pf-je-check-circle pf-je-circle--pending"></span>':ne?X=`<span class="pf-je-check-circle pf-je-circle--pass">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg>
            </span>`:X=`<span class="pf-je-check-circle pf-je-circle--fail">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
            </span>`;let Z=p?` = ${Y}`:"";return`
            <div class="pf-je-check-row">
                ${X}
                <span class="pf-je-check-desc-pill">${S(M)}${Z}</span>
            </div>
        `},d=($=r.difference)!=null?$:0,g=(V=i.difference)!=null?V:0,v=Array.isArray(r.mismatches)?r.mismatches.filter(Boolean):[],w=Array.isArray(i.mismatches)?i.mismatches.filter(Boolean):[],h=`
        ${u("SS_Employee_Roster count",(x=r.rosterCount)!=null?x:"\u2014",!0)}
        ${u("PR_Data employee count",(T=r.payrollCount)!=null?T:"\u2014",!0)}
        ${u("Difference",d,d===0)}
    `,E=`
        ${u("Expected departments",(m=i.rosterCount)!=null?m:"\u2014",!0)}
        ${u("PR_Data departments",(I=i.payrollCount)!=null?I:"\u2014",!0)}
        ${u("Difference",g,g===0)}
    `,k=v.length&&!H.skipAnalysis&&p&&((Q=(L=window.PrairieForge)==null?void 0:L.renderMismatchTiles)==null?void 0:Q.call(L,{mismatches:v,label:"Employees Driving the Difference",sourceLabel:"Roster",targetLabel:"Payroll Data",escapeHtml:S}))||"",_=w.length&&!H.skipAnalysis&&p&&((K=(pe=window.PrairieForge)==null?void 0:pe.renderMismatchTiles)==null?void 0:K.call(pe,{mismatches:w,label:"Employees with Department Differences",formatter:M=>({name:M.employee||M.name||"",source:`${M.rosterDept||"\u2014"} \u2192 ${M.payrollDept||"\u2014"}`,isMissingFromTarget:!0}),escapeHtml:S}))||"";return`
        <section class="pf-hero" id="pf-step-hero">
            <p class="pf-hero-copy">${S(Pe)} | Step ${e.id}</p>
    ...
    `}function Go(e){var $;let t=Se(3),n=t?P(t.note):"",o=(t?P(t.reviewer):"")||De(),a=t?ye(P(t.signOff)):"",s=F.loading?'<p class="pf-step-note">Preparing reconciliation data\u2026</p>':F.lastError?`<p class="pf-step-note">${S(F.lastError)}</p>`:"",l=!!(a||P(de[3])),c=F.prDataTotal!==null,r=F.prDataTotal,i=F.cleanTotal,p=($=F.reconDifference)!=null?$:r!=null&&i!=null?r-i:null,f=p!==null&&Math.abs(p)<.01,u=ie(F.cleanTotal),d=F.bankDifference!=null?ie(F.bankDifference):"---",g=F.bankDifference==null?"":Math.abs(F.bankDifference)<.5?"Difference within acceptable tolerance.":"Difference exceeds tolerance and should be resolved.",v=Kn(F.bankAmount),w=(V,x,T)=>{let m=!c,I;return m?I='<span class="pf-je-check-circle pf-je-circle--pending"></span>':T?I=`<span class="pf-je-check-circle pf-je-circle--pass">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg>
    ...
    `;return`
        ...
        <section class="pf-step-guide">
            ...
            <article class="pf-step-card pf-step-detail pf-config-card">
                ...
                <p class="pf-metric-hint" id="bank-diff-hint">${S(g)}</p>
            </article>
            ${t?`
    ...
    `}function zo(e){let t=Se(4),n=t?P(t.note):"",o=(t?P(t.reviewer):"")||De(),a=t?ye(P(t.signOff)):"",s=!!(a||P(de[4])),l=ke.loading?'<p class="pf-step-note">Preparing executive summary\u2026</p>':ke.lastError?`<p class="pf-step-note">${S(ke.lastError)}</p>`:"",c=rn({id:"expense-review-copilot",body:"Want help analyzing your data? Just ask!",placeholder:"Where should I focus this pay period?",buttonLabel:"Ask CoPilot"});return`
        <section class="pf-hero" id="pf-step-hero">
            <p class="pf-hero-copy">${S(Pe)} | Step ${e.id}</p>
            <h2 class="pf-hero-title">${S(e.title)}</h2>
    ...
    `}function Wo(e){var $,V,x;let t=Se(5),n=t?P(t.note):"",o=t?Re(t.note):!1,a=(t?P(t.reviewer):"")||De(),s=t?ye(P(t.signOff)):"",l=!!(s||P(de[5])),c=G.lastError?`<p class="pf-step-note">${S(G.lastError)}</p>`:"",r=G.debitTotal!==null,i=($=G.debitTotal)!=null?$:0,p=(V=G.creditTotal)!=null?V:0,f=i-p,u=(x=F.cleanTotal)!=null?x:0,d=r,g=r&&Math.abs(f-u)<.01,v=(T,m)=>{let I=!r,L;return I?L='<span class="pf-je-check-circle pf-je-circle--pending"></span>':m?L=`<span class="pf-je-check-circle pf-je-circle--pass">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg>
        ...
        `},w=r?ie(i):"\u2014",h=r?ie(p):"\u2014",E=r?ie(f):"\u2014",k=r?ie(u):"\u2014",_=`
        ${v(`Total Debits = ${w}`,d)}
        ${v(`Total Credits = ${h}`,d)}
        ${v(`Line Amount (Debit - Credit) = ${E}`,d)}
        ${v(`JE Total matches PR_Data_Clean (${k})`,g)}
    `;return`
        <section class="pf-hero" id="pf-step-hero">
            <p class="pf-hero-copy">${S(Pe)} | Step ${e.id}</p>
            <h2 class="pf-hero-title">${S(e.title)}</h2>
    ...
    `}function Jo(e){let t=be.filter(a=>a.id!==6).map(a=>({id:a.id,title:a.title,complete:la(a.id)})),n=t.every(a=>a.complete),o=t.map(a=>`
            <article class="pf-step-card pf-step-detail pf-config-card">
                <div class="pf-config-head pf-notes-header">
    ...
    `}function Yo(e){let t=rt.find(_=>_.id===e)||{id:e!=null?e:"-",title:"Workflow Step",summary:"",description:"",checklist:[]};if(e===1)return Ho(t);if(e===2)return Uo(t);if(e===3)return Go(t);if(e===4)return zo(t);if(e===5)return Wo(t);if(e===6)return Jo(t);let n=!1,o=Se(e),a=o?P(o.note):"",s=o?Re(o.note):!1,l=(o?P(o.reviewer):"")||De(),c=o?ye(P(o.signOff)):"",r=o&&de[e]?!!(c||P(de[e])):!!c,i=(t.highlights||[]).map(_=>`
        ...
        `).join(""),p=(t.checklist||[]).map(_=>`<li>${S(_)}</li>`).join("")||"",f=n?"":t.description||"Detailed guidance will appear here.",u=[];!n&&t.ctaLabel&&u.push(`<button type="button" class="pf-pill-btn" id="step-action-btn">${S(t.ctaLabel)}</button>`),n||u.push('<button type="button" class="pf-pill-btn pf-pill-btn--ghost" id="step-back-btn">Back to Step List</button>');let d=u.length?`<div class="pf-pill-row pf-config-actions">${u.join("")}</div>`:"",g=qt(),v=n?`
            <div class="pf-link-card">
                ...
                <div class="pf-link-list">
                    <a
                        class="pf-link-item"
                        id="pr-provider-link"
                        ${g?`href="${S(g)}" target="_blank" rel="noopener noreferrer"`:'aria-disabled="true"'}
                    >
                        ...
                        <span class="pf-link-item__body">
                            ...
                            <span class="pf-link-item__meta">${S(g||"Add a provider link in Configuration")}</span>
                        </span>
                    </a>
                </div>
            </div>
        `:"",w="",h=!n&&i?`<article class="pf-step-card pf-step-detail">${i}</article>`:"",E=!n&&p?`<article class="pf-step-card pf-step-detail">
                            <h3 class="pf-step-subtitle">Checklist</h3>
                            <ul class="pf-step-checklist">${p}</ul>
                        </article>`:"",k=!n||f||d?`
            <article class="pf-step-card pf-step-detail">
    ...
    `}function qo(e,t){let n=te.focusedIndex===t?"pf-step-card--active":"",o=vn(Xo(e.id));return`
    ...
    `}function Xo(e){return e===0?"config":e===1?"import":e===2?"headcount":e===3?"validate":e===4?"review":e===5?"journal":e===6?"archive":""}function Qo(){var n,o,a,s,l,c,r,i;(n=document.getElementById("nav-home"))==null||n.addEventListener("click",()=>{var p;Hn(),(p=document.getElementById("pf-hero"))==null||p.scrollIntoView({behavior:"smooth",block:"start"})}),(o=document.getElementById("nav-selector"))==null||o.addEventListener("click",()=>{window.location.href="../module-selector/index.html"}),(a=document.getElementById("nav-prev"))==null||a.addEventListener("click",()=>In(-1)),(s=document.getElementById("nav-next"))==null||s.addEventListener("click",()=>In(1));let e=document.getElementById("nav-quick-toggle"),t=document.getElementById("quick-access-dropdown");e==null||e.addEventListener("click",p=>{p.stopPropagation(),t==null||t.classList.toggle("hidden"),e.classList.toggle("is-active")}),document.addEventListener("click",p=>{!(t!=null&&t.contains(p.target))&&!(e!=null&&e.contains(p.target))&&(t==null||t.classList.add("hidden"),e==null||e.classList.remove("is-active"))}),(l=document.getElementById("nav-roster"))==null||l.addEventListener("click",()=>{Pn("SS_Employee_Roster"),t==null||t.classList.add("hidden"),e==null||e.classList.remove("is-active")}),(c=document.getElementById("nav-accounts"))==null||c.addEventListener("click",()=>{Pn("SS_Chart_of_Accounts"),t==null||t.classList.add("hidden"),e==null||e.classList.remove("is-active")}),(r=document.getElementById("nav-expense-map"))==null||r.addEventListener("click",async()=>{t==null||t.classList.add("hidden"),e==null||e.classList.remove("is-active"),await ea()}),(i=document.getElementById("showConfigSheets"))==null||i.addEventListener("click",async()=>{await Zo()})}async function Zo(){if(typeof Excel=="undefined"){console.log("Excel not available");return}try{await Excel.run(async e=>{let t=e.workbook.worksheets;t.load("items/name,visibility"),await e.sync();let n=0;t.items.forEach(a=>{a.name.toUpperCase().startsWith("SS_")&&(a.visibility=Excel.SheetVisibility.visible,console.log(`[Config] Made visible: ${a.name}`),n++)}),await e.sync();let o=e.workbook.worksheets.getItemOrNullObject("SS_PF_Config");o.load("isNullObject"),await e.sync(),o.isNullObject||(o.activate(),o.getRange("A1").select(),await e.sync()),console.log(`[Config] ${n} system sheets now visible`)})}catch(e){console.error("[Config] Error unhiding system sheets:",e)}}async function Pn(e){if(!e||typeof Excel=="undefined")return;let t={SS_Employee_Roster:["Employee","Department","Pay_Rate","Status","Hire_Date"],SS_Chart_of_Accounts:["Account_Number","Account_Name","Type","Category"]};try{await Excel.run(async n=>{let o=n.workbook.worksheets.getItemOrNullObject(e);if(o.load("isNullObject"),await n.sync(),o.isNullObject){o=n.workbook.worksheets.add(e);let a=t[e]||["Column1","Column2"],s=o.getRange(`A1:${String.fromCharCode(64+a.length)}1`);s.values=[a],s.format.font.bold=!0,s.format.fill.color="#f0f0f0",s.format.autofitColumns(),await n.sync()}o.activate(),o.getRange("A1").select(),await n.sync()})}catch(n){console.error("Error opening reference sheet:",n)}}async function ea(){try{await Excel.run(async e=>{let t=e.workbook.worksheets.getItemOrNullObject("PR_Expense_Mapping");if(t.load("isNullObject"),await e.sync(),t.isNullObject){t=e.workbook.worksheets.add("PR_Expense_Mapping");let n=["Expense_Category","GL_Account","Description","Active"],o=t.getRange("A1:D1");o.values=[n],o.format.font.bold=!0}t.activate(),t.getRange("A1").select(),await e.sync()})}catch(e){console.error("Error navigating to PR_Expense_Mapping:",e)}}function ta(){document.querySelectorAll("[data-step-card]").forEach(e=>{let t=Number(e.getAttribute("data-step-index"));e.addEventListener("click",()=>Qe(t))})}function na(){var r,i,p,f;let e=document.getElementById("config-user-name");e==null||e.addEventListener("change",u=>{let d=u.target.value.trim();U(qe,d);let g=document.getElementById("config-reviewer-name");g&&!g.value&&(g.value=d)});let t=document.getElementById("config-payroll-date");t==null||t.addEventListener("change",u=>{let d=u.target.value||"";if(U(Wn(),d),!!d){if(!W.overrides.accountingPeriod){let g=ca(d);if(g){let v=document.getElementById("config-accounting-period");v&&(v.value=g),U("PR_Accounting_Period",g)}}if(!W.overrides.jeId){let g=da(d);if(g){let v=document.getElementById("config-je-id");v&&(v.value=g),U("PR_Journal_Entry_ID",g)}}}});let n=Se(0),o=document.getElementById("config-accounting-period");o==null||o.addEventListener("change",u=>{W.overrides.accountingPeriod=!!u.target.value,U("PR_Accounting_Period",u.target.value||"")});let a=document.getElementById("config-je-id");a==null||a.addEventListener("change",u=>{W.overrides.jeId=!!u.target.value,U("PR_Journal_Entry_ID",u.target.value.trim())}),(r=document.getElementById("config-company-name"))==null||r.addEventListener("change",u=>{U("SS_Company_Name",u.target.value.trim())}),(i=document.getElementById("config-payroll-provider"))==null||i.addEventListener("change",u=>{let d=u.target.value.trim();U(jn,d)}),(p=document.getElementById("config-accounting-link"))==null||p.addEventListener("change",u=>{U("SS_Accounting_Software",u.target.value.trim())});let s=document.getElementById("config-notes");if(s==null||s.addEventListener("input",u=>{n&&U(n.note,u.target.value,{debounceMs:400})}),n){let u=document.getElementById("config-notes-permanent");u&&(u.addEventListener("click",()=>{let g=!u.classList.contains("is-locked");Je(u,g),Jn(n.note,g)}),Je(u,Re(n.note)));let d=document.getElementById("config-notes-save");d==null||d.addEventListener("click",()=>{s&&(U(n.note,s.value),Te(d,!0))})}let l=document.getElementById("config-reviewer-name");l==null||l.addEventListener("change",u=>{let d=u.target.value.trim();n&&U(n.reviewer,d),U(qe,d);let g=document.getElementById("config-signoff-date");if(d&&g&&!g.value){let v=Ze();g.value=v,n&&U(n.signOff,v)}}),(f=document.getElementById("config-signoff-date"))==null||f.addEventListener("change",u=>{n&&U(n.signOff,u.target.value||"")});let c=document.getElementById("config-signoff-save");if(c==null||c.addEventListener("click",()=>{var v;let u=((v=l==null?void 0:l.value)==null?void 0:v.trim())||"",d=document.getElementById("config-signoff-date"),g=(d==null?void 0:d.value)||"";n&&(U(n.reviewer,u),U(n.signOff,g)),U(qe,u),Te(c,!0)}),Vt(),n){let u=P(n.signOff),d=P(de[0]),g=!!(u||d==="Y"||d===!0);console.log(`[Step 0] Binding signoff toggle. signOff="${u}", complete="${d}", isComplete=${g}`),Gn({buttonId:"config-signoff-toggle",inputId:"config-signoff-date",fieldName:n.signOff,completeField:de[0],initialActive:g,stepId:0})}}function oa(e){var n,o,a,s,l,c,r,i,p,f,u,d,g,v,w,h,E,k,_,$,V;if((n=document.getElementById("step-back-btn"))==null||n.addEventListener("click",()=>{Hn()}),(o=document.getElementById("step-action-btn"))==null||o.addEventListener("click",()=>{let x=rt.find(T=>T.id===e);window.alert(x!=null&&x.ctaLabel?`${x.ctaLabel} coming soon.`:"Step actions coming soon.")}),e===1&&((a=document.getElementById("import-open-data-btn"))==null||a.addEventListener("click",()=>ra()),(s=document.getElementById("import-clear-btn"))==null||s.addEventListener("click",()=>ia())),e===2&&((l=document.getElementById("headcount-skip-btn"))==null||l.addEventListener("click",()=>{H.skipAnalysis=!H.skipAnalysis;let x=document.getElementById("headcount-skip-btn");x==null||x.classList.toggle("is-active",H.skipAnalysis),H.skipAnalysis&&Jt(),vt()}),(c=document.getElementById("roster-run-btn"))==null||c.addEventListener("click",()=>Wt()),(r=document.getElementById("roster-refresh-btn"))==null||r.addEventListener("click",()=>Wt()),(i=document.getElementById("roster-review-btn"))==null||i.addEventListener("click",()=>{var T;let x=((T=H.roster)==null?void 0:T.mismatches)||[];Vn("Roster Differences",x,{sourceLabel:"Roster",targetLabel:"Payroll Data"})}),(p=document.getElementById("dept-review-btn"))==null||p.addEventListener("click",()=>{var T;let x=((T=H.departments)==null?void 0:T.mismatches)||[];Vn("Department Differences",x,{sourceLabel:"Roster",targetLabel:"Payroll",formatter:m=>({name:m.employee,source:`${m.rosterDept} \u2192 ${m.payrollDept}`,isMissingFromTarget:!0})})})),e===3&&((f=document.getElementById("validation-run-btn"))==null||f.addEventListener("click",()=>Mn()),(u=document.getElementById("validation-refresh-btn"))==null||u.addEventListener("click",()=>Mn()),(d=document.getElementById("bank-amount-input"))==null||d.addEventListener("blur",Fn),(g=document.getElementById("bank-amount-input"))==null||g.addEventListener("keydown",x=>{x.key==="Enter"&&Fn(x)})),e===5&&((v=document.getElementById("je-run-btn"))==null||v.addEventListener("click",()=>Ta()),(w=document.getElementById("je-save-btn"))==null||w.addEventListener("click",()=>La()),(h=document.getElementById("je-create-btn"))==null||h.addEventListener("click",()=>Ba()),(E=document.getElementById("je-export-btn"))==null||E.addEventListener("click",()=>Ma())),e===4){let x=document.querySelector(".pf-step-guide");if(x){let T="https://your-project.supabase.co/functions/v1/copilot";ln(x,{id:"expense-review-copilot",contextProvider:pa(),systemPrompt:`You are Prairie Forge CoPilot, an expert financial analyst assistant for payroll expense review.
...
When asked about readiness, be specific about what passes and what needs attention.`})}(k=document.getElementById("expense-run-btn"))==null||k.addEventListener("click",()=>{Ln()}),(_=document.getElementById("expense-refresh-btn"))==null||_.addEventListener("click",()=>{Ln()})}let t=Se(e);if(console.log(`[Step ${e}] Binding interactions, fields:`,t),t){let x=e===1?"step-notes-1":"step-notes-input",T=document.getElementById(x);console.log(`[Step ${e}] Notes input found:`,!!T,`(id: ${x})`);let m=e===1?document.getElementById("step-notes-save-1"):e===2?document.getElementById("step-notes-save-2"):e===3?document.getElementById("step-notes-save-3"):e===4?document.getElementById("step-notes-save-4"):e===5?document.getElementById("step-notes-save-5"):document.getElementById("step-notes-save");T==null||T.addEventListener("input",Z=>{U(t.note,Z.target.value,{debounceMs:400}),e===2&&(H.skipAnalysis&&Jt(),vt())}),m==null||m.addEventListener("click",()=>{T&&(U(t.note,T.value),Te(m,!0))});let I=e===1?"step-reviewer-1":"step-reviewer-name",L=document.getElementById(I);L==null||L.addEventListener("change",Z=>{let fe=Z.target.value.trim();U(t.reviewer,fe);let me=e===1?document.getElementById("step-signoff-1"):e===2?document.getElementById("step-signoff-date"):e===3?document.getElementById("step-signoff-3"):e===4?document.getElementById("step-signoff-4"):e===5?document.getElementById("step-signoff-5"):document.getElementById(`step-signoff-${e}`);if(fe&&me&&!me.value){let he=Ze();me.value=he,U(t.signOff,he)}});let Q=e===1?"step-signoff-1":e===2?"step-signoff-date":e===3?"step-signoff-3":e===4?"step-signoff-4":e===5?"step-signoff-5":`step-signoff-${e}`;console.log(`[Step ${e}] Signoff input ID: ${Q}, found:`,!!document.getElementById(Q)),($=document.getElementById(Q))==null||$.addEventListener("change",Z=>{U(t.signOff,Z.target.value||"")});let pe=e===1?"step-notes-lock-1":"step-notes-permanent",K=document.getElementById(pe);K&&(K.addEventListener("click",()=>{let Z=!K.classList.contains("is-locked");Je(K,Z),Jn(t.note,Z),e===2&&vt()}),Je(K,Re(t.note)));let M=e===1?document.getElementById("step-signoff-save-1"):e===2?document.getElementById("headcount-signoff-save"):e===3?document.getElementById("step-signoff-save-3"):e===4?document.getElementById("step-signoff-save-4"):e===5?document.getElementById("step-signoff-save-5"):document.getElementById(`step-signoff-save-${e}`);M==null||M.addEventListener("click",()=>{var me,he;let Z=((me=L==null?void 0:L.value)==null?void 0:me.trim())||"",fe=((he=document.getElementById(Q))==null?void 0:he.value)||"";U(t.reviewer,Z),U(t.signOff,fe),Te(M,!0)}),Vt();let Y=de[e],ne=Y?!!P(Y):!1,xe=P(t.signOff),X=e===1?"step-signoff-toggle-1":e===2?"headcount-signoff-toggle":e===3?"validation-signoff-toggle":e===4?"expense-signoff-toggle":e===5?"step-signoff-toggle-5":`step-signoff-toggle-${e}`;console.log(`[Step ${e}] Toggle button ID: ${X}, found:`,!!document.getElementById(X)),Gn({buttonId:X,inputId:Q,fieldName:t.signOff,completeField:Y,requireNotesCheck:e===2?Rt:null,initialActive:!!(xe||ne),stepId:e,onComplete:e===3?_a:e===4?Aa:e===2?xa:null})}e===2&&vt(),e===6&&((V=document.getElementById("archive-run-btn"))==null||V.addEventListener("click",Da))}function Qe(e){if(Number.isNaN(e)||e<0||e>=be.length)return;let t=be[e];if(!t)return;bt=e;let n=t.id===0?"config":"step";Yt({focusedIndex:e,activeView:n,activeStepId:t.id});let o=No[t.id];o&&Ca(o),t.id===2&&!H.hasAnalyzed&&Wt()}function In(e){if(te.activeView==="home"&&e>0){Qe(0);return}let t=te.focusedIndex+e,n=Math.max(0,Math.min(be.length-1,t));Qe(n)}function aa(){if(te.activeView!=="home"||bt===null)return;let e=document.querySelector(`[data-step-card][data-step-index="${bt}"]`);bt=null,e==null||e.scrollIntoView({behavior:"smooth",block:"center"})}async function Hn(){let e=Ot(Et);await Nt(e.sheetName,e.title,e.subtitle),Yt({activeView:"home",activeStepId:null})}function Yt(e){Object.assign(te,e),le()}function De(){return P(qe)||P("SS_Default_Reviewer")||""}function Ut(e,t){e&&(e.classList.toggle("is-active",t),e.setAttribute("aria-pressed",String(t)))}function Un(e){let t=document.getElementById("je-save-btn");t&&t.classList.toggle("is-saved",e)}function sa(){let e={};return console.log("[Signoff] Checking step completion status..."),Object.keys($e).forEach(t=>{let n=parseInt(t,10),o=$e[n];if(!o){e[n]=!1;return}let a=P(o.signOff),s=de[n],l=P(s),c=!!a||l==="Y"||l===!0;e[n]=c,console.log(`[Signoff] Step ${n}: signOff="${a}", complete="${l}" \u2192 ${c?"COMPLETE":"pending"}`)}),console.log("[Signoff] Status summary:",e),e}function Gn({buttonId:e,inputId:t,fieldName:n,completeField:o,requireNotesCheck:a,onComplete:s,initialActive:l=!1,stepId:c=null}){let r=document.getElementById(e);if(!r){console.warn(`[Signoff] Button not found: ${e}`);return}let i=t?document.getElementById(t):null,p=l||!!(i!=null&&i.value);Ut(r,p),console.log(`[Signoff] Bound ${e}, initial active: ${p}, stepId: ${c}`),r.addEventListener("click",()=>{if(console.log(`[Signoff] Done button clicked: ${e}, stepId: ${c}`),c!==null&&c>0){let u=sa(),{canComplete:d,message:g}=Sn(c,u),v=r.classList.contains("is-active");if(console.log(`[Signoff] canComplete: ${d}, isCurrentlyActive: ${v}`),!v&&!d){console.log(`[Signoff] BLOCKED: ${g}`),xn(g);return}}if(a&&!a()){window.alert("Please add notes before completing this step.");return}let f=!r.classList.contains("is-active");if(console.log(`[Signoff] ${e} clicked, toggling to: ${f}`),Ut(r,f),i&&(i.value=f?Ze():""),n){let u=f?Ze():"";console.log(`[Signoff] Writing ${n} = "${u}"`),U(n,u)}if(o){let u=f?"Y":"";console.log(`[Signoff] Writing ${o} = "${u}"`),U(o,u)}f&&typeof s=="function"&&s()}),i&&i.addEventListener("change",()=>{let f=!!i.value,u=r.classList.contains("is-active");f!==u&&(console.log(`[Signoff] Date input changed, syncing button to: ${f}`),Ut(r,f),n&&U(n,i.value||""),o&&U(o,f?"Y":""))})}async function ra(){if(!ae()){window.alert("Open this module inside Excel to access the data sheet.");return}try{await Excel.run(async e=>{let t=e.workbook.worksheets.getItem(A.DATA);t.activate(),t.getRange("A1").select(),await e.sync()})}catch(e){console.error("Unable to open PR_Data sheet",e),window.alert(`Unable to open ${A.DATA}. Confirm the sheet exists in this workbook.`)}}async function ia(){if(!ae()){window.alert("Open this module inside Excel to clear data.");return}if(window.confirm("Are you sure you want to clear all data from PR_Data? This cannot be undone."))try{await Excel.run(async t=>{let n=t.workbook.worksheets.getItem(A.DATA),o=n.getUsedRangeOrNullObject();o.load("isNullObject"),await t.sync(),o.isNullObject||(n.getRange("A2:Z10000").clear(Excel.ClearApplyTo.contents),await t.sync()),n.activate(),n.getRange("A1").select(),await t.sync()}),window.alert("PR_Data cleared successfully.")}catch(t){console.error("Unable to clear PR_Data sheet",t),window.alert("Unable to clear PR_Data. Please try again.")}}async function Ie(e){var a,s;if(!Ht.length)return null;if(gt){let l=e.workbook.tables.getItemOrNullObject(gt);if(l.load("name"),await e.sync(),!l.isNullObject)return l;gt=null}let t=e.workbook.tables;t.load("items/name"),await e.sync();let n=((a=t.items)==null?void 0:a.map(l=>l.name))||[];console.log("[Payroll] Looking for config table:",Ht),console.log("[Payroll] Found tables in workbook:",n);let o=(s=t.items)==null?void 0:s.find(l=>Ht.includes(l.name));return o?(console.log("[Payroll] \u2713 Config table found:",o.name),gt=o.name,e.workbook.tables.getItem(o.name)):(console.warn("[Payroll] \u26A0\uFE0F CONFIG TABLE NOT FOUND!"),console.warn("[Payroll] Expected table named: SS_PF_Config"),console.warn("[Payroll] Available tables:",n),console.warn("[Payroll] To fix: Select your data in SS_PF_Config sheet \u2192 Insert \u2192 Table \u2192 Name it 'SS_PF_Config'"),null)}async function zn(){if(!ae()){W.loaded=!0;return}try{await Excel.run(async e=>{let t=await Ie(e);if(!t){console.warn("Payroll Recorder: SS_PF_Config table is missing."),W.loaded=!0;return}let n=t.getDataBodyRange();n.load("values"),await e.sync();let o=n.values||[],a={},s={};o.forEach(l=>{var r,i;let c=oe(l[B.FIELD]);c&&(a[c]=(r=l[B.VALUE])!=null?r:"",s[c]=(i=l[B.PERMANENT])!=null?i:"")}),W.values=a,W.permanents=s,W.overrides.accountingPeriod=!!(a.PR_Accounting_Period||a.Accounting_Period),W.overrides.jeId=!!(a.PR_Journal_Entry_ID||a.Journal_Entry_ID),W.loaded=!0})}catch(e){console.warn("Payroll Recorder: unable to load PF_Config table.",e),W.loaded=!0}}function P(e){var t;return(t=W.values[e])!=null?t:""}function Wn(){let e=Object.keys(W.values||{});return Xe.find(n=>e.includes(n))||Xe[0]}function Ct(){return P(Wn())}function qt(){return(P(jn)||P("Payroll_Provider_Link")||"").trim()}function Re(e){return Yn(W.permanents[e])}function la(e){let t=de[e];return t?Yn(P(t)):!1}function Jn(e,t){let n=oe(e);n&&(W.permanents[n]=t?"Y":"N",ua(n,t?"Y":"N"))}function Yn(e){let t=String(e!=null?e:"").trim().toLowerCase();return t==="true"||t==="y"||t==="yes"||t==="1"}function oe(e){return String(e!=null?e:"").trim()}function qn(e){let t=String(e!=null?e:"").trim().toLowerCase();return t?t.includes("total")||t.includes("totals")||t.includes("grand total")||t.includes("subtotal")||t.includes("summary"):!0}function ye(e){if(!e)return"";let t=kt(e);return t?`${t.year}-${String(t.month).padStart(2,"0")}-${String(t.day).padStart(2,"0")}`:""}function ca(e){let t=kt(e);return t?`${["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][t.month-1]} ${t.year}`:""}function da(e){let t=kt(e);return t?`PR-AUTO-${t.year}-${String(t.month).padStart(2,"0")}-${String(t.day).padStart(2,"0")}`:""}function Ze(){return wt(new Date)}function U(e,t,n={}){var l;let o=oe(e);W.values[o]=t!=null?t:"";let a=(l=n.debounceMs)!=null?l:0;if(!a){let c=Le.get(o);c&&clearTimeout(c),Le.delete(o),Ke(o,t!=null?t:"");return}Le.has(o)&&clearTimeout(Le.get(o));let s=setTimeout(()=>{Le.delete(o),Ke(o,t!=null?t:"")},a);Le.set(o,s)}async function Ke(e,t){let n=oe(e);if(W.values[n]=t!=null?t:"",console.log(`[Payroll] Writing config: ${n} = "${t}"`),!ae()){console.warn("[Payroll] Excel runtime not available - cannot write");return}try{await Excel.run(async o=>{var f;let a=await Ie(o);if(!a){console.error("[Payroll] \u274C Cannot write - config table not found");return}let s=a.getDataBodyRange(),l=a.getHeaderRowRange();s.load("values"),l.load("values"),await o.sync();let c=l.values[0]||[],r=s.values||[],i=c.length;console.log(`[Payroll] Table has ${r.length} rows, ${i} columns`);let p=r.findIndex(u=>oe(u[B.FIELD])===n);if(p===-1){W.permanents[n]=(f=W.permanents[n])!=null?f:Dn;let u=new Array(i).fill("");B.TYPE>=0&&B.TYPE<i&&(u[B.TYPE]=Do),B.FIELD>=0&&B.FIELD<i&&(u[B.FIELD]=n),B.VALUE>=0&&B.VALUE<i&&(u[B.VALUE]=t!=null?t:""),B.PERMANENT>=0&&B.PERMANENT<i&&(u[B.PERMANENT]=Dn),console.log("[Payroll] Adding NEW row:",u),a.rows.add(null,[u]),await o.sync(),console.log(`[Payroll] \u2713 New row added for ${n}`)}else console.log(`[Payroll] Updating existing row ${p} for ${n}`),s.getCell(p,B.VALUE).values=[[t!=null?t:""]],await o.sync(),console.log(`[Payroll] \u2713 Updated ${n}`)})}catch(o){console.error(`[Payroll] \u274C Write failed for ${e}:`,o)}}async function ua(e,t){let n=oe(e);if(n&&ae()){W.permanents[n]=t;try{await Excel.run(async o=>{let a=await Ie(o);if(!a){console.warn(`Payroll Recorder: unable to locate config table when toggling ${e} permanent flag.`);return}let s=a.getDataBodyRange();s.load("values"),await o.sync();let c=(s.values||[]).findIndex(r=>oe(r[B.FIELD])===n);c!==-1&&(s.getCell(c,B.PERMANENT).values=[[t]],await o.sync())})}catch(o){console.warn(`Payroll Recorder: unable to update permanent flag for ${e}`,o)}}}function kt(e){if(!e)return null;let t=String(e).trim(),n=/^(\d{4})-(\d{2})-(\d{2})/.exec(t);if(n){let l=Number(n[1]),c=Number(n[2]),r=Number(n[3]);if(l&&c&&r)return{year:l,month:c,day:r}}let o=/^(\d{1,2})\/(\d{1,2})\/(\d{4})/.exec(t);if(o){let l=Number(o[1]),c=Number(o[2]),r=Number(o[3]);if(r&&l&&c)return{year:r,month:l,day:c}}let a=Number(e);if(Number.isFinite(a)&&a>4e4&&a<6e4){let l=new Date(1899,11,30),c=new Date(l.getTime()+a*24*60*60*1e3);if(!isNaN(c.getTime()))return console.log("DEBUG parseDateInput - Converted Excel serial",a,"to",c.toISOString().split("T")[0]),{year:c.getFullYear(),month:c.getMonth()+1,day:c.getDate()}}let s=new Date(t);return isNaN(s.getTime())?(console.warn("DEBUG parseDateInput - Could not parse date value:",e),null):{year:s.getFullYear(),month:s.getMonth()+1,day:s.getDate()}}function wt(e){let t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${t}-${n}-${o}`}function $n(e){if(!e)return null;if(typeof e=="string"){let n=e.match(/^(\d{4})-(\d{2})-(\d{2})/);if(n)return`${n[1]}-${n[2]}-${n[3]}`}let t=kt(e);return t?`${t.year}-${String(t.month).padStart(2,"0")}-${String(t.day).padStart(2,"0")}`:null}function pa(){return async()=>{if(!ae())return null;try{return await Excel.run(async e=>{var l,c,r;let t={timestamp:new Date().toISOString(),period:null,summary:{},departments:[],recentPeriods:[],dataQuality:{}},n=await Ie(e);if(n){let i=n.getDataBodyRange();i.load("values"),await e.sync();let p=i.values||[];for(let f of p){let u=String(f[B.FIELD]||"").trim(),d=f[B.VALUE];u.toLowerCase().includes("accounting")&&u.toLowerCase().includes("period")&&(t.period=String(d||"").trim())}}let o=e.workbook.worksheets.getItemOrNullObject(A.DATA_CLEAN);if(o.load("isNullObject"),await e.sync(),!o.isNullObject){let i=o.getUsedRangeOrNullObject();if(i.load("values"),await e.sync(),!i.isNullObject&&((l=i.values)==null?void 0:l.length)>1){let p=i.values[0].map(E=>ve(E)),f=i.values.slice(1),u=p.findIndex(E=>E.includes("amount")),d=Be(p),g=p.findIndex(E=>E.includes("employee")),v=0,w=new Set,h=new Map;for(let E of f){let k=Number(E[u])||0;if(v+=k,g>=0){let _=String(E[g]||"").trim();_&&w.add(_)}if(d>=0){let _=String(E[d]||"").trim();_&&h.set(_,(h.get(_)||0)+k)}}t.summary={total:v,employeeCount:w.size,avgPerEmployee:w.size?v/w.size:0,rowCount:f.length},t.departments=Array.from(h.entries()).map(([E,k])=>({name:E,total:k,percentOfTotal:v?k/v:0})).sort((E,k)=>k.total-E.total),t.dataQuality.dataCleanReady=!0,t.dataQuality.rowCount=f.length}}let a=e.workbook.worksheets.getItemOrNullObject(A.ARCHIVE_SUMMARY);if(a.load("isNullObject"),await e.sync(),!a.isNullObject){let i=a.getUsedRangeOrNullObject();if(i.load("values"),await e.sync(),!i.isNullObject&&((c=i.values)==null?void 0:c.length)>1){let p=i.values[0].map(d=>ve(d)),f=p.findIndex(d=>d.includes("period")),u=p.findIndex(d=>d.includes("total"));t.recentPeriods=i.values.slice(1,6).map(d=>({period:d[f]||"",total:Number(d[u])||0})),t.dataQuality.archiveAvailable=!0,t.dataQuality.periodsAvailable=t.recentPeriods.length}}let s=e.workbook.worksheets.getItemOrNullObject(A.JE_DRAFT);if(s.load("isNullObject"),await e.sync(),!s.isNullObject){let i=s.getUsedRangeOrNullObject();if(i.load("values"),await e.sync(),!i.isNullObject&&((r=i.values)==null?void 0:r.length)>1){let p=i.values[0].map(v=>ve(v)),f=p.findIndex(v=>v.includes("debit")),u=p.findIndex(v=>v.includes("credit")),d=0,g=0;for(let v of i.values.slice(1))d+=Number(v[f])||0,g+=Number(v[u])||0;t.journalEntry={totalDebit:d,totalCredit:g,difference:Math.abs(d-g),isBalanced:Math.abs(d-g)<.01,lineCount:i.values.length-1},t.dataQuality.jeDraftReady=!0}}return console.log("CoPilot context gathered:",t),t})}catch(e){return console.warn("CoPilot context provider error:",e),null}}}function S(e){return String(e!=null?e:"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ge(e,t){return`
        <div class="pf-labeled-button">
            ${e}
            <span class="pf-button-label">${S(t)}</span>
        </div>
    `}function ae(){return typeof Excel!="undefined"&&typeof Excel.run=="function"}function Se(e){return $e[e]||null}function fa(){var n,o,a,s;let e=Math.abs((o=(n=H.roster)==null?void 0:n.difference)!=null?o:0),t=Math.abs((s=(a=H.departments)==null?void 0:a.difference)!=null?s:0);return e>0||t>0}function Rt(){return!H.skipAnalysis&&fa()}function ie(e){return e==null||Number.isNaN(e)?"---":typeof e!="number"?e:e.toLocaleString(void 0,{minimumFractionDigits:2,maximumFractionDigits:2})}function Kn(e){let t=Kt(e);return Number.isFinite(t)?t.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2}):""}function ma(e=[]){return e.map(t=>(t||[]).map(n=>{if(n==null)return"";let o=String(n);return/[",\n]/.test(o)?`"${o.replace(/"/g,'""')}"`:o}).join(",")).join(`
`)}function ga(e,t){let n=new Blob([t],{type:"text/csv;charset=utf-8;"}),o=URL.createObjectURL(n),a=document.createElement("a");a.href=o,a.download=e,document.body.appendChild(a),a.click(),a.remove(),setTimeout(()=>URL.revokeObjectURL(o),1e3)}function Kt(e){if(typeof e=="number")return e;if(e==null)return NaN;let t=String(e).replace(/[^0-9.-]/g,""),n=Number.parseFloat(t);return Number.isFinite(n)?n:NaN}function ha(e){if(e instanceof Date)return wt(e);if(typeof e=="number"&&!Number.isNaN(e)){let o=ya(e);return o?wt(o):""}let t=String(e!=null?e:"").trim();if(!t)return"";if(/^\d{4}-\d{2}-\d{2}$/.test(t))return t;let n=new Date(t);return Number.isNaN(n.getTime())?t:wt(n)}function ya(e){if(!Number.isFinite(e))return null;let t=Math.floor(e-25569);if(!Number.isFinite(t))return null;let n=t*86400*1e3;return new Date(n)}function va(e){if(!e)return"";let t=new Date(e);return Number.isNaN(t.getTime())?e:t.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}function ht(e){if(e==null||e==="")return 0;let t=Number(e);return Number.isFinite(t)?t:0}function ba(e){let t=ce(e).toLowerCase();return t?t.includes("burden")||t.includes("tax")||t.includes("benefit")||t.includes("fica")||t.includes("insurance")||t.includes("health")||t.includes("medicare")?"burden":t.includes("bonus")||t.includes("commission")||t.includes("variable")||t.includes("overtime")||t.includes("per diem")?"variable":"fixed":"variable"}function Nn(e){if(!e||e.length<2)return[];let t=(e[0]||[]).map(a=>ve(a));console.log("parseExpenseRows - headers:",t);let n={payrollDate:t.findIndex(a=>a.includes("payroll")&&a.includes("date")),employee:t.findIndex(a=>a.includes("employee")),department:t.findIndex(a=>a.includes("department")),fixed:t.findIndex(a=>a.includes("fixed")),variable:t.findIndex(a=>a.includes("variable")),burden:t.findIndex(a=>a.includes("burden")),amount:t.findIndex(a=>a.includes("amount")),expenseReview:t.findIndex(a=>a.includes("expense")&&a.includes("review")),category:t.findIndex(a=>a.includes("payroll")&&a.includes("category"))};if(console.log("parseExpenseRows - column indexes:",n),n.payrollDate>=0){let a=new Set;for(let s=1;s<e.length;s++){let l=e[s][n.payrollDate];l&&a.add(String(l))}console.log("parseExpenseRows - unique payroll dates found:",[...a].slice(0,20))}let o=[];for(let a=1;a<e.length;a+=1){let s=e[a],l=ha(n.payrollDate>=0?s[n.payrollDate]:null);if(!l)continue;let c=n.employee>=0?ce(s[n.employee]):"",r=n.department>=0&&ce(s[n.department])||"Unassigned",i=n.fixed>=0?ht(s[n.fixed]):null,p=n.variable>=0?ht(s[n.variable]):null,f=n.burden>=0?ht(s[n.burden]):null,u=0,d=0,g=0;if(i!==null||p!==null||f!==null)u=i!=null?i:0,d=p!=null?p:0,g=f!=null?f:0;else{let v=n.amount>=0?ht(s[n.amount]):0,w=ba(n.expenseReview>=0?s[n.expenseReview]:s[n.category]);w==="fixed"?u=v:w==="burden"?g=v:d=v}u===0&&d===0&&g===0||o.push({period:l,employee:c,department:r||"Unassigned",fixed:u,variable:d,burden:g})}return o}function On(e){let t=new Map;e.forEach(o=>{let a=o.period;if(!a)return;t.has(a)||t.set(a,{key:a,label:va(a),employees:new Set,departments:new Map,summary:{fixed:0,variable:0,burden:0}});let s=t.get(a);s.employees.add(o.employee||`EMP-${s.employees.size+1}`);let l=o.department||"Unassigned";s.departments.has(l)||s.departments.set(l,{name:l,fixed:0,variable:0,burden:0,employees:new Set});let c=s.departments.get(l);c.fixed+=o.fixed,c.variable+=o.variable,c.burden+=o.burden,c.employees.add(o.employee||`EMP-${c.employees.size+1}`),s.summary.fixed+=o.fixed,s.summary.variable+=o.variable,s.summary.burden+=o.burden});let n=[];return t.forEach(o=>{let a=o.summary.fixed+o.summary.variable+o.summary.burden,s=Array.from(o.departments.values()).map(r=>{let i=r.fixed+r.variable,p=i+r.burden;return{name:r.name,fixed:r.fixed,variable:r.variable,gross:i,burden:r.burden,allIn:p,percent:a?p/a:0,headcount:r.employees.size,delta:0}});s.sort((r,i)=>i.allIn-r.allIn);let l={employeeCount:o.employees.size,fixed:o.summary.fixed,variable:o.summary.variable,burden:o.summary.burden,total:a,burdenRate:a?o.summary.burden/a:0,delta:0},c={name:"Totals",fixed:o.summary.fixed,variable:o.summary.variable,gross:o.summary.fixed+o.summary.variable,burden:o.summary.burden,allIn:a,percent:a?1:0,headcount:o.employees.size,delta:0,isTotal:!0};n.push({key:o.key,label:o.label,summary:l,departments:s,totalsRow:c})}),n.sort((o,a)=>o.key<a.key?1:-1)}function Tn(e,t){console.log("buildExpenseReviewPeriods - cleanValues rows:",(e==null?void 0:e.length)||0),console.log("buildExpenseReviewPeriods - archiveValues rows:",(t==null?void 0:t.length)||0);let n=On(Nn(e)),o=On(Nn(t));console.log("buildExpenseReviewPeriods - currentPeriods:",n.map(i=>{var p,f;return{key:i.key,employees:(p=i.summary)==null?void 0:p.employeeCount,total:(f=i.summary)==null?void 0:f.total}})),console.log("buildExpenseReviewPeriods - archivePeriods:",o.map(i=>{var p,f;return{key:i.key,employees:(p=i.summary)==null?void 0:p.employeeCount,total:(f=i.summary)==null?void 0:f.total}}));let a=new Map(o.map(i=>[i.key,i])),s=[];n.length&&(s.push(n[0]),a.delete(n[0].key)),o.forEach(i=>{s.length>=6||s.some(p=>p.key===i.key)||s.push(i)}),console.log("buildExpenseReviewPeriods - combined before filter:",s.map(i=>{var p,f;return{key:i.key,employees:(p=i.summary)==null?void 0:p.employeeCount,total:(f=i.summary)==null?void 0:f.total}}));let l=3,c=1e3,r=s.filter(i=>{var d,g,v,w,h;if(!i||!i.key)return console.log("buildExpenseReviewPeriods - EXCLUDED (no key):",i),!1;let p=((d=i.summary)==null?void 0:d.total)||(((g=i.summary)==null?void 0:g.fixed)||0)+(((v=i.summary)==null?void 0:v.variable)||0)+(((w=i.summary)==null?void 0:w.burden)||0),f=((h=i.summary)==null?void 0:h.employeeCount)||0;if(s.indexOf(i)===0)return console.log(`buildExpenseReviewPeriods - INCLUDED (current): ${i.key} - ${f} employees, $${p}`),!0;let u=f>=l&&p>=c;return console.log(`buildExpenseReviewPeriods - ${u?"INCLUDED":"EXCLUDED"}: ${i.key} - ${f} employees, $${p} (needs >=${l} emp, >=$${c})`),u}).sort((i,p)=>i.key<p.key?1:-1).slice(0,6);return console.log("buildExpenseReviewPeriods - FINAL periods:",r.map(i=>i.key)),r.forEach((i,p)=>{let f=r[p+1],u=f?i.summary.total-f.summary.total:0;i.summary.delta=u;let d=new Map(((f==null?void 0:f.departments)||[]).map(g=>[g.name,g]));i.departments.forEach(g=>{let v=d.get(g.name);g.delta=v?g.allIn-v.allIn:0}),i.totalsRow.delta=u}),r}async function Ln(){if(!ae()){yt({loading:!1,lastError:"Excel runtime is unavailable."});return}yt({loading:!0,lastError:null});try{let e=await Excel.run(async t=>{let n=t.workbook.worksheets.getItemOrNullObject(A.DATA_CLEAN),o=t.workbook.worksheets.getItemOrNullObject(A.ARCHIVE_SUMMARY),a=t.workbook.worksheets.getItemOrNullObject(A.EXPENSE_REVIEW);if(n.load("isNullObject, name"),o.load("isNullObject, name"),a.load("isNullObject, name"),await t.sync(),console.log("Expense Review - Sheet check:",{cleanSheet:n.isNullObject?"MISSING":n.name,archiveSheet:o.isNullObject?"MISSING":o.name,reviewSheet:a.isNullObject?"MISSING":a.name}),a.isNullObject){console.log("Creating PR_Expense_Review sheet...");let r=t.workbook.worksheets.add(A.EXPENSE_REVIEW);await t.sync();let i=t.workbook.worksheets.getItem(A.EXPENSE_REVIEW),p=[],f=[];if(!n.isNullObject){let d=n.getUsedRangeOrNullObject();d.load("values"),await t.sync(),p=d.isNullObject?[]:d.values||[]}if(!o.isNullObject){let d=o.getUsedRangeOrNullObject();d.load("values"),await t.sync(),f=d.isNullObject?[]:d.values||[]}let u=Tn(p,f);return await Bn(t,i,u),u}let s=[],l=[];if(n.isNullObject)console.warn("Expense Review - PR_Data_Clean sheet not found, using empty data");else{let r=n.getUsedRangeOrNullObject();r.load("values"),await t.sync(),s=r.isNullObject?[]:r.values||[],console.log("Expense Review - PR_Data_Clean rows:",s.length)}if(o.isNullObject)console.warn("Expense Review - PR_Archive_Summary sheet not found, using empty data");else{let r=o.getUsedRangeOrNullObject();r.load("values"),await t.sync(),l=r.isNullObject?[]:r.values||[],console.log("Expense Review - PR_Archive_Summary rows:",l.length)}let c=Tn(s,l);return console.log("Expense Review - Periods built:",c.length),await Bn(t,a,c),c});yt({loading:!1,periods:e,lastError:null}),await Oo(),le()}catch(e){console.error("Expense Review: unable to build executive summary",e),console.error("Error details:",e.message,e.stack),yt({loading:!1,lastError:`Unable to build the Expense Review: ${e.message||"Unknown error"}`,periods:[]})}}async function Bn(e,t,n){if(!t){console.error("writeExpenseReviewSheet: sheet is null/undefined");return}console.log("writeExpenseReviewSheet: Building executive dashboard with",n.length,"periods");try{let y=t.getUsedRangeOrNullObject();y.load("address");let R=t.charts;R.load("items"),await e.sync(),y.isNullObject||(y.clear(),await e.sync());for(let j=R.items.length-1;j>=0;j--)R.items[j].delete();await e.sync()}catch(y){console.warn("Could not clear sheet:",y)}let o=n[0]||{},a=n[1]||{},s=o.summary||{},l=a.summary||{},c=P("PR_Accounting_Period")||Ct()||"",r=Number(s.total)||0,i=Number(l.total)||0,p=r-i,f=i?p/i:0,u=Number(s.employeeCount)||0,d=Number(l.employeeCount)||0,g=u-d,v=u?r/u:0,w=d?i/d:0,h=v-w,E=wa(n),k=Ea(o,n),_=o.label||o.key||"Current Period",$=new Date().toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric",hour:"numeric",minute:"2-digit"}),V=y=>y>0?"\u25B2":y<0?"\u25BC":"\u2014",x=n.map(y=>{var R;return((R=y.summary)==null?void 0:R.total)||0}).filter(y=>y>0),T=n.map(y=>{let R=y.summary||{},j=R.employeeCount||0;return j>0?(R.total||0)/j:0}).filter(y=>y>0),m=n.slice(0,-1).map((y,R)=>{var re,J,z;let j=((re=y.summary)==null?void 0:re.total)||0,ee=((z=(J=n[R+1])==null?void 0:J.summary)==null?void 0:z.total)||0;return ee>0?(j-ee)/ee:0}),I=(y,R=null)=>{let j=R!==null?[...y,R]:y;if(!j.length)return{min:0,max:0,avg:0};let ee=Math.min(...j),re=Math.max(...j),J=y.length?y:j,z=J.reduce((Ce,we)=>Ce+we,0)/J.length;return{min:ee,max:re,avg:z}},L=I(x,r),Q=I(T,v),pe=I(m),K=(y,R,j,ee=20)=>{if(j<=R)return"\u2591".repeat(ee);let re=j-R,J=Math.max(0,Math.min(1,(y-R)/re)),z=Math.round(J*(ee-1)),Ce="";for(let we=0;we<ee;we++)we===z?Ce+="\u25CF":Ce+="\u2591";return Ce},M=Number(s.fixed)||0,Y=Number(s.variable)||0,ne=Number(s.burden)||0,xe=M+Y,X=r?ne/r:0,Z=Number(l.fixed)||0,fe=Number(l.variable)||0,me=Number(l.burden)||0,he=i?me/i:0,se=o.departments||[],Xt=se.filter(y=>{let R=(y.name||"").toLowerCase();return R.includes("sales")||R.includes("marketing")}),Qt=se.filter(y=>{let R=(y.name||"").toLowerCase();return!R.includes("sales")&&!R.includes("marketing")}),eo=Xt.reduce((y,R)=>y+(R.variable||0),0),et=Xt.reduce((y,R)=>y+(R.headcount||0),0),to=Qt.reduce((y,R)=>y+(R.variable||0),0),tt=Qt.reduce((y,R)=>y+(R.headcount||0),0),St=et?eo/et:0,xt=tt?to/tt:0,_t=u?M/u:0,N=[],C=0,b={};b.headerStart=C;let Zt=c||_;if(typeof c=="number"||!isNaN(Number(c))&&c){let y=Number(c);if(y>4e4&&y<6e4){let R=new Date(1899,11,30);Zt=new Date(R.getTime()+y*24*60*60*1e3).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})}}N.push(["PAYROLL EXPENSE REVIEW"]),C++,N.push([`Period: ${Zt}`]),C++,N.push([`Generated: ${$}`]),C++,N.push([""]),C++,b.headerEnd=C-1,b.execSummaryStart=C,N.push(["EXECUTIVE SUMMARY"]),C++,b.execSummaryHeader=C-1,N.push([""]),C++,N.push(["","Pay Date","Headcount","Fixed Salary","Variable Salary","Burden","Total Payroll","Burden Rate"]),C++,b.execSummaryColHeaders=C-1,N.push(["Current Pay Period",o.label||o.key||"",u,M,Y,ne,r,X]),C++,b.execSummaryCurrentRow=C-1,N.push(["Same Period Prior Month",a.label||a.key||"",d,Z,fe,me,i,he]),C++,b.execSummaryPriorRow=C-1,N.push([""]),C++,N.push([""]),C++,b.execSummaryEnd=C-1,b.deptBreakdownStart=C,N.push(["CURRENT PERIOD BREAKDOWN (DEPARTMENT)"]),C++,b.deptBreakdownHeader=C-1,N.push([""]),C++,N.push(["Payroll Date",o.label||o.key||""]),C++,N.push([""]),C++,N.push(["Department","Fixed Salary","Variable Salary","Gross Pay","Burden","All-In Total","% of Total","Headcount"]),C++,b.deptColHeaders=C-1;let no=[...se].sort((y,R)=>(R.allIn||0)-(y.allIn||0));if(b.deptDataStart=C,no.forEach(y=>{N.push([y.name||"",y.fixed||0,y.variable||0,y.gross||0,y.burden||0,y.allIn||0,y.percent||0,y.headcount||0]),C++}),b.deptDataEnd=C-1,o.totalsRow){let y=o.totalsRow;N.push(["TOTAL",y.fixed||0,y.variable||0,y.gross||0,y.burden||0,y.allIn||0,1,y.headcount||0]),C++,b.deptTotalsRow=C-1}N.push([""]),C++,N.push([""]),C++,b.deptBreakdownEnd=C-1,b.historicalStart=C,N.push(["HISTORICAL CONTEXT"]),C++,b.historicalHeader=C-1,N.push([`Visual comparison of current period vs. historical range (${n.length} periods). The dot (\u25CF) shows where you currently stand.`]),C++,N.push([""]),C++;let q=y=>`$${Math.round(y/1e3)}K`,nt=y=>`${(y*100).toFixed(1)}%`;N.push(["","Metric","Low","Range","High","","Current","Average"]),C++,b.historicalColHeaders=C-1;let oo=n.map(y=>{var R;return((R=y.summary)==null?void 0:R.fixed)||0}).filter(y=>y>0),ao=n.map(y=>{var R;return((R=y.summary)==null?void 0:R.variable)||0}),so=n.map(y=>{let R=y.summary||{};return R.total?(R.burden||0)/R.total:0}),ro=n.map(y=>{let R=y.summary||{},j=R.employeeCount||0;return j>0?(R.fixed||0)/j:0}).filter(y=>y>0),Me=I(oo,M),Ve=I(ao,Y),Fe=I(so,X),je=I(ro,_t);b.spectrumRows=[];let io=K(r,L.min,L.max,25);N.push(["","Total Payroll",q(L.min),io,q(L.max),"",q(r),q(L.avg)]),C++,b.spectrumRows.push(C-1);let lo=K(M,Me.min,Me.max,25);N.push(["","Total Fixed Payroll",q(Me.min),lo,q(Me.max),"",q(M),q(Me.avg)]),C++,b.spectrumRows.push(C-1);let co=K(Y,Ve.min,Ve.max,25);N.push(["","Total Variable Payroll",q(Ve.min),co,q(Ve.max),"",q(Y),q(Ve.avg)]),C++,b.spectrumRows.push(C-1),N.push([""]),C++;let uo=K(_t,je.min,je.max,25);N.push(["","Avg Fixed Payroll / Employee",q(je.min),uo,q(je.max),"",q(_t),q(je.avg)]),C++,b.spectrumRows.push(C-1);let po=n.map(y=>{let j=(y.departments||[]).filter(J=>{let z=(J.name||"").toLowerCase();return z.includes("sales")||z.includes("marketing")}),ee=j.reduce((J,z)=>J+(z.variable||0),0),re=j.reduce((J,z)=>J+(z.headcount||0),0);return re>0?ee/re:0}),ot=I(po,St),fo=n.map(y=>{let j=(y.departments||[]).filter(J=>{let z=(J.name||"").toLowerCase();return!z.includes("sales")&&!z.includes("marketing")}),ee=j.reduce((J,z)=>J+(z.variable||0),0),re=j.reduce((J,z)=>J+(z.headcount||0),0);return re>0?ee/re:0}),at=I(fo,xt);if(et>0){let y=K(St,ot.min,ot.max,25);N.push(["","Avg Variable / Sales & Marketing",q(ot.min),y,q(ot.max),"",q(St),`${et} emp`]),C++,b.spectrumRows.push(C-1)}if(tt>0){let y=K(xt,at.min,at.max,25);N.push(["","Avg Variable / Other Depts",q(at.min),y,q(at.max),"",q(xt),`${tt} emp`]),C++,b.spectrumRows.push(C-1)}N.push([""]),C++;let mo=K(X,Fe.min,Fe.max,25);N.push(["","Burden Rate (%)",nt(Fe.min),mo,nt(Fe.max),"",nt(X),nt(Fe.avg)]),C++,b.spectrumRows.push(C-1),N.push([""]),C++,N.push([""]),C++,b.historicalEnd=C-1,b.trendsStart=C,N.push(["PERIOD TRENDS"]),C++,b.trendsHeader=C-1,N.push([""]),C++,N.push(["Pay Period","Total Payroll","Fixed Payroll","Variable Payroll","Burden","Headcount"]),C++,b.trendColHeaders=C-1;let en=n.slice(0,6).reverse();b.trendDataStart=C,en.forEach(y=>{let R=y.summary||{};N.push([y.label||y.key||"",R.total||0,R.fixed||0,R.variable||0,R.burden||0,R.employeeCount||0]),C++}),b.trendDataEnd=C-1,N.push([""]),C++,b.trendsEnd=C-1,b.chartStart=C;for(let y=0;y<15;y++)N.push([""]),C++;b.payrollChartEnd=C-1,b.headcountChartStart=C;for(let y=0;y<12;y++)N.push([""]),C++;b.headcountChartEnd=C-1,console.log("writeExpenseReviewSheet: Writing",N.length,"rows");let tn=N.map(y=>{let R=Array.isArray(y)?y:[""];for(;R.length<10;)R.push("");return R.slice(0,10)});try{let y=t.getRangeByIndexes(0,0,tn.length,10);y.values=tn,await e.sync()}catch(y){throw console.error("writeExpenseReviewSheet: Write failed",y),y}try{t.getRange("A:A").format.columnWidth=200,t.getRange("B:B").format.columnWidth=130,t.getRange("C:C").format.columnWidth=100,t.getRange("D:D").format.columnWidth=200,t.getRange("E:E").format.columnWidth=100,t.getRange("F:F").format.columnWidth=100,t.getRange("G:G").format.columnWidth=100,t.getRange("H:H").format.columnWidth=100,t.getRange("I:I").format.columnWidth=80,t.getRange("J:J").format.columnWidth=80,await e.sync();let y=t.getRange("A1");y.format.font.bold=!0,y.format.font.size=22,y.format.font.color="#1e293b",t.getRange("A2").format.font.size=11,t.getRange("A2").format.font.color="#64748b",t.getRange("A3").format.font.size=10,t.getRange("A3").format.font.color="#94a3b8",await e.sync();let R=t.getRange(`A${b.execSummaryHeader+1}`);R.format.font.bold=!0,R.format.font.size=14,R.format.font.color="#1e293b";let j=t.getRange(`A${b.execSummaryColHeaders+1}:H${b.execSummaryColHeaders+1}`);j.format.font.bold=!0,j.format.font.size=10,j.format.fill.color="#1e293b",j.format.font.color="#ffffff";let ee=t.getRange(`A${b.execSummaryCurrentRow+1}:H${b.execSummaryCurrentRow+1}`);ee.format.fill.color="#dcfce7",ee.format.font.bold=!0;let re=t.getRange(`A${b.execSummaryPriorRow+1}:H${b.execSummaryPriorRow+1}`);re.format.fill.color="#f1f5f9";for(let O of[b.execSummaryCurrentRow+1,b.execSummaryPriorRow+1])t.getRange(`C${O}`).numberFormat=[["#,##0"]],t.getRange(`D${O}`).numberFormat=[["$#,##0"]],t.getRange(`E${O}`).numberFormat=[["$#,##0"]],t.getRange(`F${O}`).numberFormat=[["$#,##0"]],t.getRange(`G${O}`).numberFormat=[["$#,##0"]],t.getRange(`H${O}`).numberFormat=[["0.00%"]];await e.sync();let J=t.getRange(`A${b.deptBreakdownHeader+1}`);J.format.font.bold=!0,J.format.font.size=14,J.format.font.color="#1e293b";let z=t.getRange(`A${b.deptColHeaders+1}:H${b.deptColHeaders+1}`);z.format.font.bold=!0,z.format.font.size=10,z.format.fill.color="#1e293b",z.format.font.color="#ffffff";for(let O=b.deptDataStart;O<=b.deptDataEnd;O++){let D=O+1;t.getRange(`B${D}`).numberFormat=[["$#,##0"]],t.getRange(`C${D}`).numberFormat=[["$#,##0"]],t.getRange(`D${D}`).numberFormat=[["$#,##0"]],t.getRange(`E${D}`).numberFormat=[["$#,##0"]],t.getRange(`F${D}`).numberFormat=[["$#,##0"]],t.getRange(`G${D}`).numberFormat=[["0.00%"]],t.getRange(`H${D}`).numberFormat=[["#,##0"]],(O-b.deptDataStart)%2===1&&(t.getRange(`A${D}:H${D}`).format.fill.color="#f8fafc")}if(b.deptTotalsRow){let O=t.getRange(`A${b.deptTotalsRow+1}:H${b.deptTotalsRow+1}`);O.format.font.bold=!0,O.format.fill.color="#1e293b",O.format.font.color="#ffffff";let D=b.deptTotalsRow+1;t.getRange(`B${D}`).numberFormat=[["$#,##0"]],t.getRange(`C${D}`).numberFormat=[["$#,##0"]],t.getRange(`D${D}`).numberFormat=[["$#,##0"]],t.getRange(`E${D}`).numberFormat=[["$#,##0"]],t.getRange(`F${D}`).numberFormat=[["$#,##0"]],t.getRange(`G${D}`).numberFormat=[["0%"]],t.getRange(`H${D}`).numberFormat=[["#,##0"]]}await e.sync();let Ce=t.getRange(`A${b.historicalHeader+1}`);Ce.format.font.bold=!0,Ce.format.font.size=14,Ce.format.font.color="#1e293b",t.getRange(`A${b.historicalHeader+2}`).format.font.size=10,t.getRange(`A${b.historicalHeader+2}`).format.font.color="#64748b",t.getRange(`A${b.historicalHeader+2}`).format.font.italic=!0;let we=t.getRange(`A${b.historicalColHeaders+1}:H${b.historicalColHeaders+1}`);we.format.font.bold=!0,we.format.font.size=10,we.format.fill.color="#e2e8f0",we.format.font.color="#334155",t.getRange(`C${b.historicalColHeaders+1}`).format.horizontalAlignment="Center",t.getRange(`E${b.historicalColHeaders+1}`).format.horizontalAlignment="Center",t.getRange(`G${b.historicalColHeaders+1}`).format.horizontalAlignment="Center",t.getRange(`H${b.historicalColHeaders+1}`).format.horizontalAlignment="Center",b.spectrumRows.forEach(O=>{t.getRange(`D${O+1}`).format.font.name="Consolas",t.getRange(`D${O+1}`).format.font.size=14,t.getRange(`D${O+1}`).format.font.color="#6366f1",t.getRange(`D${O+1}`).format.horizontalAlignment="Center",t.getRange(`B${O+1}`).format.font.color="#334155",t.getRange(`C${O+1}`).format.font.color="#94a3b8",t.getRange(`C${O+1}`).format.horizontalAlignment="Center",t.getRange(`E${O+1}`).format.font.color="#94a3b8",t.getRange(`E${O+1}`).format.horizontalAlignment="Center",t.getRange(`G${O+1}`).format.font.bold=!0,t.getRange(`G${O+1}`).format.font.color="#1e293b",t.getRange(`G${O+1}`).format.horizontalAlignment="Center",t.getRange(`H${O+1}`).format.font.color="#94a3b8",t.getRange(`H${O+1}`).format.horizontalAlignment="Center"}),await e.sync();let At=t.getRange(`A${b.trendsHeader+1}`);At.format.font.bold=!0,At.format.font.size=14,At.format.font.color="#1e293b";let st=t.getRange(`A${b.trendColHeaders+1}:F${b.trendColHeaders+1}`);st.format.font.bold=!0,st.format.font.size=10,st.format.fill.color="#1e293b",st.format.font.color="#ffffff";for(let O=b.trendDataStart;O<=b.trendDataEnd;O++){let D=O+1;t.getRange(`B${D}`).numberFormat=[["$#,##0"]],t.getRange(`C${D}`).numberFormat=[["$#,##0"]],t.getRange(`D${D}`).numberFormat=[["$#,##0"]],t.getRange(`E${D}`).numberFormat=[["$#,##0"]],t.getRange(`F${D}`).numberFormat=[["#,##0"]],(O-b.trendDataStart)%2===1&&(t.getRange(`A${D}:F${D}`).format.fill.color="#f8fafc")}if(await e.sync(),en.length>=2){try{let O=t.getRange(`A${b.trendColHeaders+1}:E${b.trendDataEnd+1}`),D=t.charts.add(Excel.ChartType.lineMarkers,O,Excel.ChartSeriesBy.columns);D.setPosition(`A${b.chartStart+1}`,`J${b.payrollChartEnd+1}`),D.title.text="Payroll Expense Trends",D.title.format.font.size=14,D.title.format.font.bold=!0,D.legend.position=Excel.ChartLegendPosition.bottom,D.format.fill.setSolidColor("#ffffff"),D.format.border.lineStyle=Excel.ChartLineStyle.continuous,D.format.border.color="#e2e8f0";let He=D.axes.getItem(Excel.ChartAxisType.category);He.categoryType=Excel.ChartAxisCategoryType.textAxis,He.setCategoryNames(t.getRange(`A${b.trendDataStart+1}:A${b.trendDataEnd+1}`)),await e.sync();let Ee=D.series;Ee.load("count"),await e.sync();let ue=["#3b82f6","#22c55e","#f97316","#8b5cf6"];for(let Ne=0;Ne<Math.min(Ee.count,ue.length);Ne++){let Ue=Ee.getItemAt(Ne);Ue.format.line.color=ue[Ne],Ue.format.line.weight=2,Ue.markerStyle=Excel.ChartMarkerStyle.circle,Ue.markerSize=6,Ue.markerBackgroundColor=ue[Ne]}await e.sync(),console.log("writeExpenseReviewSheet: Payroll chart created successfully")}catch(O){console.warn("writeExpenseReviewSheet: Payroll chart creation failed (non-critical)",O)}try{let O=t.getRange(`A${b.trendColHeaders+1}:F${b.trendDataEnd+1}`),D=t.charts.add(Excel.ChartType.lineMarkers,O,Excel.ChartSeriesBy.columns);D.setPosition(`A${b.headcountChartStart+1}`,`J${b.headcountChartEnd+1}`),D.title.text="Headcount Trend",D.title.format.font.size=12,D.title.format.font.bold=!0,D.legend.visible=!1,D.format.fill.setSolidColor("#ffffff"),D.format.border.lineStyle=Excel.ChartLineStyle.continuous,D.format.border.color="#e2e8f0";let He=D.axes.getItem(Excel.ChartAxisType.category);He.categoryType=Excel.ChartAxisCategoryType.textAxis,He.setCategoryNames(t.getRange(`A${b.trendDataStart+1}:A${b.trendDataEnd+1}`)),await e.sync();let Ee=D.series;Ee.load("count, items/name"),await e.sync();for(let ue=Ee.count-2;ue>=0;ue--)Ee.getItemAt(ue).delete();if(await e.sync(),Ee.load("count"),await e.sync(),Ee.count>0){let ue=Ee.getItemAt(0);ue.format.line.color="#64748b",ue.format.line.weight=2.5,ue.markerStyle=Excel.ChartMarkerStyle.circle,ue.markerSize=8,ue.markerBackgroundColor="#64748b"}await e.sync(),console.log("writeExpenseReviewSheet: Headcount chart created successfully")}catch(O){console.warn("writeExpenseReviewSheet: Headcount chart creation failed (non-critical)",O)}}t.freezePanes.freezeRows(b.execSummaryEnd+1),t.pageLayout.orientation=Excel.PageOrientation.landscape,t.getRange("A1").select(),await e.sync(),console.log("writeExpenseReviewSheet: Formatting applied successfully")}catch(y){console.warn("writeExpenseReviewSheet: Formatting error (non-critical)",y)}}function wa(e){var o;return!e||!e.length?!1:(((o=e[0].summary)==null?void 0:o.categories)||[]).some(a=>{let s=(a.name||"").toLowerCase();return s.includes("commission")||s.includes("bonus")||s.includes("variable")})}function Ea(e,t){var l;if(!e||t.length<2)return!1;let n=t.map(c=>{var r;return((r=c.summary)==null?void 0:r.total)||0}).filter(c=>c>0);if(n.length<2)return!1;let o=n.reduce((c,r)=>c+r,0)/n.length,a=((l=e.summary)==null?void 0:l.total)||0;return(o>0?a/o:1)<.9}async function Ca(e){if(!(!ae()||!e))try{await Excel.run(async t=>{let n=t.workbook.worksheets.getItemOrNullObject(e);n.load("name"),await t.sync(),!n.isNullObject&&(n.activate(),n.getRange("A1").select(),await t.sync())})}catch(t){console.warn(`Payroll Recorder: unable to activate worksheet ${e}`,t)}}async function Wt(){if(!ae()){H.lastError="Excel runtime is unavailable.",H.hasAnalyzed=!0,H.loading=!1,le();return}H.loading=!0,H.lastError=null,le();try{let e=await Excel.run(async t=>{let n=t.workbook.worksheets.getItem("SS_Employee_Roster"),o=t.workbook.worksheets.getItem(A.DATA),a=n.getUsedRangeOrNullObject(),s=o.getUsedRangeOrNullObject();a.load("values"),s.load("values"),await t.sync();let l=a.isNullObject?[]:a.values||[],c=s.isNullObject?[]:s.values||[],r=Ra(l),i=Sa(c),p=[];r.employeeMap.forEach((d,g)=>{i.employeeMap.has(g)||p.push({name:d.name||"Unknown Employee",type:"missing_from_payroll",message:"In roster but NOT in payroll data",department:d.department||"\u2014"})}),i.employeeMap.forEach((d,g)=>{r.employeeMap.has(g)||p.push({name:d.name||"Unknown Employee",type:"missing_from_roster",message:"In payroll but NOT in roster",department:d.department||"\u2014"})}),p.sort((d,g)=>d.type!==g.type?d.type.localeCompare(g.type):(d.name||"").localeCompare(g.name||""));let f=[],u=0;return r.employeeMap.forEach((d,g)=>{let v=i.employeeMap.get(g);if(!v)return;let w=ce(d.department),h=ce(v.department);!w&&!h||(u+=1,w!==h&&f.push({employee:d.name||v.name||"Employee",rosterDept:w||"\u2014",payrollDept:h||"\u2014"}))}),console.log("Headcount Analysis Results:",{rosterCount:r.activeCount,payrollCount:i.totalEmployees,difference:r.activeCount-i.totalEmployees,missingFromPayroll:p.filter(d=>d.type==="missing_from_payroll").length,missingFromRoster:p.filter(d=>d.type==="missing_from_roster").length,deptMismatches:f.length}),{roster:{rosterCount:r.activeCount,payrollCount:i.totalEmployees,difference:r.activeCount-i.totalEmployees,mismatches:p},departments:{rosterCount:u,payrollCount:u,difference:f.length,mismatches:f}}});H.roster=e.roster,H.departments=e.departments,H.hasAnalyzed=!0}catch(e){console.warn("Headcount Review: unable to analyze data",e),H.lastError="Unable to analyze headcount data. Try re-running the analysis."}finally{H.loading=!1,le()}}function Ye(e={},{rerender:t=!0}={}){Object.assign(F,e);let n=Number(F.prDataTotal),o=Number(F.cleanTotal);F.reconDifference=Number.isFinite(n)&&Number.isFinite(o)?n-o:null;let a=Kt(F.bankAmount);F.bankDifference=Number.isFinite(o)&&!Number.isNaN(a)?o-a:null,F.plugEnabled=F.bankDifference!=null&&Math.abs(F.bankDifference)>=.5,t?le():ka()}function ka(){if(te.activeStepId!==3)return;let e=(o,a)=>{let s=document.getElementById(o);s&&(s.value=a)};e("pr-data-total-value",ie(F.prDataTotal)),e("clean-total-value",ie(F.cleanTotal)),e("recon-diff-value",ie(F.reconDifference)),e("bank-clean-total-value",ie(F.cleanTotal)),e("bank-diff-value",F.bankDifference!=null?ie(F.bankDifference):"---");let t=document.getElementById("bank-diff-hint");t&&(t.textContent=F.bankDifference==null?"":Math.abs(F.bankDifference)<.5?"Difference within acceptable tolerance.":"Difference exceeds tolerance and should be resolved.");let n=document.getElementById("bank-plug-btn");n&&(n.disabled=!F.plugEnabled)}function yt(e={},{rerender:t=!0}={}){Object.assign(ke,e),t&&le()}async function Mn(){if(!ae()){Ye({loading:!1,lastError:"Excel runtime is unavailable.",prDataTotal:null,cleanTotal:null});return}Ye({loading:!0,lastError:null});try{let e="";await Excel.run(async n=>{let o=await Ie(n);if(console.log("DEBUG - Config table found:",!!o),o){let a=o.getDataBodyRange();a.load("values"),await n.sync();let s=a.values||[];console.log("DEBUG - Config table rows:",s.length),console.log("DEBUG - Looking for payroll date aliases:",Xe),console.log("DEBUG - CONFIG_COLUMNS.FIELD:",B.FIELD,"CONFIG_COLUMNS.VALUE:",B.VALUE);for(let l of s){let c=String(l[B.FIELD]||"").trim(),r=l[B.VALUE],i=Xe.some(p=>c===p||oe(c)===oe(p));if((c.toLowerCase().includes("payroll")||c.toLowerCase().includes("date"))&&console.log("DEBUG - Potential date field:",c,"=",r,"| isMatch:",i),i){let p=l[B.VALUE];console.log("DEBUG - Found payroll date field!",c,"raw value:",p),e=ye(p)||"",console.log("DEBUG - Formatted payroll date:",e);break}}e||(console.warn("DEBUG - No payroll date found in config! Available fields:"),s.forEach((l,c)=>{console.log(`  Row ${c}: Field="${l[B.FIELD]}" Value="${l[B.VALUE]}"`)}))}else console.warn("DEBUG - Config table not found!")}),console.log("DEBUG prepareValidationData - Final Payroll Date:",e||"(empty)");let t=await Excel.run(async n=>{var T;let o=n.workbook.worksheets.getItem(A.DATA),a=n.workbook.worksheets.getItem(A.EXPENSE_MAPPING),s=n.workbook.worksheets.getItem(A.DATA_CLEAN),l=o.getUsedRangeOrNullObject(),c=a.getUsedRangeOrNullObject(),r=s.getUsedRangeOrNullObject();l.load("values"),c.load("values"),r.load(["address","rowCount"]),await n.sync();let i=l.isNullObject?[]:l.values||[],p=c.isNullObject?[]:c.values||[];console.log("DEBUG prepareValidationData - PR_Data rows:",i.length),console.log("DEBUG prepareValidationData - PR_Data headers:",i[0]),console.log("DEBUG prepareValidationData - PR_Expense_Mapping rows:",p.length);let f=((T=p[0])==null?void 0:T.map(m=>ve(m)))||[],u=m=>f.findIndex(m),d={category:u(m=>m.includes("category")),accountNumber:u(m=>m.includes("account")&&(m.includes("number")||m.includes("#"))),accountName:u(m=>m.includes("account")&&m.includes("name")),expenseReview:u(m=>m.includes("expense")&&m.includes("review"))},g=new Map;p.slice(1).forEach(m=>{var L,Q,pe;let I=d.category>=0?Gt(m[d.category]):"";I&&g.set(I,{accountNumber:d.accountNumber>=0&&(L=m[d.accountNumber])!=null?L:"",accountName:d.accountName>=0&&(Q=m[d.accountName])!=null?Q:"",expenseReview:d.expenseReview>=0&&(pe=m[d.expenseReview])!=null?pe:""})});let v=s.getRangeByIndexes(0,0,1,8);v.load("values"),await n.sync();let w=v.values[0]||[],h=w.map(m=>ve(m));console.log("DEBUG prepareValidationData - PR_Data_Clean headers:",w),console.log("DEBUG prepareValidationData - PR_Data_Clean normalized:",h),console.log("DEBUG - PR_Data_Clean headers:",w),console.log("DEBUG - PR_Data_Clean normalized headers:",h);let E=h.findIndex(m=>(m.includes("payroll")||m.includes("period"))&&m.includes("date"));console.log("DEBUG - payrollDate column index:",E),E===-1&&(console.warn("DEBUG - No payroll date column found! Looking for header containing 'payroll'/'period' AND 'date'"),h.forEach((m,I)=>console.log(`  Col ${I}: "${m}"`)));let k={payrollDate:E,employee:h.findIndex(m=>m.includes("employee")),department:Be(h),payrollCategory:h.findIndex(m=>m.includes("payroll")&&m.includes("category")),accountNumber:h.findIndex(m=>m.includes("account")&&(m.includes("number")||m.includes("#"))),accountName:h.findIndex(m=>m.includes("account")&&m.includes("name")),amount:h.findIndex(m=>m.includes("amount")),expenseReview:h.findIndex(m=>m.includes("expense")&&m.includes("review"))};console.log("DEBUG prepareValidationData - fieldMap:",k);let _=w.length,$=[],V=0,x=0;if(i.length>=2){let m=i[0],I=m.map(M=>ve(M));console.log("DEBUG prepareValidationData - Normalized headers:",I);let L=I.findIndex(M=>M.includes("employee")),Q=Be(I);console.log("DEBUG prepareValidationData - Employee column index:",L,"searching for 'employee' in:",I[6]),console.log("DEBUG prepareValidationData - Department column index:",Q);let pe=g.size>0,K=I.reduce((M,Y,ne)=>{if(ne===L||ne===Q||!Y||Y.includes("total")||Y.includes("gross")||Y.includes("date")||Y.includes("period"))return M;let xe=Gt(m[ne]||Y);return pe&&!g.has(xe)||M.push(ne),M},[]);console.log("DEBUG prepareValidationData - Numeric columns:",K.length,K);for(let M=1;M<i.length;M+=1){let Y=i[M],ne=L>=0?ce(Y[L]):"";if(!ne||ne.toLowerCase().includes("total"))continue;let xe=Q>=0&&Y[Q]||"";K.forEach(X=>{let Z=Y[X],fe=Number(Z);if(!Number.isFinite(fe)||fe===0)return;V+=fe;let me=m[X]||I[X]||`Column ${X+1}`,he=g.get(Gt(me))||{};x+=fe;let se=new Array(_).fill("");k.payrollDate>=0?se[k.payrollDate]=e:_>0&&(se[0]=e),$.length===0&&(console.log("DEBUG - Building first PR_Data_Clean row:"),console.log("  payrollDate value:",e),console.log("  fieldMap.payrollDate:",k.payrollDate),console.log("  Writing to column index:",k.payrollDate>=0?k.payrollDate:0)),k.employee>=0&&(se[k.employee]=ne),k.department>=0&&(se[k.department]=xe),k.payrollCategory>=0&&(se[k.payrollCategory]=me),k.accountNumber>=0&&(se[k.accountNumber]=he.accountNumber||""),k.accountName>=0&&(se[k.accountName]=he.accountName||""),k.amount>=0&&(se[k.amount]=fe),k.expenseReview>=0&&(se[k.expenseReview]=he.expenseReview||""),$.push(se)})}}if(console.log("DEBUG prepareValidationData - Clean rows generated:",$.length),console.log("DEBUG prepareValidationData - PR_Data total:",V,"Clean total:",x),console.log("DEBUG prepareValidationData - columnCount:",_,"cleanRange.address:",r.address),!r.isNullObject&&r.address){console.log("DEBUG prepareValidationData - Clearing data rows...");let m=Math.max(0,(r.rowCount||0)-1),I=Math.max(1,m);s.getRangeByIndexes(1,0,I,_).clear(),await n.sync(),console.log("DEBUG prepareValidationData - Data rows cleared")}if(console.log("DEBUG prepareValidationData - About to write",$.length,"rows with",_,"columns"),$.length>0){let m=s.getRangeByIndexes(1,0,$.length,_);m.values=$,console.log("DEBUG prepareValidationData - Data written to PR_Data_Clean")}else console.log("DEBUG prepareValidationData - No rows to write!");return await n.sync(),{prDataTotal:V,cleanTotal:x}});Ye({loading:!1,lastError:null,prDataTotal:t.prDataTotal,cleanTotal:t.cleanTotal})}catch(e){console.warn("Validate & Reconcile: unable to prepare PR_Data_Clean",e),Ye({loading:!1,prDataTotal:null,cleanTotal:null,lastError:"Unable to prepare reconciliation data. Try again."})}}function Ra(e){let t={activeCount:0,departmentCount:0,employeeMap:new Map};if(!e||!e.length)return t;let{headers:n,dataStartIndex:o}=Zn(e,["employee"]);if(!n.length||o==null)return t;let a=Qn(n),s=n.findIndex(r=>r.includes("termination")),l=Be(n);if(a===-1)return t;let c=new Set;for(let r=o;r<e.length;r+=1){let i=e[r],p=i[a],f=Xn(p);if(!f||qn(f))continue;let u=s>=0?i[s]:"",d=l>=0?i[l]:"";!ce(u)&&!c.has(f)&&(c.add(f),t.activeCount+=1),d&&(t.departmentCount+=1),t.employeeMap.has(f)||t.employeeMap.set(f,{name:ce(p)||f,department:ce(d),termination:u})}return t}function Sa(e){let t={totalEmployees:0,departmentCount:0,employeeMap:new Map};if(!e||!e.length)return t;let{headers:n,dataStartIndex:o}=Zn(e,["employee"]);if(!n.length||o==null)return t;let a=Qn(n),s=Be(n);if(a===-1)return t;let l=new Set;for(let c=o;c<e.length;c+=1){let r=e[c],i=r[a],p=Xn(i);if(!p||qn(p))continue;l.has(p)||(l.add(p),t.totalEmployees+=1);let f=s>=0?r[s]:"";f&&(t.departmentCount+=1),t.employeeMap.has(p)||t.employeeMap.set(p,{name:ce(i)||p,department:ce(f)})}return t}function ve(e){return ce(e).toLowerCase()}function Xn(e){return ce(e).toLowerCase()}function Qn(e=[]){let t=e.findIndex(o=>o.includes("employee")&&o.includes("name"));return t>=0?t:e.findIndex(o=>o.includes("employee"))}function Zn(e,t=[]){let n=[],o=null;return(e||[]).some((a,s)=>{let l=(a||[]).map(ve);return t.every(r=>l.some(i=>i.includes(r)))?(n=l,o=s,!0):!1}),{headers:n,dataStartIndex:o!=null?o+1:null}}function ce(e){return e==null?"":String(e).trim()}function Gt(e){return ce(e).toLowerCase()}function Be(e=[]){let t=e.map((l,c)=>({idx:c,value:ve(l)})),n=t.find(({value:l})=>l.includes("department")&&l.includes("description"));if(n)return console.log("DEBUG pickDepartmentIndex - Using 'Department Description' at index:",n.idx),n.idx;let o=t.find(({value:l})=>l.includes("department")&&l.includes("name"));if(o)return console.log("DEBUG pickDepartmentIndex - Using 'Department Name' at index:",o.idx),o.idx;let a=t.find(({value:l})=>l.includes("department")&&!l.includes("id")&&!l.includes("#")&&!l.includes("code")&&!l.includes("number"));if(a)return console.log("DEBUG pickDepartmentIndex - Using non-ID department at index:",a.idx),a.idx;let s=t.find(({value:l})=>l.includes("department"));return s&&console.log("DEBUG pickDepartmentIndex - Using fallback department at index:",s.idx),s?s.idx:-1}function Vn(e,t,n={}){if(zt(),!t||!t.length)return;let o=document.createElement("div");o.className="pf-modal";let a=t.filter(r=>r.type==="missing_from_payroll"),s=t.filter(r=>r.type==="missing_from_roster"),l=t.filter(r=>!r.type),c="";if(a.length>0&&(c+=`
        ...
        `),l.length>0){let r=n.formatter||(i=>typeof i=="string"?{name:i,source:"",isMissingFromTarget:!0}:i);c+=`
            <div class="pf-mismatch-section">
                ...
                <div class="pf-mismatch-tiles">
                    ${l.map(i=>{let p=r(i);return`
                            <div class="pf-mismatch-tile">
                                <span class="pf-mismatch-name">${S(p.name||p.employee||"")}</span>
                                <span class="pf-mismatch-detail">${S(p.source||`${p.rosterDept||""} \u2192 ${p.payrollDept||""}`)}</span>
                            </div>
                        `}).join("")}
                </div>
            </div>
    ...
    `,o.addEventListener("click",r=>{r.target===o&&zt()}),o.querySelectorAll("[data-modal-close]").forEach(r=>{r.addEventListener("click",zt)}),document.body.appendChild(o)}function zt(){var e;(e=document.querySelector(".pf-modal"))==null||e.remove()}function vt(){let e=document.getElementById("headcount-signoff-toggle");if(!e)return;let t=Rt(),n=document.getElementById("step-notes-input"),o=(n==null?void 0:n.value.trim())||"";e.disabled=t&&!o;let a=document.getElementById("headcount-notes-hint");a&&(a.textContent=t?"Please document outstanding differences before signing off.":""),H.skipAnalysis&&Jt()}function xa(){var n;let e=Rt(),t=((n=document.getElementById("step-notes-input"))==null?void 0:n.value.trim())||"";if(e&&!t){window.alert("Please enter a brief explanation of the outstanding differences before completing this step.");return}Yt({statusText:"Headcount Review signed off."})}function Jt(){let e=document.getElementById("step-notes-input");if(!e)return;let t=e.value||"",n=t.startsWith(mt)?t.slice(mt.length).replace(/^\s+/,""):t.replace(new RegExp(`^${mt}\\s*`,"i"),"").trimStart(),o=mt+(n?`
${n}`:"");if(e.value!==o){e.value=o;let a=Se(2);a&&U(a.note,o)}}function Fn(e){let t=e!=null&&e.target&&e.target instanceof HTMLInputElement?e.target:document.getElementById("bank-amount-input"),n=Kt(t==null?void 0:t.value),o=Kn(n);t&&(t.value=o),Ye({bankAmount:n},{rerender:!1})}function _a(){let e=be.findIndex(t=>t.id===3);e!==-1&&Qe(Math.min(be.length-1,e+1))}function Aa(){let e=be.findIndex(t=>t.id===4);e!==-1&&Qe(Math.min(be.length-1,e+1))}async function Da(){if(!ae()){window.alert("Excel runtime is unavailable.");return}if(window.confirm(`Archive Payroll Run
...
Continue?`))try{if(console.log("[Archive] Step 1: Creating archive workbook..."),!await Pa()){window.alert("Archive cancelled or failed. No data was modified.");return}console.log("[Archive] Step 1 complete: Archive workbook created"),console.log("[Archive] Step 2: Updating PR_Archive_Summary..."),await Ia(),console.log("[Archive] Step 2 complete: Archive summary updated"),console.log("[Archive] Step 3: Clearing working data..."),await $a(),console.log("[Archive] Step 3 complete: Working data cleared"),console.log("[Archive] Step 4: Clearing non-permanent notes..."),await Na(),console.log("[Archive] Step 4 complete: Notes cleared"),console.log("[Archive] Step 5: Resetting config values..."),await Oa(),console.log("[Archive] Step 5 complete: Config reset"),console.log("[Archive] Archive workflow complete!"),await zn(),le(),window.alert(`Archive Complete!
...
Please check the console for details and verify your data.`)}}async function Pa(){try{let t=`Payroll_Archive_${Ct()||new Date().toISOString().split("T")[0]}`,n=[A.DATA,A.DATA_CLEAN,A.EXPENSE_MAPPING,A.EXPENSE_REVIEW,A.JE_DRAFT,A.ARCHIVE_SUMMARY];return await Excel.run(async o=>{let s=o.workbook.worksheets;s.load("items/name"),await o.sync();let l=o.application.createWorkbook();await o.sync(),console.log(`[Archive] New workbook created. User should save as: ${t}`);for(let c of n){let r=s.items.find(p=>p.name===c);if(!r){console.warn(`[Archive] Sheet not found: ${c}`);continue}let i=r.getUsedRangeOrNullObject();if(i.load("values,numberFormat,address"),await o.sync(),i.isNullObject||!i.values||i.values.length===0){console.log(`[Archive] Skipping empty sheet: ${c}`);continue}console.log(`[Archive] Archived data from: ${c} (${i.values.length} rows)`)}return window.alert(`Archive Workbook Created
...
Click OK after saving to continue with the archive process.`),!0})}catch(e){return console.error("[Archive] Error creating archive workbook:",e),!1}}async function Ia(){await Excel.run(async e=>{let t=e.workbook.worksheets.getItemOrNullObject(A.ARCHIVE_SUMMARY),n=e.workbook.worksheets.getItemOrNullObject(A.DATA_CLEAN);if(t.load("isNullObject"),n.load("isNullObject"),await e.sync(),t.isNullObject){console.warn("[Archive] PR_Archive_Summary not found - skipping");return}if(n.isNullObject){console.warn("[Archive] PR_Data_Clean not found - skipping");return}let o=n.getUsedRangeOrNullObject();if(o.load("values"),await e.sync(),o.isNullObject||!o.values||o.values.length<2){console.warn("[Archive] PR_Data_Clean is empty - skipping archive summary update");return}let a=(o.values[0]||[]).map(m=>String(m||"").toLowerCase().trim()),s=o.values.slice(1),l=a.findIndex(m=>m.includes("amount")),c=a.findIndex(m=>m.includes("employee")),r=a.findIndex(m=>m.includes("payroll")&&m.includes("date")||m.includes("pay period")||m==="date"),i=0,p=new Set,f=Ct()||"";s.forEach(m=>{l>=0&&(i+=Number(m[l])||0),c>=0&&m[c]&&p.add(String(m[c]).trim()),r>=0&&m[r]&&!f&&(f=String(m[r]))});let u=p.size;console.log(`[Archive] Current period: Date=${f}, Total=${i}, Employees=${u}`);let d=t.getUsedRangeOrNullObject();d.load("values,rowCount"),await e.sync();let g=[],v=[];!d.isNullObject&&d.values&&d.values.length>0&&(g=d.values[0],v=d.values.slice(1)),g.length===0&&(g=["Pay Period","Total Payroll","Employee Count","Archived Date"],t.getRange("A1:D1").values=[g],await e.sync());let w=g.map(m=>String(m||"").toLowerCase().trim()),h=w.findIndex(m=>m.includes("pay period")||m.includes("period")||m==="date"),E=w.findIndex(m=>m.includes("total")),k=w.findIndex(m=>m.includes("employee")||m.includes("count")),_=w.findIndex(m=>m.includes("archived")),$=new Array(g.length).fill("");h>=0&&($[h]=f),E>=0&&($[E]=i),k>=0&&($[k]=u),_>=0&&($[_]=new Date().toISOString().split("T")[0]),v.length>=5&&(v=v.slice(0,4),console.log("[Archive] Trimmed archive to 4 periods, adding current")),v.unshift($);let V=2,x=V+5;if(t.getRange(`A${V}:${String.fromCharCode(64+g.length)}${x}`).clear(Excel.ClearApplyTo.contents),await e.sync(),v.length>0){let m=t.getRange(`A${V}:${String.fromCharCode(64+g.length)}${V+v.length-1}`);m.values=v,await e.sync()}console.log(`[Archive] Archive summary updated with ${v.length} periods`)})}async function $a(){let e=[A.DATA,A.DATA_CLEAN,A.EXPENSE_REVIEW,A.JE_DRAFT];await Excel.run(async t=>{for(let n of e){let o=t.workbook.worksheets.getItemOrNullObject(n);if(o.load("isNullObject"),await t.sync(),o.isNullObject){console.log(`[Archive] Sheet not found: ${n}`);continue}let a=o.getUsedRangeOrNullObject();if(a.load("rowCount,columnCount,address"),await t.sync(),a.isNullObject||a.rowCount<=1){console.log(`[Archive] Sheet empty or headers only: ${n}`);continue}if(o.getRange(`A2:${String.fromCharCode(64+a.columnCount)}${a.rowCount}`).clear(Excel.ClearApplyTo.contents),n===A.EXPENSE_REVIEW){let l=o.charts;l.load("items"),await t.sync();for(let c=l.items.length-1;c>=0;c--)l.items[c].delete()}await t.sync(),console.log(`[Archive] Cleared data from: ${n}`)}})}async function Na(){await Excel.run(async e=>{let t=await Ie(e);if(!t){console.warn("[Archive] Config table not found");return}let n=t.getDataBodyRange();n.load("values,rowCount"),await e.sync();let o=n.values||[],a=0,s=Object.values($e).map(l=>l.note);for(let l=0;l<o.length;l++){let c=String(o[l][B.FIELD]||"").trim(),r=String(o[l][B.PERMANENT]||"").toUpperCase();s.includes(c)&&r!=="Y"&&(n.getCell(l,B.VALUE).values=[[""]],a++)}await e.sync(),console.log(`[Archive] Cleared ${a} non-permanent notes`)})}async function Oa(){let e=["PR_Payroll_Date","PR_Accounting_Period","PR_Journal_Entry_ID","Payroll_Date","Accounting_Period","Journal_Entry_ID","JE_Transaction_ID",...Object.values($e).map(t=>t.signOff),...Object.values($e).map(t=>t.reviewer),...Object.values(de)];await Excel.run(async t=>{let n=await Ie(t);if(!n){console.warn("[Archive] Config table not found");return}let o=n.getDataBodyRange();o.load("values,rowCount"),await t.sync();let a=o.values||[],s=0;for(let l=0;l<a.length;l++){let c=String(a[l][B.FIELD]||"").trim(),r=String(a[l][B.PERMANENT]||"").toUpperCase();e.some(p=>oe(p)===oe(c))&&r!=="Y"&&(o.getCell(l,B.VALUE).values=[[""]],s++)}await t.sync(),console.log(`[Archive] Reset ${s} non-permanent config values`),Object.keys(W.values).forEach(l=>{e.some(c=>oe(c)===oe(l))&&(W.values[l]="")})})}async function Ta(){if(!ae()){window.alert("Excel runtime is unavailable.");return}G.loading=!0,G.lastError=null,Un(!1),le();try{let e=await Excel.run(async t=>{let o=t.workbook.worksheets.getItem(A.JE_DRAFT).getUsedRangeOrNullObject();o.load("values"),await t.sync();let a=o.isNullObject?[]:o.values||[];if(!a.length)throw new Error(`${A.JE_DRAFT} is empty.`);let s=(a[0]||[]).map(p=>ve(p)),l=s.findIndex(p=>p.includes("debit")),c=s.findIndex(p=>p.includes("credit"));if(l===-1||c===-1)throw new Error("Debit/Credit columns not found in JE Draft.");let r=0,i=0;return a.slice(1).forEach(p=>{r+=Number(p[l])||0,i+=Number(p[c])||0}),{debitTotal:r,creditTotal:i,difference:i-r}});Object.assign(G,e,{lastError:null})}catch(e){console.warn("JE summary:",e),G.lastError=(e==null?void 0:e.message)||"Unable to calculate journal totals.",G.debitTotal=null,G.creditTotal=null,G.difference=null}finally{G.loading=!1,le()}}async function La(){try{let e=Number.isFinite(Number(G.debitTotal))?G.debitTotal:"",t=Number.isFinite(Number(G.creditTotal))?G.creditTotal:"",n=Number.isFinite(Number(G.difference))?G.difference:"";await Promise.all([Ke(Po,String(e)),Ke(Io,String(t)),Ke($o,String(n))]),Un(!0)}catch(e){console.error("JE save:",e)}}async function Ba(){if(!ae()){window.alert("Excel runtime is unavailable.");return}G.loading=!0,G.lastError=null,le();try{await Excel.run(async e=>{let t="",n="",o=await Ie(e);if(o){let h=o.getDataBodyRange();h.load("values"),await e.sync();let E=h.values||[];for(let k of E){let _=String(k[B.FIELD]||"").trim(),$=k[B.VALUE];(_==="Journal_Entry_ID"||_==="JE_Transaction_ID"||_==="PR_Journal_Entry_ID")&&(t=String($||"").trim()),Xe.some(V=>_===V||oe(_)===oe(V))&&(n=ye($)||"")}}console.log("JE Generation - RefNumber:",t,"TxnDate:",n);let a=e.workbook.worksheets.getItemOrNullObject(A.DATA_CLEAN);if(a.load("isNullObject"),await e.sync(),a.isNullObject)throw new Error("PR_Data_Clean sheet not found. Run Validate & Reconcile first.");let s=a.getUsedRangeOrNullObject();if(s.load("values"),await e.sync(),s.isNullObject)throw new Error("PR_Data_Clean is empty. Run Validate & Reconcile first.");let l=s.values||[];if(l.length<2)throw new Error("PR_Data_Clean has no data rows.");let c=l[0].map(h=>ve(h));console.log("JE Generation - PR_Data_Clean headers:",c);let r={accountNumber:c.findIndex(h=>h.includes("account")&&(h.includes("number")||h.includes("#"))),accountName:c.findIndex(h=>h.includes("account")&&h.includes("name")),amount:c.findIndex(h=>h.includes("amount")),department:Be(c),payrollCategory:c.findIndex(h=>h.includes("payroll")&&h.includes("category")),employee:c.findIndex(h=>h.includes("employee"))};if(console.log("JE Generation - Column indices:",r),r.amount===-1)throw new Error("Amount column not found in PR_Data_Clean.");let i=new Map;for(let h=1;h<l.length;h++){let E=l[h],k=r.accountNumber>=0?String(E[r.accountNumber]||"").trim():"",_=r.accountName>=0?String(E[r.accountName]||"").trim():"",$=Number(E[r.amount])||0,V=r.department>=0?String(E[r.department]||"").trim():"";if($===0)continue;let x=`${k}|${V}`;if(i.has(x)){let T=i.get(x);T.amount+=$}else i.set(x,{accountNumber:k,accountName:_,department:V,amount:$})}console.log("JE Generation - Aggregated into",i.size,"unique Account+Department combinations");let p=["RefNumber","TxnDate","Account Number","Account Name","LineAmount","Debit","Credit","LineDesc","Department"],f=[p],u=0,d=0,g=Array.from(i.values()).sort((h,E)=>{let k=String(h.accountNumber).localeCompare(String(E.accountNumber));return k!==0?k:String(h.department).localeCompare(String(E.department))});for(let h of g){let{accountNumber:E,accountName:k,department:_,amount:$}=h,V=$>0?$:0,x=$<0?Math.abs($):0,T=[k,_].filter(Boolean).join(" - ");u+=V,d+=x,f.push([t,n,E,k,$,V||"",x||"",T,_])}console.log("JE Generation - Built",f.length-1,"summarized journal lines"),console.log("JE Generation - Total Debit:",u,"Total Credit:",d);let v=e.workbook.worksheets.getItemOrNullObject(A.JE_DRAFT);if(v.load("isNullObject"),await e.sync(),v.isNullObject)v=e.workbook.worksheets.add(A.JE_DRAFT),await e.sync();else{let h=v.getUsedRangeOrNullObject();h.load("address"),await e.sync(),h.isNullObject||(h.clear(),await e.sync())}let w=v.getRangeByIndexes(0,0,f.length,p.length);w.values=f,await e.sync();try{let h=f.length-1,E=v.getRange("A1:I1");_n(E),h>0&&(An(v,1,h),ft(v,4,h),ft(v,5,h),ft(v,6,h)),v.getRange("A:I").format.autofitColumns(),await e.sync()}catch(h){console.warn("JE formatting error (non-critical):",h)}v.activate(),v.getRange("A1").select(),await e.sync(),G.debitTotal=u,G.creditTotal=d,G.difference=d-u}),G.loading=!1,G.lastError=null,le()}catch(e){console.error("JE Generation failed:",e),G.loading=!1,G.lastError=e.message||"Failed to generate journal entry.",le()}}async function Ma(){if(!ae()){window.alert("Excel runtime is unavailable.");return}try{let{rows:e}=await Excel.run(async n=>{let a=n.workbook.worksheets.getItem(A.JE_DRAFT).getUsedRangeOrNullObject();a.load("values"),await n.sync();let s=a.isNullObject?[]:a.values||[];if(!s.length)throw new Error(`${A.JE_DRAFT} is empty.`);return{rows:s}}),t=ma(e);ga(`pr-je-draft-${Ze()}.csv`,t)}catch(e){console.warn("JE export:",e),window.alert("Unable to export the JE draft. Confirm the sheet has data.")}}})();
