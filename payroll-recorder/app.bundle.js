...
- Missing or incomplete mappings`},It=[];function rn(e={}){var o;let t={...sn,...e},n=((o=t.quickActions)==null?void 0:o.map(a=>`<button type="button" class="pf-ada-chip" data-action="${a.id}" data-prompt="${Co(a.prompt)}">${a.label}</button>`).join(""))||"";return`
    ...
    `}function Co(e){return String(e||"").replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&#39;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function ln(e,t={}){let n={...sn,...t},o=e.querySelector(`[data-copilot="${n.id}"]`);if(!o)return;let a=o.querySelector(`#${n.id}-messages`),s=o.querySelector(`#${n.id}-prompt`),l=o.querySelector(`#${n.id}-ask`),d=o.querySelector(`#${n.id}-status-dot`),r=o.querySelector(`#${n.id}-status-badge`),i=!1,u=(w,g="ready")=>{d&&(d.classList.remove("pf-ada-status-dot--busy","pf-ada-status-dot--offline"),g==="busy"&&d.classList.add("pf-ada-status-dot--busy"),g==="offline"&&d.classList.add("pf-ada-status-dot--offline")),r&&(r.title=w)},f=(w,g="assistant")=>{if(!a)return;let E=g==="user"?"pf-ada-bubble--user":g==="system"?"pf-ada-bubble--system":"pf-ada-bubble--ai",k=document.createElement("div");k.className=`pf-ada-bubble ${E}`,k.innerHTML=`<p>${m(w)}</p>`,a.appendChild(k),a.scrollTop=a.scrollHeight,It.push({role:g,content:w,timestamp:new Date().toISOString()})},p=()=>{if(!a)return;let w=document.createElement("div");w.className="pf-ada-bubble pf-ada-bubble--ai pf-ada-bubble--loading",w.id=`${n.id}-loading`,w.innerHTML=`
            <div class="pf-ada-typing">
                <span></span><span></span><span></span>
            </div>
        `,a.appendChild(w),a.scrollTop=a.scrollHeight},c=()=>{let w=document.getElementById(`${n.id}-loading`);w&&w.remove()},m=w=>String(w).replace(/\*\*(.*?)\*\*/g,"<strong>$1</strong>").replace(/\n\n/g,"</p><p>").replace(/\n- /g,"<br>\u2022 ").replace(/\n/g,"<br>"),y=async w=>{let g=w||(s==null?void 0:s.value.trim());if(!(!g||i)){i=!0,s&&(s.value=""),l&&(l.disabled=!0),f(g,"user"),p(),u("Analyzing...","busy");try{let E=null;if(typeof n.contextProvider=="function")try{E=await n.contextProvider()}catch(x){console.warn("CoPilot: Context provider failed",x)}let k;typeof n.onPrompt=="function"?k=await n.onPrompt(g,E,It):typeof n.apiEndpoint=="string"?k=await ko(n.apiEndpoint,g,E,n.systemPrompt):k=Ro(g,E),c(),f(k,"assistant"),u("Ready to assist","ready")}catch(E){console.error("CoPilot error:",E),c(),f(`I encountered an issue: ${E.message}. Please try again.`,"system"),u("Error occurred","offline")}i=!1,l&&(l.disabled=!1),s==null||s.focus()}};l==null||l.addEventListener("click",()=>y()),s==null||s.addEventListener("keydown",w=>{w.key==="Enter"&&!w.shiftKey&&(w.preventDefault(),y())}),o.querySelectorAll(".pf-ada-chip").forEach(w=>{w.addEventListener("click",()=>{let g=w.dataset.prompt;g&&y(g)})})}async function ko(e,t,n,o){let a=await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({prompt:t,context:n,systemPrompt:o,history:It.slice(-10)})});if(!a.ok)throw new Error(`API request failed: ${a.status}`);let s=await a.json();return s.message||s.response||"No response received."}function Ro(e,t){var o,a,s;let n=e.toLowerCase();return n.includes("diagnostic")||n.includes("check")?`Great question! Let me run through the diagnostics for you.
...
`.trim();function We(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Mt(e,t){return`
    ...
    `,document.body.appendChild(n),requestAnimationFrame(()=>{n.classList.add("pf-workflow-toast--visible")}),setTimeout(()=>{n.classList.remove("pf-workflow-toast--visible"),setTimeout(()=>n.remove(),300)},4e3)}var Ft={fillColor:"#000000",fontColor:"#FFFFFF",bold:!0},jt={currency:"$#,##0.00",currencyWithNegative:"$#,##0.00;($#,##0.00)",number:"#,##0.00",integer:"#,##0",percent:"0.00%",date:"yyyy-mm-dd",dateTime:"yyyy-mm-dd hh:mm"};function xn(e){e.format.fill.color=Ft.fillColor,e.format.font.color=Ft.fontColor,e.format.font.bold=Ft.bold}function ft(e,t,n,o=!1){if(n<=0)return;let a=e.getRangeByIndexes(1,t,n,1);a.numberFormat=[[o?jt.currencyWithNegative:jt.currency]]}function An(e,t,n,o=jt.date){if(n<=0)return;let a=e.getRangeByIndexes(1,t,n,1);a.numberFormat=[[o]]}var Et="payroll-recorder";var Pe="Payroll Recorder",_s=A.CONFIG||"SS_PF_Config",Ht=["SS_PF_Config"];var xo="Normalize payroll exports, enforce controls, and prep journal entries without leaving Excel. Every run follows the same guidance so you stay audit-ready.",be=rt.map(({id:e,title:t})=>({id:e,title:t})),B={TYPE:0,FIELD:1,VALUE:2,PERMANENT:3,TITLE:-1},Ao="Run Settings";var Dn="N";var Do="PR_JE_Debit_Total",Po="PR_JE_Credit_Total",Io="PR_JE_Difference",$e={0:{note:"PR_Notes_Config",reviewer:"PR_Reviewer_Config",signOff:"PR_SignOff_Config"},1:{note:"PR_Notes_Import",reviewer:"PR_Reviewer_Import",signOff:"PR_SignOff_Import"},2:{note:"PR_Notes_Headcount",reviewer:"PR_Reviewer_Headcount",signOff:"PR_SignOff_Headcount"},3:{note:"PR_Notes_Validate",reviewer:"PR_Reviewer_Validate",signOff:"PR_SignOff_Validate"},4:{note:"PR_Notes_Review",reviewer:"PR_Reviewer_Review",signOff:"PR_SignOff_Review"},5:{note:"PR_Notes_JE",reviewer:"PR_Reviewer_JE",signOff:"PR_SignOff_JE"},6:{note:"PR_Notes_Archive",reviewer:"PR_Reviewer_Archive",signOff:"PR_SignOff_Archive"}},de={0:"PR_Complete_Config",1:"PR_Complete_Import",2:"PR_Complete_Headcount",3:"PR_Complete_Validate",4:"PR_Complete_Review",5:"PR_Complete_JE",6:"PR_Complete_Archive"},$o={1:A.DATA,2:A.DATA_CLEAN,3:A.DATA_CLEAN,4:A.EXPENSE_REVIEW,5:A.JE_DRAFT},qe="PR_Reviewer",jn="PR_Payroll_Provider",mt="User opted to skip the headcount review this period.",te={statusText:"",focusedIndex:0,activeView:"home",activeStepId:null,stepStatuses:be.reduce((e,t)=>({...e,[t.id]:"pending"}),{})},W={loaded:!1,values:{},permanents:{},overrides:{accountingPeriod:!1,jeId:!1}},Le=new Map,gt=null,Xe=["PR_Payroll_Date","Payroll Date (YYYY-MM-DD)","Payroll_Date","Payroll Date","Payroll_Date_(YYYY-MM-DD)"],H={skipAnalysis:!1,roster:{rosterCount:null,payrollCount:null,difference:null,mismatches:[]},departments:{rosterCount:null,payrollCount:null,difference:null,mismatches:[]},loading:!1,hasAnalyzed:!1,lastError:null},bt=null,F={loading:!1,lastError:null,prDataTotal:null,cleanTotal:null,reconDifference:null,bankAmount:"",bankDifference:null,plugEnabled:!1},ke={loading:!1,lastError:null,periods:[],copilotResponse:"",completenessCheck:{currentPeriod:null,historicalPeriods:null}},G={debitTotal:null,creditTotal:null,difference:null,loading:!1,lastError:null};async function No(){if(console.log("Completeness Check - Starting..."),!ae()){console.log("Completeness Check - Excel runtime not available");return}try{await Excel.run(async e=>{var a,s,l,d;let t=e.workbook.worksheets.getItemOrNullObject(A.DATA_CLEAN),n=e.workbook.worksheets.getItemOrNullObject(A.ARCHIVE_SUMMARY);t.load("isNullObject"),n.load("isNullObject"),await e.sync();let o={currentPeriod:null,historicalPeriods:null};if(!t.isNullObject){let r=t.getUsedRangeOrNullObject();if(r.load("values"),await e.sync(),!r.isNullObject&&r.values&&r.values.length>1){let i=(r.values[0]||[]).map(p=>String(p||"").toLowerCase().trim()),u=i.findIndex(p=>p.includes("amount")),f=u>=0?u:i.findIndex(p=>p==="total"||p==="all-in"||p==="allin"||p==="all-in total"||p==="gross"||p==="total pay");if(console.log("Completeness Check - PR_Data_Clean headers:",i),console.log("Completeness Check - Amount column index:",u,"Total column index:",f),f>=0){let c=r.values.slice(1).reduce((w,g)=>w+(Number(g[f])||0),0),m=((l=(s=(a=ke.periods)==null?void 0:a[0])==null?void 0:s.summary)==null?void 0:l.total)||0;console.log("Completeness Check - PR_Data_Clean sum:",c,"Current period total:",m);let y=Math.abs(c-m)<1;o.currentPeriod={match:y,prDataClean:c,currentTotal:m}}else console.warn("Completeness Check - No amount/total column found in PR_Data_Clean")}}if(!n.isNullObject){let r=n.getUsedRangeOrNullObject();if(r.load("values"),await e.sync(),!r.isNullObject&&r.values&&r.values.length>1){let i=(r.values[0]||[]).map(c=>String(c||"").toLowerCase().trim()),u=i.findIndex(c=>c.includes("pay period")||c.includes("payroll date")||c==="date"||c==="period"||c.includes("period")),f=i.findIndex(c=>c.includes("amount")),p=f>=0?f:i.findIndex(c=>c==="total"||c==="all-in"||c==="allin"||c==="all-in total"||c==="total payroll"||c.includes("total"));if(console.log("Completeness Check - PR_Archive_Summary headers:",i),console.log("Completeness Check - Date column index:",u,"Total column index:",p),p>=0&&u>=0){let c=r.values.slice(1),m=(ke.periods||[]).slice(1,6);console.log("Completeness Check - Looking for periods:",m.map(_=>_.key||_.label));let y=new Map;for(let _ of c){let T=_[u],h=$n(T);h&&y.set(h,Number(_[p])||0)}console.log("Completeness Check - Archive lookup keys:",Array.from(y.keys()));let w=0,g=0,E=0,k=[];for(let _ of m){let T=_.key||_.label||"",h=$n(T),I=((d=_.summary)==null?void 0:d.total)||0;g+=I;let L=y.get(h);L!==void 0?(w+=L,E++,k.push({period:T,calculated:I,archive:L,match:Math.abs(I-L)<1})):(console.warn(`Completeness Check - Period ${T} (normalized: ${h}) not found in archive`),k.push({period:T,calculated:I,archive:null,match:!1}))}console.log("Completeness Check - Period details:",k),console.log("Completeness Check - Matched",E,"of",m.length,"periods"),console.log("Completeness Check - Archive sum:",w,"Periods sum:",g);let x=E===m.length&&m.length>0,$=Math.abs(w-g)<1,V=x&&$;o.historicalPeriods={match:V,archiveSum:w,periodsSum:g,matchedCount:E,totalPeriods:m.length,details:k}}else console.warn("Completeness Check - Missing date or total column in PR_Archive_Summary"),console.warn("  Date column index:",u,"Total column index:",p)}}ke.completenessCheck=o,console.log("Completeness Check - Results:",JSON.stringify(o))}),console.log("Completeness Check - Complete!")}catch(e){console.error("Payroll completeness check failed:",e)}}function Oo(){var y,w;let e=ke.completenessCheck||{},t=((y=ke.periods)==null?void 0:y.length)>0,n=g=>`$${Math.round(g||0).toLocaleString()}`,o=g=>{let E=Math.abs(g);return E<1?"\u2014":`${g>0?"+":"-"}$${Math.round(E).toLocaleString()}`},a=(g,E,k,x,$,V,_)=>{let T=(k||0)-($||0),h,I;_?(h='<span class="pf-complete-status pf-complete-status--pending">\u23F3</span>',I="pending"):V?(h='<span class="pf-complete-status pf-complete-status--pass">\u2713</span>',I="pass"):(h='<span class="pf-complete-status pf-complete-status--fail">\u2717</span>',I="fail");let L=_?"":`
        ...
        `},s=e.currentPeriod,l=!t||s===null||s===void 0,d=a("Current Period","PR_Data_Clean Total",s==null?void 0:s.prDataClean,"Calculated Total",s==null?void 0:s.currentTotal,s==null?void 0:s.match,l),r=e.historicalPeriods,i=!t||r===null||r===void 0,u=(r==null?void 0:r.matchedCount)||0,f=(r==null?void 0:r.totalPeriods)||0,p=f>0?`Historical Periods (${u}/${f} matched)`:"Historical Periods",c=a(p,"PR_Archive_Summary (matched)",r==null?void 0:r.archiveSum,"Calculated Total",r==null?void 0:r.periodsSum,r==null?void 0:r.match,i),m="";return!i&&((w=r==null?void 0:r.details)==null?void 0:w.length)>0&&(m=`
            <div class="pf-complete-details-section">
                ...
                ${r.details.map(E=>{let k=E.archive===null?"\u26A0\uFE0F":E.match?"\u2713":"\u2717",x=E.archive!==null?n(E.archive):"Not found";return`
                <div class="pf-complete-detail-row">
                    ...
                    <span class="pf-complete-detail-vals">${n(E.calculated)} vs ${x}</span>
                </div>
            `}).join("")}
            </div>
        `),`
    ...
    `}function Fo(){if(!W.loaded)return`
        ...
        `;let e=$e[0],t=ye(Ct()),n=ye(P("PR_Accounting_Period")),o=P("PR_Journal_Entry_ID"),a=P("SS_Accounting_Software"),s=qt(),l=P("SS_Company_Name"),d=P(qe)||De(),r=e?P(e.note):"",i=e?Re(e.note):!1,u=(e?P(e.reviewer):"")||De(),f=e?ye(P(e.signOff)):"",p=!!(f||P(de[0]));return`
        ...
        <section class="pf-step-guide">
            ...
            ${e?xe({textareaId:"config-notes",value:r,permanentId:"config-notes-permanent",isPermanent:i,hintId:"",saveButtonId:"config-notes-save"}):""}
    ...
    `}function jo(e){let t=Se(1),n=t?Re(t.note):!1,o=t?P(t.note):"",a=(t?P(t.reviewer):"")||De(),s=t?ye(P(t.signOff)):"",l=!!(s||P(de[1])),d=qt();return`
        ...
        <section class="pf-step-guide">
            ...
            ${t?`
                ${xe({textareaId:"step-notes-1",value:o||"",permanentId:"step-notes-lock-1",isPermanent:n,saveButtonId:"step-notes-save-1"})}
    ...
    `}function Ho(e){var $,V,_,T,h,I,L,Q,pe,K;let t=Se(2),n=t?P(t.note):"",o=t?Re(t.note):!1,a=(t?P(t.reviewer):"")||De(),s=t?ye(P(t.signOff)):"",l=!!(s||P(de[2])),d=Rt(),r=H.roster||{},i=H.departments||{},u=H.hasAnalyzed,f="";H.loading?f='<p class="pf-step-note">Analyzing roster and payroll data\u2026</p>':H.lastError&&(f=`<p class="pf-step-note">${S(H.lastError)}</p>`);let p=(M,Y,ne)=>{let _e=!u,X;_e?X='<span class="pf-je-check-circle pf-je-circle--pending"></span>':ne?X=`<span class="pf-je-check-circle pf-je-circle--pass">
        ...
        `},c=($=r.difference)!=null?$:0,m=(V=i.difference)!=null?V:0,y=Array.isArray(r.mismatches)?r.mismatches.filter(Boolean):[],w=Array.isArray(i.mismatches)?i.mismatches.filter(Boolean):[],g=`
        ${p("SS_Employee_Roster count",(_=r.rosterCount)!=null?_:"\u2014",!0)}
        ${p("PR_Data employee count",(T=r.payrollCount)!=null?T:"\u2014",!0)}
        ${p("Difference",c,c===0)}
    `,E=`
        ${p("Expected departments",(h=i.rosterCount)!=null?h:"\u2014",!0)}
        ${p("PR_Data departments",(I=i.payrollCount)!=null?I:"\u2014",!0)}
        ${p("Difference",m,m===0)}
    `,k=y.length&&!H.skipAnalysis&&u&&((Q=(L=window.PrairieForge)==null?void 0:L.renderMismatchTiles)==null?void 0:Q.call(L,{mismatches:y,label:"Employees Driving the Difference",sourceLabel:"Roster",targetLabel:"Payroll Data",escapeHtml:S}))||"",x=w.length&&!H.skipAnalysis&&u&&((K=(pe=window.PrairieForge)==null?void 0:pe.renderMismatchTiles)==null?void 0:K.call(pe,{mismatches:w,label:"Employees with Department Differences",formatter:M=>({name:M.employee||M.name||"",source:`${M.rosterDept||"\u2014"} \u2192 ${M.payrollDept||"\u2014"}`,isMissingFromTarget:!0}),escapeHtml:S}))||"";return`
        <section class="pf-hero" id="pf-step-hero">
            <p class="pf-hero-copy">${S(Pe)} | Step ${e.id}</p>
        ...
        <section class="pf-step-guide">
            ...
            ${t?`
                ${xe({textareaId:"step-notes-input",value:n,permanentId:"step-notes-permanent",isPermanent:o,hintId:d?"headcount-notes-hint":"",saveButtonId:"step-notes-save-2"})}
    ...
    `}function Uo(e){var $;let t=Se(3),n=t?P(t.note):"",o=(t?P(t.reviewer):"")||De(),a=t?ye(P(t.signOff)):"",s=F.loading?'<p class="pf-step-note">Preparing reconciliation data\u2026</p>':F.lastError?`<p class="pf-step-note">${S(F.lastError)}</p>`:"",l=!!(a||P(de[3])),d=F.prDataTotal!==null,r=F.prDataTotal,i=F.cleanTotal,u=($=F.reconDifference)!=null?$:r!=null&&i!=null?r-i:null,f=u!==null&&Math.abs(u)<.01,p=ie(F.cleanTotal),c=F.bankDifference!=null?ie(F.bankDifference):"---",m=F.bankDifference==null?"":Math.abs(F.bankDifference)<.5?"Difference within acceptable tolerance.":"Difference exceeds tolerance and should be resolved.",y=qn(F.bankAmount),w=(V,_,T)=>{let h=!d,I;return h?I='<span class="pf-je-check-circle pf-je-circle--pending"></span>':T?I=`<span class="pf-je-check-circle pf-je-circle--pass">
        ...
        `},g=d?ie(r):"\u2014",E=d?ie(i):"\u2014",k=d?ie(u):"\u2014",x=`
        ${w("PR_Data Total",`PR_Data Total = ${g}`,!0)}
    ...
    `;return`
        ...
        <section class="pf-step-guide">
            ...
            ${t?`
                ${xe({textareaId:"step-notes-input",value:n,permanentId:"step-notes-permanent",isPermanent:Re(t.note),saveButtonId:"step-notes-save-3"})}
            `:""}
    ...
    `}function Go(e){let t=Se(4),n=t?P(t.note):"",o=(t?P(t.reviewer):"")||De(),a=t?ye(P(t.signOff)):"",s=!!(a||P(de[4])),l=ke.loading?'<p class="pf-step-note">Preparing executive summary\u2026</p>':ke.lastError?`<p class="pf-step-note">${S(ke.lastError)}</p>`:"",d=rn({id:"expense-review-copilot",body:"Want help analyzing your data? Just ask!",placeholder:"Where should I focus this pay period?",buttonLabel:"Ask CoPilot"});return`
        ...
        <section class="pf-step-guide">
            ...
            ${Oo()}
                ${d}
            ${t?`
            ${xe({textareaId:"step-notes-input",value:n,permanentId:"step-notes-permanent",isPermanent:Re(t.note),saveButtonId:"step-notes-save-4"})}
    ...
    `}function zo(e){var $,V,_;let t=Se(5),n=t?P(t.note):"",o=t?Re(t.note):!1,a=(t?P(t.reviewer):"")||De(),s=t?ye(P(t.signOff)):"",l=!!(s||P(de[5])),d=G.lastError?`<p class="pf-step-note">${S(G.lastError)}</p>`:"",r=G.debitTotal!==null,i=($=G.debitTotal)!=null?$:0,u=(V=G.creditTotal)!=null?V:0,f=i-u,p=(_=F.cleanTotal)!=null?_:0,c=r,m=r&&Math.abs(f-p)<.01,y=(T,h)=>{let I=!r,L;return I?L='<span class="pf-je-check-circle pf-je-circle--pending"></span>':h?L=`<span class="pf-je-check-circle pf-je-circle--pass">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg>
        ...
        `},w=r?ie(i):"\u2014",g=r?ie(u):"\u2014",E=r?ie(f):"\u2014",k=r?ie(p):"\u2014",x=`
        ${y(`Total Debits = ${w}`,c)}
        ${y(`Total Credits = ${g}`,c)}
    ...
    `;return`
        ...
        <section class="pf-step-guide">
            ...
            ${t?`
                ${xe({textareaId:"step-notes-input",value:n||"",permanentId:"step-notes-permanent",isPermanent:o,saveButtonId:"step-notes-save-5"})}
    ...
    `}function Jo(e){let t=rt.find(x=>x.id===e)||{id:e!=null?e:"-",title:"Workflow Step",summary:"",description:"",checklist:[]};if(e===1)return jo(t);if(e===2)return Ho(t);if(e===3)return Uo(t);if(e===4)return Go(t);if(e===5)return zo(t);if(e===6)return Wo(t);let n=!1,o=Se(e),a=o?P(o.note):"",s=o?Re(o.note):!1,l=(o?P(o.reviewer):"")||De(),d=o?ye(P(o.signOff)):"",r=o&&de[e]?!!(d||P(de[e])):!!d,i=(t.highlights||[]).map(x=>`
        ...
        `:"",w="",g=!n&&i?`<article class="pf-step-card pf-step-detail">${i}</article>`:"",E=!n&&u?`<article class="pf-step-card pf-step-detail">
        ...
        <section class="pf-step-guide">
            ...
            ${E}
            ${o?`
                ${xe({textareaId:"step-notes-input",value:a,permanentId:"step-notes-permanent",isPermanent:s,saveButtonId:"step-notes-save"})}
