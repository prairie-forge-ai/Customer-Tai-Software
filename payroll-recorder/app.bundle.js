...
`.trim();function We(e){return e==null?"":String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Mt(e,t){return`
    ...
    `}function zo(e){var $,V,_;let t=Se(5),n=t?I(t.note):"",o=t?Re(t.note):!1,a=(t?I(t.reviewer):"")||De(),s=t?ye(I(t.signOff)):"",l=!!(s||I(de[5])),d=G.lastError?`<p class="pf-step-note">${S(G.lastError)}</p>`:"",r=G.debitTotal!==null,i=($=G.debitTotal)!=null?$:0,u=(V=G.creditTotal)!=null?V:0,f=i-u,p=(_=F.cleanTotal)!=null?_:0,c=r,m=r&&Math.abs(f-p)<.01,y=(T,g)=>{let D=!r,L;return D?L='<span class="pf-je-check-circle pf-je-circle--pending"></span>':g?L=`<span class="pf-je-check-circle pf-je-circle--pass">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"/></svg>
        ...
        `},w=r?ie(i):"\u2014",h=r?ie(u):"\u2014",E=r?ie(f):"\u2014",k=r?ie(p):"\u2014",x=`
        ${y(`Total Debits = ${w}`,c)}
        ${y(`Total Credits = ${h}`,c)}
